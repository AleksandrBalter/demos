...
lib.ssMetadata = [
		{name:"728_90_atlas_1", frames: [[416,92,164,90],[0,0,728,90],[0,92,230,102],[730,0,214,110],[946,53,50,50],[946,0,51,51],[787,112,102,28],[582,112,203,56],[232,92,182,85]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-368,48.5).lineTo(-368,-48.5).lineTo(368,-48.5).lineTo(368,48.5).closePath();
	this.shape.setTransform(367.975,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol104, new cjs.Rectangle(0,-48.5,736,97), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.3,9.8).curveTo(-5.2,9,-5.2,7.7).curveTo(-5.2,6.3,-4.2,5.4).curveTo(-3.2,4.4,-1.6,4.4).curveTo(-0.2,4.4,0.7,5.2).curveTo(1.6,6,1.6,7.3).curveTo(1.6,8.7,0.6,9.7).curveTo(-0.5,10.6,-2,10.6).curveTo(-3.4,10.6,-4.3,9.8).closePath().moveTo(-3.1,2.7).lineTo(-1.6,-10.6).lineTo(5.2,-10.6).lineTo(1.4,2.7).closePath();
	this.shape.setTransform(307.125,2.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.3,10.5).lineTo(-6.1,-10.5).lineTo(10.3,-10.5).lineTo(9.4,-5.9).lineTo(-1.2,-5.9).lineTo(-1.9,-2.4).lineTo(7.4,-2.4).lineTo(6.5,2.1).lineTo(-2.8,2.1).lineTo(-3.6,5.9).lineTo(7.4,5.9).lineTo(6.5,10.5).closePath();
	this.shape_1.setTransform(291.55,2.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.3,10.5).lineTo(-6.1,-10.5).lineTo(10.3,-10.5).lineTo(9.4,-5.9).lineTo(-1.2,-5.9).lineTo(-1.9,-2.4).lineTo(7.4,-2.4).lineTo(6.5,2.1).lineTo(-2.8,2.1).lineTo(-3.5,5.9).lineTo(7.4,5.9).lineTo(6.5,10.5).closePath();
	this.shape_2.setTransform(270.3,2.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.5).lineTo(3.5,2.3).lineTo(-4.5,2.3).lineTo(-6.1,10.5).lineTo(-12.1,10.5).lineTo(-7.9,-10.5).lineTo(-2,-10.5).lineTo(-3.5,-2.6).lineTo(4.6,-2.6).lineTo(6.1,-10.5).lineTo(12.1,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_3.setTransform(246.575,2.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.5).lineTo(3.5,2.3).lineTo(-4.5,2.3).lineTo(-6.1,10.5).lineTo(-12.1,10.5).lineTo(-7.9,-10.5).lineTo(-2,-10.5).lineTo(-3.5,-2.6).lineTo(4.6,-2.6).lineTo(6.1,-10.5).lineTo(12.1,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_4.setTransform(221.075,2.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.1,10.5).lineTo(4.6,-1.8).lineTo(-6.5,10.5).lineTo(-12.1,10.5).lineTo(-8,-10.5).lineTo(-2.1,-10.5).lineTo(-4.7,1.9).lineTo(6.4,-10.5).lineTo(12.2,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_5.setTransform(195.55,2.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-12.8,10.3).lineTo(-11.5,5.5).lineTo(-10.8,5.5).curveTo(-9.7,5.5,-8.9,4.8).curveTo(-8.1,4.1,-7.4,2.4).curveTo(-6.8,0.7,-6.1,-2.3).lineTo(-4.2,-10.7).lineTo(12.8,-10.7).lineTo(8.6,10.3).lineTo(2.7,10.3).lineTo(6,-6).lineTo(0,-6).lineTo(-1,-1.4).curveTo(-2.1,3.3,-3.3,5.9).curveTo(-4.5,8.4,-6.1,9.6).curveTo(-7.7,10.7,-10.1,10.7).curveTo(-11.5,10.7,-12.8,10.3).closePath();
	this.shape_6.setTransform(169.25,2.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5.6,12.6).lineTo(6.4,8.4).lineTo(-7,8.4).lineTo(-7.8,12.6).lineTo(-13.3,12.6).lineTo(-11.5,3.7).lineTo(-10.9,3.7).curveTo(-9,3.6,-7.7,1).curveTo(-6.3,-1.7,-5.2,-6.4).lineTo(-3.6,-12.6).lineTo(13.3,-12.6).lineTo(10,3.7).lineTo(12.9,3.7).lineTo(11,12.6).closePath().moveTo(-0.1,-5.4).curveTo(-1,-2,-1.7,0.2).curveTo(-2.5,2.4,-3.5,3.7).lineTo(4.1,3.7).lineTo(6.4,-7.9).lineTo(0.4,-7.9).closePath();
	this.shape_7.setTransform(142.5,4.225);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-12.8,10.3).lineTo(-11.5,5.5).lineTo(-10.7,5.5).curveTo(-9.7,5.5,-8.9,4.8).curveTo(-8.1,4.1,-7.5,2.4).curveTo(-6.8,0.7,-6.1,-2.3).lineTo(-4.1,-10.7).lineTo(12.8,-10.7).lineTo(8.6,10.3).lineTo(2.8,10.3).lineTo(6,-6).lineTo(0,-6).lineTo(-1.1,-1.4).curveTo(-2.1,3.3,-3.3,5.9).curveTo(-4.5,8.4,-6.1,9.6).curveTo(-7.7,10.7,-10.2,10.7).curveTo(-11.5,10.7,-12.8,10.3).closePath();
	this.shape_8.setTransform(108,2.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.9,9.8).curveTo(-9.2,8.6,-10.5,6.5).curveTo(-11.8,4.4,-11.8,1.7).curveTo(-11.8,-1.9,-10.1,-4.8).curveTo(-8.5,-7.7,-5.5,-9.3).curveTo(-2.5,-10.9,1.3,-10.9).curveTo(4.5,-10.9,6.8,-9.8).curveTo(9.2,-8.6,10.5,-6.5).curveTo(11.8,-4.4,11.8,-1.7).curveTo(11.8,1.9,10.1,4.8).curveTo(8.4,7.6,5.4,9.3).curveTo(2.5,10.9,-1.4,10.9).curveTo(-4.5,10.9,-6.9,9.8).closePath().moveTo(-2.7,-5).curveTo(-4.2,-4,-5,-2.4).curveTo(-5.8,-0.7,-5.8,1.3).curveTo(-5.8,3.4,-4.5,4.7).curveTo(-3.2,6,-0.8,6).curveTo(1.1,6,2.6,5).curveTo(4.1,4.1,4.9,2.3).curveTo(5.8,0.7,5.8,-1.3).curveTo(5.8,-3.5,4.4,-4.7).curveTo(3.1,-6,0.8,-6).curveTo(-1.2,-6,-2.7,-5).closePath();
	this.shape_9.setTransform(83.225,2.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-11,10.5).lineTo(-6.9,-10.5).lineTo(3.7,-10.5).curveTo(7.3,-10.5,9.1,-9.2).curveTo(11.1,-8,11,-5.6).curveTo(11.1,-3.8,10,-2.4).curveTo(9,-1.1,7.3,-0.4).curveTo(8.7,0.3,9.3,1.3).curveTo(10.1,2.4,10.1,3.8).curveTo(10.1,7.1,7.4,8.8).curveTo(4.7,10.5,0.5,10.5).closePath().moveTo(-4.4,6.2).lineTo(0.8,6.2).curveTo(2.4,6.2,3.3,5.6).curveTo(4.2,4.9,4.2,3.7).curveTo(4.2,2.8,3.6,2.4).curveTo(2.9,2,1.8,1.9).lineTo(-3.5,1.9).closePath().moveTo(-2.7,-2.2).lineTo(1.6,-2.2).curveTo(3.2,-2.2,4,-2.7).curveTo(4.9,-3.4,4.8,-4.5).curveTo(4.8,-6.2,2.4,-6.2).lineTo(-1.8,-6.2).closePath();
	this.shape_10.setTransform(57.55,2.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,10.5).lineTo(-3.5,-5.8).lineTo(-9.8,-5.8).lineTo(-8.9,-10.5).lineTo(9.8,-10.5).lineTo(8.9,-5.8).lineTo(2.4,-5.8).lineTo(-0.8,10.5).closePath();
	this.shape_11.setTransform(37.325,2.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,9.8).curveTo(-8.3,8.6,-9.6,6.5).curveTo(-10.8,4.4,-10.8,1.7).curveTo(-10.8,-1.9,-9.2,-4.8).curveTo(-7.5,-7.7,-4.5,-9.3).curveTo(-1.5,-10.9,2.3,-10.9).curveTo(5.2,-10.9,7.5,-9.9).curveTo(9.7,-8.8,10.8,-7).lineTo(6.6,-3.5).curveTo(5,-6,1.9,-6).curveTo(-0.1,-6,-1.6,-5.1).curveTo(-3.1,-4.1,-4,-2.5).curveTo(-4.8,-0.8,-4.8,1.3).curveTo(-4.8,3.4,-3.5,4.7).curveTo(-2.1,6,0.3,6).curveTo(3.3,6,5.4,3.6).lineTo(8.9,7).curveTo(7.2,9.1,4.9,10).curveTo(2.7,10.9,-0.3,10.9).curveTo(-3.5,10.9,-5.9,9.8).closePath();
	this.shape_12.setTransform(14.225,2.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol103, new cjs.Rectangle(0,-22.6,314.1,45.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,9.4).curveTo(-8,8.3,-9.2,6.3).curveTo(-10.5,4.2,-10.5,1.7).curveTo(-10.5,-1.8,-8.9,-4.6).curveTo(-7.3,-7.4,-4.4,-9).curveTo(-1.5,-10.6,2.2,-10.6).curveTo(5.1,-10.6,7.2,-9.6).curveTo(9.4,-8.5,10.5,-6.8).lineTo(6.3,-3.4).curveTo(4.9,-5.8,1.9,-5.8).curveTo(-0.1,-5.8,-1.6,-4.9).curveTo(-3,-4,-3.9,-2.4).curveTo(-4.7,-0.7,-4.7,1.2).curveTo(-4.7,3.3,-3.4,4.6).curveTo(-2,5.8,0.3,5.8).curveTo(3.2,5.8,5.2,3.5).lineTo(8.6,6.8).curveTo(7,8.8,4.8,9.6).curveTo(2.6,10.5,-0.3,10.5).curveTo(-3.4,10.5,-5.7,9.4).closePath();
	this.shape.setTransform(95.425,2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(6.1,10.1).lineTo(5.3,6.2).lineTo(-3.4,6.2).lineTo(-5.7,10.1).lineTo(-11.8,10.1).lineTo(1.2,-10.2).lineTo(6.9,-10.2).lineTo(11.8,10.1).closePath().moveTo(-0.9,2).lineTo(4.4,2).lineTo(3,-4.6).closePath();
	this.shape_1.setTransform(69.075,2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.1).lineTo(3.4,2.2).lineTo(-4.4,2.2).lineTo(-5.9,10.1).lineTo(-11.7,10.1).lineTo(-7.6,-10.2).lineTo(-1.9,-10.2).lineTo(-3.4,-2.5).lineTo(4.4,-2.5).lineTo(5.9,-10.2).lineTo(11.7,-10.2).lineTo(7.6,10.1).closePath();
	this.shape_2.setTransform(46.325,2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-11.7,9.5).lineTo(-9.8,5.5).curveTo(-9,5.7,-8.1,5.8).curveTo(-6.2,5.8,-4.8,4).lineTo(-4.6,3.9).lineTo(-9.6,-10.4).lineTo(-3.6,-10.4).lineTo(-0.8,-0.7).lineTo(6,-10.4).lineTo(11.7,-10.4).lineTo(0.2,5.5).curveTo(-1.6,7.9,-3.7,9.2).curveTo(-5.8,10.4,-8,10.4).curveTo(-9.9,10.4,-11.7,9.5).closePath();
	this.shape_3.setTransform(14.225,2.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol102, new cjs.Rectangle(0,-22,108.5,44), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.2,4.1).lineTo(-1.2,0.5).curveTo(-1.8,0.2,-2.1,-0.4).curveTo(-2.5,-0.9,-2.5,-1.6).curveTo(-2.5,-2.7,-1.8,-3.4).curveTo(-1.1,-4.1,0,-4.1).curveTo(1.1,-4.1,1.8,-3.4).curveTo(2.5,-2.7,2.5,-1.6).lineTo(2.4,-0.6).lineTo(1.8,0.9).lineTo(0.4,4.1).closePath();
	this.shape.setTransform(95.2,8.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,9.9).lineTo(3.1,0.9).lineTo(-3.3,9.9).lineTo(-7.4,9.9).lineTo(-7.4,-5.5).lineTo(-3.1,-5.5).lineTo(-3.1,3.6).lineTo(3.3,-5.5).lineTo(7.4,-5.5).lineTo(7.4,9.9).closePath().moveTo(-3.4,-7.3).curveTo(-4.5,-8.2,-4.5,-10).lineTo(-1.6,-10).curveTo(-1.6,-9.2,-1.2,-8.8).curveTo(-0.8,-8.5,-0,-8.4).curveTo(0.8,-8.5,1.2,-8.8).curveTo(1.6,-9.2,1.6,-10).lineTo(4.5,-10).curveTo(4.5,-8.2,3.4,-7.3).curveTo(2.3,-6.4,-0,-6.4).curveTo(-2.4,-6.4,-3.4,-7.3).closePath();
	this.shape_1.setTransform(82.075,-0.75);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.5,7.7).lineTo(3.3,4.7).lineTo(-3.3,4.7).lineTo(-4.5,7.7).lineTo(-9,7.7).lineTo(-2.1,-7.7).lineTo(2.1,-7.7).lineTo(9,7.7).closePath().moveTo(-2,1.5).lineTo(1.9,1.5).lineTo(-0,-3.5).closePath();
	this.shape_2.setTransform(62.95,1.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3,7.7).lineTo(3,1.7).lineTo(-3,1.7).lineTo(-3,7.7).lineTo(-7.3,7.7).lineTo(-7.3,-7.7).lineTo(-3,-7.7).lineTo(-3,-1.9).lineTo(3,-1.9).lineTo(3,-7.7).lineTo(7.3,-7.7).lineTo(7.3,7.7).closePath();
	this.shape_3.setTransform(43.925,1.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.6,7.7).curveTo(-5.2,7.3,-6.8,6.5).lineTo(-5.4,3.5).curveTo(-4.4,4,-3.2,4.3).curveTo(-2,4.6,-0.9,4.5).curveTo(0.5,4.6,1.5,4.1).curveTo(2.3,3.7,2.4,2.7).curveTo(2.4,2.1,1.8,1.7).curveTo(1.2,1.5,0.2,1.5).lineTo(-3.7,1.5).lineTo(-3.7,-1.8).lineTo(-0.1,-1.8).curveTo(0.8,-1.7,1.2,-2.1).curveTo(1.8,-2.5,1.8,-3).curveTo(1.7,-3.8,1,-4.2).curveTo(0.3,-4.6,-0.9,-4.6).curveTo(-1.9,-4.6,-3,-4.4).curveTo(-4.1,-4,-5.1,-3.6).lineTo(-6.3,-6.8).curveTo(-3.9,-8,-0.9,-8.1).curveTo(1,-8,2.6,-7.5).curveTo(4.3,-6.9,5.2,-5.9).curveTo(6.2,-5,6.2,-3.6).curveTo(6.1,-2.5,5.6,-1.7).curveTo(5,-0.8,4,-0.3).curveTo(5.3,0.2,6.1,1.1).curveTo(6.7,2.1,6.7,3.4).curveTo(6.8,4.8,5.8,5.9).curveTo(4.8,6.9,3.1,7.4).curveTo(1.5,8.1,-0.5,8).curveTo(-2.1,8,-3.6,7.7).closePath();
	this.shape_4.setTransform(26.5,1.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,7.4).lineTo(-5.7,4.1).curveTo(-4.8,4.4,-4.2,4.3).curveTo(-3.5,4.4,-3,4.1).curveTo(-2.5,3.8,-2.1,3.2).lineTo(-8.1,-7.9).lineTo(-3.5,-7.9).lineTo(0.1,-0.4).lineTo(3.8,-7.9).lineTo(8.1,-7.9).lineTo(1.7,4).curveTo(0.7,5.9,-0.8,6.9).curveTo(-2.3,7.9,-4,7.9).curveTo(-5.3,7.9,-6.7,7.4).closePath();
	this.shape_5.setTransform(10.225,1.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol101, new cjs.Rectangle(0,-17.2,101.6,34.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.9,7.6).lineTo(-7.6,4).lineTo(-7,4.1).curveTo(-6.2,4.1,-5.7,3.4).curveTo(-5.3,2.7,-5,1.5).lineTo(-4.7,-1.7).lineTo(-4.5,-7.8).lineTo(7.9,-7.8).lineTo(7.9,7.6).lineTo(3.6,7.6).lineTo(3.6,-4.4).lineTo(-0.8,-4.4).lineTo(-0.9,-1.9).curveTo(-1,1.4,-1.5,3.5).curveTo(-1.9,5.6,-2.9,6.7).curveTo(-3.9,7.8,-5.9,7.8).curveTo(-6.7,7.8,-7.9,7.6).closePath();
	this.shape.setTransform(139.35,1.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.9).curveTo(-6.3,6,-7.5,4.1).curveTo(-8.6,2.3,-8.6,-0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-7).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-7).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,-0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,6,4.4,6.9).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,6.9).closePath().moveTo(-2.1,-3.9).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,-0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.9).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.9).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,-0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.9).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.9).closePath();
	this.shape_1.setTransform(120.975,1.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(0.5,-7.7).curveTo(3.3,-7.7,4.8,-6.7).curveTo(6.3,-5.6,6.3,-3.7).curveTo(6.3,-2.5,5.8,-1.7).curveTo(5.2,-0.8,4.2,-0.4).curveTo(5.6,0.1,6.3,1).curveTo(7,2,7,3.3).curveTo(7,5.4,5.4,6.5).curveTo(3.8,7.7,0.9,7.7).closePath().moveTo(-2.7,4.6).lineTo(0.7,4.6).curveTo(2.6,4.5,2.6,3).curveTo(2.6,1.4,0.7,1.4).lineTo(-2.7,1.4).closePath().moveTo(-2.7,-1.5).lineTo(0.1,-1.5).curveTo(1.9,-1.6,1.9,-3.1).curveTo(1.9,-4.6,0.1,-4.6).lineTo(-2.7,-4.6).closePath();
	this.shape_2.setTransform(103.05,1.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.1,7.7).lineTo(-2.1,-4.3).lineTo(-6.8,-4.3).lineTo(-6.8,-7.7).lineTo(6.9,-7.7).lineTo(6.9,-4.3).lineTo(2.2,-4.3).lineTo(2.2,7.7).closePath();
	this.shape_3.setTransform(86.2,1.55);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.4,7).curveTo(-5.3,6,-6.4,4.1).curveTo(-7.5,2.3,-7.5,-0).curveTo(-7.5,-2.3,-6.4,-4.2).curveTo(-5.3,-5.9,-3.4,-7).curveTo(-1.5,-8,0.9,-8).curveTo(3,-8,4.7,-7.2).curveTo(6.4,-6.5,7.5,-5.1).lineTo(4.8,-2.6).curveTo(3.3,-4.4,1.1,-4.4).curveTo(-0.1,-4.4,-1.1,-3.9).curveTo(-2.1,-3.3,-2.6,-2.3).curveTo(-3.1,-1.3,-3.1,-0).curveTo(-3.1,1.3,-2.6,2.3).curveTo(-2.1,3.3,-1.1,3.9).curveTo(-0.1,4.4,1.1,4.4).curveTo(3.3,4.4,4.8,2.6).lineTo(7.5,5.1).curveTo(6.4,6.5,4.7,7.3).curveTo(3,8,0.9,8).curveTo(-1.5,8,-3.4,7).closePath();
	this.shape_4.setTransform(70.125,1.55);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,10).lineTo(3.1,1).lineTo(-3.3,10).lineTo(-7.4,10).lineTo(-7.4,-5.4).lineTo(-3.1,-5.4).lineTo(-3.1,3.6).lineTo(3.3,-5.4).lineTo(7.4,-5.4).lineTo(7.4,10).closePath().moveTo(-3.4,-7.3).curveTo(-4.5,-8.2,-4.5,-9.9).lineTo(-1.6,-9.9).curveTo(-1.6,-9.2,-1.2,-8.8).curveTo(-0.8,-8.4,-0,-8.5).curveTo(0.8,-8.4,1.2,-8.8).curveTo(1.6,-9.2,1.6,-9.9).lineTo(4.5,-9.9).curveTo(4.5,-8.2,3.4,-7.3).curveTo(2.3,-6.4,-0,-6.4).curveTo(-2.4,-6.4,-3.4,-7.3).closePath();
	this.shape_5.setTransform(44.525,-0.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(5.9,-7.7).lineTo(5.9,-4.3).lineTo(-1.9,-4.3).lineTo(-1.9,-1.7).lineTo(5,-1.7).lineTo(5,1.5).lineTo(-1.9,1.5).lineTo(-1.9,4.4).lineTo(6.2,4.4).lineTo(6.2,7.7).closePath();
	this.shape_6.setTransform(27.475,1.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.8,7.7).lineTo(2.8,2.4).curveTo(1.1,3.1,-0.5,3).curveTo(-3.7,3,-5.4,1.5).curveTo(-7.1,-0,-7.1,-3).lineTo(-7.1,-7.7).lineTo(-2.8,-7.7).lineTo(-2.8,-3.4).curveTo(-2.8,-0.5,0.1,-0.5).curveTo(1.6,-0.5,2.8,-1).lineTo(2.8,-7.7).lineTo(7.1,-7.7).lineTo(7.1,7.7).closePath();
	this.shape_7.setTransform(9.9,1.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol100, new cjs.Rectangle(0,-17.1,152.1,34.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.8,7.2).curveTo(-2.5,6.4,-2.5,5.5).curveTo(-2.5,4.5,-1.8,3.8).curveTo(-1.1,3.2,0,3.2).curveTo(1.1,3.2,1.8,3.8).curveTo(2.5,4.5,2.5,5.5).curveTo(2.5,6.4,1.8,7.2).curveTo(1.1,7.8,0,7.8).curveTo(-1.1,7.8,-1.8,7.2).closePath().moveTo(-1.6,2).lineTo(-2.4,-7.8).lineTo(2.5,-7.8).lineTo(1.6,2).closePath();
	this.shape.setTransform(118.7,1.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(5.9,-7.7).lineTo(5.9,-4.3).lineTo(-1.9,-4.3).lineTo(-1.9,-1.7).lineTo(5,-1.7).lineTo(5,1.5).lineTo(-1.9,1.5).lineTo(-1.9,4.4).lineTo(6.2,4.4).lineTo(6.2,7.7).closePath();
	this.shape_1.setTransform(107.375,1.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.5,7.7).lineTo(-10.5,-7.7).lineTo(-6.2,-7.7).lineTo(-6.2,4.2).lineTo(-2.1,4.2).lineTo(-2.1,-7.7).lineTo(2.1,-7.7).lineTo(2.1,4.2).lineTo(6.2,4.2).lineTo(6.2,-7.7).lineTo(10.5,-7.7).lineTo(10.5,7.7).closePath();
	this.shape_2.setTransform(86.45,1.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.9,7.7).lineTo(-6.9,-7.7).lineTo(-2.6,-7.7).lineTo(-2.6,-2.8).lineTo(0.9,-2.8).curveTo(3.8,-2.8,5.3,-1.5).curveTo(6.9,-0.2,6.9,2.2).curveTo(6.9,4.9,5.1,6.3).curveTo(3.4,7.7,0.4,7.7).closePath().moveTo(-2.6,4.6).lineTo(0.1,4.6).curveTo(1.2,4.5,1.8,4).curveTo(2.5,3.4,2.5,2.3).curveTo(2.5,0.3,0.1,0.3).lineTo(-2.6,0.3).closePath();
	this.shape_3.setTransform(65.95,1.55);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.8,7.6).lineTo(-7.6,4).lineTo(-7,4.1).curveTo(-6.2,4.1,-5.7,3.4).curveTo(-5.3,2.7,-5,1.5).lineTo(-4.8,-1.7).lineTo(-4.5,-7.8).lineTo(7.8,-7.8).lineTo(7.8,7.6).lineTo(3.6,7.6).lineTo(3.6,-4.4).lineTo(-0.8,-4.4).lineTo(-0.9,-1.9).curveTo(-1.1,1.4,-1.4,3.5).curveTo(-1.9,5.6,-3,6.7).curveTo(-3.9,7.8,-5.9,7.8).curveTo(-6.8,7.8,-7.8,7.6).closePath();
	this.shape_4.setTransform(46.9,1.675);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.9).curveTo(-6.3,6,-7.5,4.1).curveTo(-8.6,2.3,-8.6,-0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-7).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-7).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,-0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,6,4.4,6.9).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,6.9).closePath().moveTo(-2.1,-3.9).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,-0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.9).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.9).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,-0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.9).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.9).closePath();
	this.shape_5.setTransform(28.525,1.55);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(5.8,-7.7).lineTo(5.8,-4.3).lineTo(-2.7,-4.3).lineTo(-2.7,-1.8).lineTo(1.3,-1.8).curveTo(4,-1.8,5.5,-0.7).curveTo(7,0.5,7,2.8).curveTo(7,5.1,5.4,6.4).curveTo(3.7,7.7,0.7,7.7).closePath().moveTo(-2.7,4.6).lineTo(0.4,4.6).curveTo(1.5,4.6,2.1,4.1).curveTo(2.6,3.7,2.6,2.9).curveTo(2.6,1.2,0.4,1.2).lineTo(-2.7,1.2).closePath();
	this.shape_6.setTransform(10.675,1.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol99, new cjs.Rectangle(0,-17.1,125.2,34.3), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol98, new cjs.Rectangle(0,-42.5,182,85), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol97, new cjs.Rectangle(0,-55,214,110), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol96, new cjs.Rectangle(0,-51,230,102), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9F060C").beginStroke().moveTo(-366.7,45.5).lineTo(-366.7,-45.5).lineTo(366.7,-45.5).lineTo(366.7,45.5).closePath();
...
}).prototype = getMCSymbolPrototype(lib.Symbol26, new cjs.Rectangle(0,-22,51,51), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol25, new cjs.Rectangle(0,-22,50,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.6,6.3).lineTo(-1.9,-0.1).lineTo(-1.9,6.3).lineTo(-5.1,6.3).lineTo(-5.1,-6.3).lineTo(-2.6,-6.3).lineTo(1.9,0.1).lineTo(1.9,-6.3).lineTo(5.1,-6.3).lineTo(5.1,6.3).closePath();
	this.shape.setTransform(359.975,0.45);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.6,5.2).curveTo(-5,4,-5,2).lineTo(-5,-6.4).lineTo(-1.8,-6.4).lineTo(-1.8,1.7).curveTo(-1.8,3.3,0,3.3).curveTo(1.7,3.3,1.7,1.7).lineTo(1.7,-6.4).lineTo(5,-6.4).lineTo(5,2).curveTo(5,4,3.6,5.2).curveTo(2.2,6.4,0,6.4).curveTo(-2.2,6.4,-3.6,5.2).closePath();
	this.shape_1.setTransform(347.1,0.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.6,4.7).curveTo(-6.5,2.8,-6.5,-0).curveTo(-6.5,-2.7,-4.6,-4.7).curveTo(-2.7,-6.5,0.1,-6.6).curveTo(1.8,-6.6,3.3,-5.8).curveTo(4.8,-5,5.6,-3.7).lineTo(2.8,-2.1).curveTo(2.5,-2.7,1.7,-3.1).curveTo(1,-3.4,0.1,-3.4).curveTo(-1.4,-3.4,-2.3,-2.4).curveTo(-3.3,-1.5,-3.3,0.1).curveTo(-3.3,1.5,-2.3,2.5).curveTo(-1.4,3.5,0.3,3.5).curveTo(2.5,3.5,3.2,1.9).lineTo(0.1,1.9).lineTo(0.1,-0.9).lineTo(6.5,-0.9).lineTo(6.5,0.4).curveTo(6.5,3.2,4.8,4.9).curveTo(3,6.5,0.3,6.6).curveTo(-2.7,6.6,-4.6,4.7).closePath();
	this.shape_2.setTransform(333.25,0.45);
	...
	this.shape_3.setTransform(318.15,0.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(4,-6.3).lineTo(4,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_4.setTransform(305.45,0.45);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.1,5.8).curveTo(-4.4,4.9,-5,3.4).lineTo(-2.2,1.9).curveTo(-1.5,3.5,0.2,3.5).curveTo(1.7,3.5,1.8,2.6).curveTo(1.8,2.2,0.9,1.7).lineTo(-0.7,1.3).curveTo(-2.6,0.7,-3.5,-0.2).curveTo(-4.4,-1.1,-4.4,-2.6).curveTo(-4.4,-4.4,-3.2,-5.5).curveTo(-1.9,-6.6,-0,-6.6).curveTo(1.5,-6.6,2.8,-5.8).curveTo(4,-5.1,4.6,-3.7).lineTo(1.9,-2.1).curveTo(1.4,-3.5,-0,-3.5).curveTo(-0.6,-3.5,-0.9,-3.3).curveTo(-1.2,-3,-1.2,-2.7).curveTo(-1.2,-2.3,-0.8,-2).curveTo(-0.4,-1.7,1,-1.3).lineTo(2.5,-0.8).lineTo(3.7,-0.1).curveTo(4.9,0.8,4.9,2.6).curveTo(4.9,4.5,3.7,5.6).curveTo(2.3,6.5,0.2,6.6).curveTo(-1.8,6.5,-3.1,5.8).closePath();
	this.shape_5.setTransform(294.15,0.45);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.1,4.7).curveTo(-6,2.9,-6,-0).curveTo(-6,-2.8,-4.1,-4.7).curveTo(-2.3,-6.6,0.6,-6.6).curveTo(2.3,-6.5,3.8,-5.8).curveTo(5.2,-4.9,6,-3.6).lineTo(3.2,-2).curveTo(2.9,-2.7,2.2,-3.1).curveTo(1.4,-3.4,0.6,-3.4).curveTo(-0.9,-3.4,-1.9,-2.4).curveTo(-2.8,-1.5,-2.8,-0).curveTo(-2.8,1.5,-1.9,2.5).curveTo(-0.9,3.4,0.6,3.4).curveTo(1.4,3.4,2.2,3.1).curveTo(2.9,2.7,3.2,2).lineTo(6,3.6).curveTo(5.2,4.9,3.8,5.8).curveTo(2.3,6.5,0.6,6.6).curveTo(-2.3,6.6,-4.1,4.7).closePath();
	this.shape_6.setTransform(276.3,0.45);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(4,-6.3).lineTo(4,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_7.setTransform(259.1,0.45);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,6.3).lineTo(1.9,-0.1).lineTo(-2.6,6.3).lineTo(-5.1,6.3).lineTo(-5.1,-6.3).lineTo(-1.9,-6.3).lineTo(-1.9,0.1).lineTo(2.6,-6.3).lineTo(5.1,-6.3).lineTo(5.1,6.3).closePath();
	this.shape_8.setTransform(246.975,0.45);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.8,6.3).lineTo(1.8,1.4).lineTo(-1.8,1.4).lineTo(-1.8,6.3).lineTo(-5,6.3).lineTo(-5,-6.3).lineTo(-1.8,-6.3).lineTo(-1.8,-1.6).lineTo(1.8,-1.6).lineTo(1.8,-6.3).lineTo(5,-6.3).lineTo(5,6.3).closePath();
	this.shape_9.setTransform(233.925,0.45);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(3.9,-6.3).lineTo(3.9,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_10.setTransform(222.35,0.45);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.4,6.3).lineTo(-5.4,3.3).curveTo(-4.4,3.4,-4,3).curveTo(-3.6,2.5,-3.5,1.2).lineTo(-3.5,-6.3).lineTo(5.5,-6.3).lineTo(5.5,6.3).lineTo(2.2,6.3).lineTo(2.2,-3.2).lineTo(-0.3,-3.2).lineTo(-0.3,1.4).curveTo(-0.3,4.5,-1.9,5.6).curveTo(-3.1,6.3,-4.7,6.3).lineTo(-5.4,6.3).closePath();
	this.shape_11.setTransform(209.9,0.4682);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.8,6.3).lineTo(-4.8,-6.3).lineTo(0.2,-6.3).curveTo(2.1,-6.3,3.2,-5.3).curveTo(4.3,-4.4,4.3,-2.7).curveTo(4.3,-1.2,3.2,-0.2).curveTo(4.8,0.7,4.8,2.6).curveTo(4.8,4.3,3.6,5.3).curveTo(2.4,6.3,0.5,6.3).closePath().moveTo(-1.6,3.4).lineTo(0.4,3.4).curveTo(0.9,3.4,1.2,3.1).curveTo(1.5,2.8,1.5,2.3).curveTo(1.5,1.9,1.2,1.6).curveTo(0.9,1.3,0.4,1.3).lineTo(-1.6,1.3).closePath().moveTo(-1.6,-1.4).lineTo(0.1,-1.4).curveTo(0.5,-1.5,0.8,-1.7).curveTo(1.1,-2,1.1,-2.4).curveTo(1.1,-2.9,0.8,-3.2).curveTo(0.5,-3.4,0.1,-3.4).lineTo(-1.6,-3.4).closePath();
	this.shape_12.setTransform(198.275,0.45);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.6,6.3).lineTo(2.1,4.5).lineTo(-2.1,4.5).lineTo(-2.6,6.3).lineTo(-6.1,6.3).lineTo(-2,-6.3).lineTo(2,-6.3).lineTo(6.1,6.3).closePath().moveTo(-1.3,1.7).lineTo(1.3,1.7).lineTo(0,-2.6).closePath();
	this.shape_13.setTransform(185.475,0.45);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,6.3).lineTo(-1.6,-3.2).lineTo(-4.7,-3.2).lineTo(-4.7,-6.3).lineTo(4.7,-6.3).lineTo(4.7,-3.2).lineTo(1.6,-3.2).lineTo(1.6,6.3).closePath();
	this.shape_14.setTransform(173.575,0.45);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.1,4.7).curveTo(-6,2.9,-6,-0).curveTo(-6,-2.8,-4.1,-4.7).curveTo(-2.3,-6.6,0.6,-6.6).curveTo(2.3,-6.5,3.8,-5.8).curveTo(5.2,-4.9,6,-3.6).lineTo(3.2,-2).curveTo(2.9,-2.7,2.1,-3.1).curveTo(1.4,-3.4,0.6,-3.4).curveTo(-0.9,-3.4,-1.9,-2.4).curveTo(-2.8,-1.5,-2.8,-0).curveTo(-2.8,1.5,-1.9,2.5).curveTo(-0.9,3.4,0.6,3.4).curveTo(1.4,3.4,2.1,3.1).curveTo(2.9,2.7,3.2,2).lineTo(6,3.6).curveTo(5.2,4.9,3.8,5.8).curveTo(2.3,6.5,0.6,6.6).curveTo(-2.3,6.6,-4.1,4.7).closePath();
	this.shape_15.setTransform(161.2,0.45);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3,7.5).lineTo(3,5.1).lineTo(-3,5.1).lineTo(-3,7.5).lineTo(-6.1,7.5).lineTo(-6.1,2).lineTo(-4.9,2).curveTo(-4,0.6,-4,-2).lineTo(-4,-7.5).lineTo(4.8,-7.5).lineTo(4.8,2).lineTo(6.1,2).lineTo(6.1,7.5).closePath().moveTo(-0.7,-2).curveTo(-0.7,0.5,-1.5,2).lineTo(1.6,2).lineTo(1.6,-4.5).lineTo(-0.7,-4.5).closePath();
	this.shape_16.setTransform(147.25,1.65);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.1,6.3).lineTo(-4.1,-6.3).lineTo(3.9,-6.3).lineTo(3.9,-3.3).lineTo(-0.8,-3.3).lineTo(-0.8,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.8,1.4).lineTo(-0.8,3.3).lineTo(4,3.3).lineTo(4,6.3).closePath();
	this.shape_17.setTransform(135.3,0.45);
	...
	this.shape_18.setTransform(124.35,0.45);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.6,6.3).lineTo(1.6,-3.2).lineTo(-1.7,-3.2).lineTo(-1.7,6.3).lineTo(-4.8,6.3).lineTo(-4.8,-6.3).lineTo(4.9,-6.3).lineTo(4.9,6.3).closePath();
	this.shape_19.setTransform(111.85,0.45);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(4,-6.3).lineTo(4,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_20.setTransform(95.3,0.45);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.7,4.7).curveTo(-6.6,2.8,-6.6,-0).curveTo(-6.6,-2.7,-4.7,-4.7).curveTo(-2.8,-6.5,0,-6.6).curveTo(2.8,-6.5,4.7,-4.7).curveTo(6.6,-2.7,6.6,-0).curveTo(6.6,2.8,4.7,4.7).curveTo(2.8,6.6,0,6.6).curveTo(-2.8,6.6,-4.7,4.7).closePath().moveTo(-2.4,-2.4).curveTo(-3.4,-1.5,-3.4,-0).curveTo(-3.4,1.5,-2.4,2.4).curveTo(-1.4,3.4,0,3.4).curveTo(1.4,3.4,2.4,2.4).curveTo(3.4,1.5,3.4,-0).curveTo(3.4,-1.5,2.4,-2.4).curveTo(1.4,-3.4,0,-3.4).curveTo(-1.4,-3.4,-2.4,-2.4).closePath();
	this.shape_21.setTransform(82.15,0.45);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.8,6.3).lineTo(-4.8,-6.3).lineTo(0.2,-6.3).curveTo(2.1,-6.3,3.2,-5.3).curveTo(4.3,-4.4,4.3,-2.7).curveTo(4.3,-1.2,3.2,-0.2).curveTo(4.8,0.7,4.8,2.6).curveTo(4.8,4.3,3.6,5.3).curveTo(2.4,6.3,0.5,6.3).closePath().moveTo(-1.6,3.4).lineTo(0.4,3.4).curveTo(0.9,3.4,1.2,3.1).curveTo(1.5,2.8,1.5,2.3).curveTo(1.5,1.9,1.2,1.6).curveTo(0.9,1.3,0.4,1.3).lineTo(-1.6,1.3).closePath().moveTo(-1.6,-1.4).lineTo(0.1,-1.4).curveTo(0.5,-1.5,0.8,-1.7).curveTo(1.1,-2,1.1,-2.4).curveTo(1.1,-2.9,0.8,-3.2).curveTo(0.5,-3.4,0.1,-3.4).lineTo(-1.6,-3.4).closePath();
	this.shape_22.setTransform(68.975,0.45);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.7,4.7).curveTo(-6.6,2.8,-6.6,-0).curveTo(-6.6,-2.7,-4.7,-4.7).curveTo(-2.8,-6.5,-0,-6.6).curveTo(2.8,-6.5,4.7,-4.7).curveTo(6.6,-2.7,6.6,-0).curveTo(6.6,2.8,4.7,4.7).curveTo(2.7,6.6,-0,6.6).curveTo(-2.8,6.6,-4.7,4.7).closePath().moveTo(-2.4,-2.4).curveTo(-3.4,-1.5,-3.4,-0).curveTo(-3.4,1.5,-2.4,2.4).curveTo(-1.5,3.4,-0,3.4).curveTo(1.5,3.4,2.4,2.4).curveTo(3.4,1.5,3.4,-0).curveTo(3.4,-1.5,2.4,-2.4).curveTo(1.5,-3.4,-0,-3.4).curveTo(-1.5,-3.4,-2.4,-2.4).closePath();
	this.shape_23.setTransform(55.1,0.45);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.6,6.3).lineTo(-2,0.6).lineTo(-2,6.3).lineTo(-5.2,6.3).lineTo(-5.2,-6.3).lineTo(-2,-6.3).lineTo(-2,-1).lineTo(1.4,-6.3).lineTo(5,-6.3).lineTo(1,-0.2).lineTo(5.2,6.3).closePath();
	this.shape_24.setTransform(41.875,0.45);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.2,4.7).curveTo(-6,2.9,-6,-0).curveTo(-6,-2.8,-4.2,-4.7).curveTo(-2.3,-6.6,0.6,-6.6).curveTo(2.3,-6.5,3.8,-5.8).curveTo(5.2,-4.9,6,-3.6).lineTo(3.2,-2).curveTo(2.9,-2.7,2.1,-3.1).curveTo(1.5,-3.4,0.6,-3.4).curveTo(-0.9,-3.4,-1.9,-2.4).curveTo(-2.8,-1.5,-2.8,-0).curveTo(-2.8,1.5,-1.9,2.5).curveTo(-0.9,3.4,0.6,3.4).curveTo(1.5,3.4,2.1,3.1).curveTo(2.9,2.7,3.2,2).lineTo(6,3.6).curveTo(5.2,4.9,3.8,5.8).curveTo(2.3,6.5,0.6,6.6).curveTo(-2.2,6.6,-4.2,4.7).closePath();
	this.shape_25.setTransform(28.2,0.45);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,6.3).lineTo(1.9,-0.1).lineTo(-2.6,6.3).lineTo(-5.1,6.3).lineTo(-5.1,-6.3).lineTo(-1.9,-6.3).lineTo(-1.9,0.1).lineTo(2.6,-6.3).lineTo(5.1,-6.3).lineTo(5.1,6.3).closePath();
	this.shape_26.setTransform(14.625,0.45);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.7,4.7).curveTo(-6.6,2.8,-6.6,-0).curveTo(-6.6,-2.7,-4.7,-4.7).curveTo(-2.8,-6.5,-0,-6.6).curveTo(2.8,-6.5,4.7,-4.7).curveTo(6.6,-2.7,6.6,-0).curveTo(6.6,2.8,4.7,4.7).curveTo(2.8,6.6,-0,6.6).curveTo(-2.8,6.6,-4.7,4.7).closePath().moveTo(-2.4,-2.4).curveTo(-3.4,-1.5,-3.4,-0).curveTo(-3.4,1.5,-2.4,2.4).curveTo(-1.4,3.4,-0,3.4).curveTo(1.4,3.4,2.4,2.4).curveTo(3.4,1.5,3.4,-0).curveTo(3.4,-1.5,2.4,-2.4).curveTo(1.4,-3.4,-0,-3.4).curveTo(-1.4,-3.4,-2.4,-2.4).closePath();
	this.shape_27.setTransform(0.45,0.45);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.7,6.3).lineTo(1.7,-3.2).lineTo(-1.7,-3.2).lineTo(-1.7,6.3).lineTo(-4.8,6.3).lineTo(-4.8,-6.3).lineTo(4.8,-6.3).lineTo(4.8,6.3).closePath();
	this.shape_28.setTransform(-13.45,0.45);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(4,-6.3).lineTo(4,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_29.setTransform(-30,0.45);
	...
	this.shape_30.setTransform(-43.15,0.45);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.8,6.3).lineTo(-4.8,-6.3).lineTo(0.2,-6.3).curveTo(2.1,-6.3,3.2,-5.3).curveTo(4.3,-4.4,4.3,-2.7).curveTo(4.3,-1.2,3.2,-0.2).curveTo(4.8,0.7,4.8,2.6).curveTo(4.8,4.3,3.6,5.3).curveTo(2.4,6.3,0.5,6.3).closePath().moveTo(-1.6,3.4).lineTo(0.4,3.4).curveTo(0.9,3.4,1.2,3.1).curveTo(1.5,2.8,1.5,2.3).curveTo(1.5,1.9,1.2,1.6).curveTo(0.9,1.3,0.4,1.3).lineTo(-1.6,1.3).closePath().moveTo(-1.6,-1.4).lineTo(0.1,-1.4).curveTo(0.5,-1.5,0.8,-1.7).curveTo(1.1,-2,1.1,-2.4).curveTo(1.1,-2.9,0.8,-3.2).curveTo(0.5,-3.4,0.1,-3.4).lineTo(-1.6,-3.4).closePath();
	this.shape_31.setTransform(-56.325,0.45);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.2,4.7).curveTo(-6,2.9,-6,-0).curveTo(-6,-2.8,-4.2,-4.7).curveTo(-2.3,-6.6,0.6,-6.6).curveTo(2.3,-6.5,3.8,-5.8).curveTo(5.2,-4.9,6,-3.6).lineTo(3.2,-2).curveTo(2.9,-2.7,2.1,-3.1).curveTo(1.5,-3.4,0.6,-3.4).curveTo(-0.9,-3.4,-1.9,-2.4).curveTo(-2.8,-1.5,-2.8,-0).curveTo(-2.8,1.5,-1.9,2.5).curveTo(-0.9,3.4,0.6,3.4).curveTo(1.5,3.4,2.1,3.1).curveTo(2.9,2.7,3.2,2).lineTo(6,3.6).curveTo(5.2,4.9,3.8,5.8).curveTo(2.3,6.5,0.6,6.6).curveTo(-2.2,6.6,-4.2,4.7).closePath();
	this.shape_32.setTransform(-69.55,0.45);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,8.1).lineTo(1.9,1.7).lineTo(-2.6,8.1).lineTo(-5.1,8.1).lineTo(-5.1,-4.6).lineTo(-1.9,-4.6).lineTo(-1.9,1.8).lineTo(2.6,-4.6).lineTo(5.1,-4.6).lineTo(5.1,8.1).closePath().moveTo(-2.9,-5.5).lineTo(-2.9,-8.1).lineTo(2.9,-8.1).lineTo(2.9,-5.5).closePath();
	this.shape_33.setTransform(-88.225,-1.3);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.8,6.3).lineTo(1.8,2.3).lineTo(1.1,2.3).lineTo(-1.5,6.3).lineTo(-5,6.3).lineTo(-2.1,1.8).curveTo(-3.3,1.3,-3.9,0.3).curveTo(-4.6,-0.7,-4.6,-2).curveTo(-4.6,-3.8,-3.3,-5).curveTo(-2,-6.3,-0,-6.3).lineTo(5,-6.3).lineTo(5,6.3).closePath().moveTo(-1,-3).curveTo(-1.4,-2.5,-1.4,-1.9).curveTo(-1.4,-1.3,-1,-0.9).curveTo(-0.6,-0.5,-0,-0.5).lineTo(1.8,-0.5).lineTo(1.8,-3.3).lineTo(-0,-3.3).curveTo(-0.6,-3.3,-1,-3).closePath();
	this.shape_34.setTransform(-101.3,0.45);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.7,6.3).lineTo(-4.7,-6.3).lineTo(0.2,-6.3).curveTo(2.1,-6.3,3.4,-5).curveTo(4.7,-3.8,4.7,-1.9).curveTo(4.7,0.1,3.4,1.3).curveTo(2.1,2.5,0.2,2.5).lineTo(-1.5,2.5).lineTo(-1.5,6.3).closePath().moveTo(-1.5,-0.5).lineTo(0.2,-0.5).curveTo(0.7,-0.6,1.1,-0.9).curveTo(1.5,-1.3,1.5,-1.9).curveTo(1.5,-2.5,1.1,-2.9).curveTo(0.7,-3.2,0.2,-3.2).lineTo(-1.5,-3.2).closePath();
	this.shape_35.setTransform(-112.55,0.45);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.3).lineTo(-4,-6.3).lineTo(4,-6.3).lineTo(4,-3.3).lineTo(-0.9,-3.3).lineTo(-0.9,-1.5).lineTo(3.5,-1.5).lineTo(3.5,1.4).lineTo(-0.9,1.4).lineTo(-0.9,3.3).lineTo(4.1,3.3).lineTo(4.1,6.3).closePath();
	this.shape_36.setTransform(-123.85,0.45);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.2,6.3).lineTo(3.2,-0.5).lineTo(0.2,4.6).lineTo(-0.2,4.6).lineTo(-3.2,-0.5).lineTo(-3.2,6.3).lineTo(-6.4,6.3).lineTo(-6.4,-6.3).lineTo(-3.2,-6.3).lineTo(-0,-0.9).lineTo(3.2,-6.3).lineTo(6.4,-6.3).lineTo(6.4,6.3).closePath();
	this.shape_37.setTransform(-137.325,0.45);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.8,3.6).lineTo(-2,2.1).curveTo(-1.5,3.5,0.1,3.5).curveTo(1.6,3.6,1.6,2.4).curveTo(1.6,1.4,0.4,1.3).lineTo(-1.5,1.3).lineTo(-1.5,-1.5).lineTo(-0.3,-1.5).curveTo(1.2,-1.5,1.2,-2.5).curveTo(1.2,-3.6,-0.1,-3.5).curveTo(-1.4,-3.5,-1.9,-2.3).lineTo(-4.6,-3.9).curveTo(-4,-5.1,-2.9,-5.9).curveTo(-1.7,-6.6,-0.1,-6.6).curveTo(1.9,-6.5,3.1,-5.6).curveTo(4.4,-4.5,4.4,-2.8).curveTo(4.4,-1.2,3.1,-0.2).curveTo(4.8,0.7,4.8,2.8).curveTo(4.8,4.5,3.5,5.6).curveTo(2.2,6.5,0.1,6.6).curveTo(-3.6,6.5,-4.8,3.6).closePath();
	this.shape_38.setTransform(-150.875,0.45);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,6.3).lineTo(1.9,-0.1).lineTo(-2.6,6.3).lineTo(-5.1,6.3).lineTo(-5.1,-6.3).lineTo(-1.9,-6.3).lineTo(-1.9,0.1).lineTo(2.6,-6.3).lineTo(5.1,-6.3).lineTo(5.1,6.3).closePath();
	this.shape_39.setTransform(-162.925,0.45);
...
}).prototype = getMCSymbolPrototype(lib.Symbol23, new cjs.Rectangle(-171,-13.3,540.3,26.700000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#B4060D").beginStroke().moveTo(-366.5,46.5).lineTo(-366.5,-46.5).lineTo(366.5,-46.5).lineTo(366.5,46.5).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill().beginStroke("#FFCC33").setStrokeStyle(2,1,1).moveTo(-50.6,-22.6).lineTo(50.6,-22.6).curveTo(60,-22.6,66.6,-16).curveTo(73.2,-9.4,73.2,-0).lineTo(73.2,0).curveTo(73.2,9.4,66.6,16).curveTo(60,22.6,50.6,22.6).lineTo(-50.6,22.6).curveTo(-60,22.6,-66.6,16).curveTo(-73.2,9.4,-73.2,0).lineTo(-73.2,-0).curveTo(-73.2,-9.4,-66.6,-16).curveTo(-60,-22.6,-50.6,-22.6).closePath();
	this.shape.setTransform(1.275,-1.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginLinearGradientFill(["#D1CC33","#FFCC33"],[0,1],-103.8,0,99,0).beginStroke().moveTo(-50.6,22.6).curveTo(-60,22.6,-66.6,16).curveTo(-73.2,9.4,-73.2,0).lineTo(-73.2,-0).curveTo(-73.2,-9.4,-66.6,-16).curveTo(-60,-22.6,-50.6,-22.6).lineTo(50.6,-22.6).curveTo(60,-22.6,66.6,-16).curveTo(73.2,-9.4,73.2,-0).lineTo(73.2,0).curveTo(73.2,9.4,66.6,16).curveTo(60,22.6,50.6,22.6).closePath();
	this.shape_1.setTransform(1.275,-1.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(-72.9,-24.6,148.4,47.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(272.6,24,1,1,0,0,0,62.6,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({x:382.6,alpha:1},19,cjs.Ease.quadOut).wait(147).to({_off:true},1).wait(344));

	// Layer_8
	this.instance_1 = new lib.Symbol100();
	this.instance_1.setTransform(256,1,1,1,0,0,0,76,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({x:326,alpha:1},19,cjs.Ease.quadOut).wait(147).to({_off:true},1).wait(344));

	// Layer_4
	this.instance_2 = new lib.Symbol101();
	this.instance_2.setTransform(349.8,-23.05,1,1,0,0,0,50.8,-0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off:false},0).to({x:239.8,alpha:1},19,cjs.Ease.quadOut).wait(147).to({_off:true},1).wait(344));

	// Layer_7
	this.instance_3 = new lib.Symbol98();
	this.instance_3.setTransform(677,2.5,1,1,0,0,0,91,0);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(8).to({_off:false},0).to({x:527,alpha:1},20,cjs.Ease.quadOut).to({x:547},126).wait(21).to({_off:true},1).wait(344));

	// Layer_6
	this.instance_4 = new lib.fon3();
	this.instance_4.setTransform(0,-45);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(175).to({_off:true},1).wait(344));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-45,768,90);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(686.55,2.5,0.3333,0.3333,0,0,0,25.5,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(27).to({_off:false},0).to({regY:0.1,scaleX:1.1961,scaleY:1.1961,y:2.6,alpha:0.6992},8).to({regY:0,scaleX:1,scaleY:1,x:686.5,y:2.5},3).wait(99).to({_off:true},1).wait(342));

	// Layer_5
	this.instance_1 = new lib.Symbol25();
	this.instance_1.setTransform(52,3,0.24,0.24,0,0,0,25,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(27).to({_off:false},0).to({regX:25.1,scaleX:1.24,scaleY:1.24,x:52.1,alpha:0.6992},8).to({regX:25,scaleX:1,scaleY:1,x:52},3).wait(99).to({_off:true},1).wait(342));

	// Layer_3
	this.instance_2 = new lib.Symbol23();
	this.instance_2.setTransform(408.3,59.85,1,1,0,0,0,140.3,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).to({y:19.85},14).to({y:23.85},4).wait(106).to({_off:true},1).wait(342));

	// Layer_2
	this.instance_3 = new lib.Symbol1();
	this.instance_3.setTransform(368.2,0.5,1.1208,1.1208,0,0,0,101.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.5591,scaleY:0.5591,x:368.1,y:-15.45},24).to({regX:101.5,regY:0.1,scaleX:0.6577,scaleY:0.6577,x:368,y:-14.45},4).wait(109).to({_off:true},1).wait(342));

	// Layer_1
	this.instance_4 = new lib.Symbol21();
	this.instance_4.setTransform(366.5,0,1,1,0,0,0,366.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(137).to({_off:true},1).wait(342));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.6,2.5).curveTo(-3.7,1.5,-3.7,0).curveTo(-3.7,-1.5,-2.6,-2.5).curveTo(-1.6,-3.6,0,-3.6).curveTo(1.6,-3.6,2.6,-2.5).curveTo(3.7,-1.5,3.7,-0).lineTo(3.7,0).curveTo(3.7,1.5,2.6,2.5).curveTo(1.6,3.6,-0,3.6).curveTo(-1.6,3.6,-2.6,2.5).closePath().moveTo(-1.5,-1.6).curveTo(-2.1,-0.9,-2.1,-0).lineTo(-2.1,0).curveTo(-2.1,0.9,-1.5,1.6).curveTo(-0.9,2.2,0,2.2).curveTo(0.9,2.2,1.5,1.6).curveTo(2.1,0.9,2.1,0).curveTo(2.1,-0.9,1.5,-1.6).curveTo(0.9,-2.2,-0,-2.2).curveTo(-0.9,-2.2,-1.5,-1.6).closePath();
	this.shape.setTransform(42.525,6.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.6,3.4).lineTo(1.6,0.7).lineTo(-1.6,0.7).lineTo(-1.6,3.4).lineTo(-3.2,3.4).lineTo(-3.2,-3.4).lineTo(-1.6,-3.4).lineTo(-1.6,-0.7).lineTo(1.6,-0.7).lineTo(1.6,-3.4).lineTo(3.1,-3.4).lineTo(3.1,3.4).closePath();
	this.shape_1.setTransform(33.6,6.125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-0.8,3.4).lineTo(-0.8,-2).lineTo(-3.2,-2).lineTo(-3.2,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-2).lineTo(0.8,-2).lineTo(0.8,3.4).closePath();
	this.shape_2.setTransform(25.325,6.125);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.4,3).curveTo(-3.1,2.4,-3.1,1.4).lineTo(-3.1,1.4).curveTo(-3.1,0.3,-2.3,-0.2).curveTo(-1.6,-0.8,-0.3,-0.8).curveTo(0.7,-0.8,1.6,-0.5).lineTo(1.6,-0.7).curveTo(1.6,-2.2,-0.1,-2.2).curveTo(-1,-2.2,-2.1,-1.7).lineTo(-2.5,-3).curveTo(-1.2,-3.5,0.1,-3.5).curveTo(1.6,-3.5,2.4,-2.8).curveTo(3.1,-2,3.1,-0.7).lineTo(3.1,3.4).lineTo(1.6,3.4).lineTo(1.6,2.6).curveTo(0.7,3.5,-0.7,3.6).curveTo(-1.7,3.5,-2.4,3).closePath().moveTo(-1.1,0.5).curveTo(-1.6,0.8,-1.6,1.3).curveTo(-1.6,1.8,-1.2,2.1).curveTo(-0.8,2.4,-0.2,2.4).curveTo(0.6,2.4,1.1,2).curveTo(1.6,1.6,1.6,1).lineTo(1.6,0.4).curveTo(0.9,0.2,0.1,0.2).curveTo(-0.7,0.2,-1.1,0.5).closePath();
	this.shape_3.setTransform(17.125,6.15);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(2,3.4).lineTo(0,-1.5).lineTo(-2,3.4).lineTo(-3.7,3.4).lineTo(-0.7,-3.5).lineTo(0.8,-3.5).lineTo(3.7,3.4).closePath();
	this.shape_4.setTransform(8.925,6.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.5,3.4).lineTo(1.5,-2).lineTo(-1.6,-2).lineTo(-1.6,3.4).lineTo(-3.1,3.4).lineTo(-3.1,-3.4).lineTo(3.2,-3.4).lineTo(3.2,3.4).closePath();
	this.shape_5.setTransform(0.25,6.125);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.1,2.5).curveTo(-3.2,1.5,-3.2,0).curveTo(-3.2,-1.5,-2.1,-2.5).curveTo(-1.1,-3.6,0.4,-3.6).curveTo(2,-3.6,3.2,-2.4).lineTo(2.2,-1.3).curveTo(1.3,-2.2,0.4,-2.2).curveTo(-0.4,-2.2,-1,-1.6).curveTo(-1.6,-0.9,-1.6,-0).lineTo(-1.6,0).curveTo(-1.6,0.9,-1,1.6).curveTo(-0.4,2.2,0.5,2.2).curveTo(1.4,2.2,2.2,1.4).lineTo(3.2,2.3).curveTo(2.6,2.9,2,3.2).curveTo(1.3,3.6,0.4,3.6).curveTo(-1.1,3.6,-2.1,2.5).closePath();
	this.shape_6.setTransform(-8.025,6.125);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.3,2.6).curveTo(-3.3,1.6,-3.3,0).lineTo(-3.3,-0).curveTo(-3.3,-1.5,-2.4,-2.5).curveTo(-1.4,-3.6,0,-3.6).curveTo(1.6,-3.6,2.5,-2.5).curveTo(3.3,-1.5,3.3,0.1).lineTo(3.3,0.5).lineTo(-1.7,0.5).curveTo(-1.6,1.4,-1.1,1.8).curveTo(-0.5,2.3,0.2,2.3).curveTo(1.2,2.3,2.1,1.5).lineTo(3,2.3).curveTo(1.9,3.6,0.2,3.6).curveTo(-1.3,3.6,-2.3,2.6).closePath().moveTo(-1.2,-1.8).curveTo(-1.7,-1.3,-1.8,-0.5).lineTo(1.8,-0.5).curveTo(1.7,-1.3,1.2,-1.8).curveTo(0.8,-2.3,0,-2.3).curveTo(-0.7,-2.3,-1.2,-1.8).closePath();
	this.shape_7.setTransform(-16.225,6.125);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.5,3.9).curveTo(-3.6,2.8,-3.6,0.7).curveTo(-3.6,-1.7,-2.7,-2.9).curveTo(-1.8,-4.2,0.1,-4.5).lineTo(2.6,-4.9).lineTo(2.8,-3.5).lineTo(0.4,-3.1).curveTo(-0.8,-2.9,-1.4,-2.3).curveTo(-1.9,-1.8,-2.1,-0.7).curveTo(-1.2,-1.7,0.4,-1.7).curveTo(1.9,-1.7,2.7,-0.9).curveTo(3.6,0,3.6,1.4).curveTo(3.6,2.9,2.6,3.9).curveTo(1.6,4.9,-0,4.9).curveTo(-1.5,4.9,-2.5,3.9).closePath().moveTo(-1.4,0).curveTo(-2,0.6,-2,1.5).lineTo(-2,1.5).curveTo(-2,2.4,-1.4,3).curveTo(-0.9,3.5,0,3.5).curveTo(0.9,3.5,1.5,2.9).curveTo(2,2.3,2,1.4).curveTo(2,0.6,1.5,0).curveTo(1,-0.5,0.1,-0.5).curveTo(-0.9,-0.5,-1.4,0).closePath();
	this.shape_8.setTransform(-24.875,4.825);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.6,4.8).lineTo(1.6,0.3).lineTo(-1.7,4.8).lineTo(-3.2,4.8).lineTo(-3.2,-2).lineTo(-1.6,-2).lineTo(-1.6,2.4).lineTo(1.7,-2).lineTo(3.1,-2).lineTo(3.1,4.8).closePath().moveTo(-1.6,-3.4).curveTo(-2.2,-3.9,-2.3,-4.8).lineTo(-1.2,-4.8).curveTo(-0.9,-4,-0,-4).curveTo(0.9,-4,1.1,-4.8).lineTo(2.2,-4.8).curveTo(2.2,-3.9,1.5,-3.4).curveTo(1,-2.9,-0,-2.9).curveTo(-0.9,-2.9,-1.6,-3.4).closePath();
	this.shape_9.setTransform(40.7,-8.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-3.1,4.1).lineTo(-2.6,2.9).curveTo(-2.1,3.2,-1.7,3.2).curveTo(-1.3,3.2,-1.1,3).curveTo(-0.9,2.8,-0.7,2.4).lineTo(-3.5,-4.5).lineTo(-1.9,-4.5).lineTo(0.1,0.6).lineTo(1.9,-4.5).lineTo(3.5,-4.5).lineTo(0.8,2.6).curveTo(0.4,3.6,-0.1,4.1).curveTo(-0.7,4.5,-1.5,4.5).curveTo(-2.4,4.5,-3.1,4.1).closePath();
	this.shape_10.setTransform(32.175,-6.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.5,3.9).curveTo(-3.6,2.8,-3.6,0.7).curveTo(-3.6,-1.7,-2.7,-2.9).curveTo(-1.8,-4.2,0.1,-4.5).lineTo(2.6,-4.9).lineTo(2.8,-3.5).lineTo(0.4,-3.1).curveTo(-0.8,-2.9,-1.4,-2.3).curveTo(-1.9,-1.8,-2.1,-0.7).curveTo(-1.2,-1.7,0.4,-1.7).curveTo(1.9,-1.7,2.7,-0.9).curveTo(3.6,0,3.6,1.4).curveTo(3.6,2.9,2.6,3.9).curveTo(1.6,4.9,-0,4.9).curveTo(-1.5,4.9,-2.5,3.9).closePath().moveTo(-1.4,0).curveTo(-2,0.6,-2,1.5).lineTo(-2,1.5).curveTo(-2,2.4,-1.4,3).curveTo(-0.9,3.5,0,3.5).curveTo(0.9,3.5,1.5,2.9).curveTo(2,2.3,2,1.4).curveTo(2,0.6,1.5,0).curveTo(1,-0.5,0.1,-0.5).curveTo(-0.9,-0.5,-1.4,0).closePath();
	this.shape_11.setTransform(23.575,-8.775);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.6,2.5).curveTo(-3.7,1.5,-3.7,0).curveTo(-3.7,-1.5,-2.6,-2.5).curveTo(-1.6,-3.6,0,-3.6).curveTo(1.6,-3.6,2.6,-2.5).curveTo(3.7,-1.5,3.7,-0).lineTo(3.7,0).curveTo(3.7,1.5,2.6,2.5).curveTo(1.6,3.6,-0,3.6).curveTo(-1.6,3.6,-2.6,2.5).closePath().moveTo(-1.5,-1.6).curveTo(-2.1,-0.9,-2.1,-0).lineTo(-2.1,0).curveTo(-2.1,0.9,-1.5,1.6).curveTo(-0.9,2.2,0,2.2).curveTo(0.9,2.2,1.5,1.6).curveTo(2.1,0.9,2.1,0).curveTo(2.1,-0.9,1.5,-1.6).curveTo(0.9,-2.2,-0,-2.2).curveTo(-0.9,-2.2,-1.5,-1.6).closePath();
	this.shape_12.setTransform(14.525,-7.475);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-3.5,4.5).lineTo(-3.5,-4.4).lineTo(-2,-4.4).lineTo(-2,-3.2).curveTo(-1.1,-4.5,0.3,-4.6).curveTo(1.6,-4.6,2.6,-3.6).curveTo(3.6,-2.7,3.6,-1).lineTo(3.6,-1).curveTo(3.6,0.6,2.6,1.6).curveTo(1.6,2.6,0.3,2.6).curveTo(-1.1,2.6,-2,1.4).lineTo(-2,4.5).closePath().moveTo(-1.5,-2.6).curveTo(-2,-2,-2.1,-1).lineTo(-2.1,-1).curveTo(-2,0,-1.5,0.6).curveTo(-0.8,1.2,-0,1.2).curveTo(0.8,1.2,1.3,0.6).curveTo(2,0,2,-1).lineTo(2,-1).curveTo(2,-2,1.3,-2.6).curveTo(0.8,-3.2,-0,-3.2).curveTo(-0.8,-3.2,-1.5,-2.6).closePath();
	this.shape_13.setTransform(5.6,-6.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.5,3.4).lineTo(1.5,-2).lineTo(-1.6,-2).lineTo(-1.6,3.4).lineTo(-3.2,3.4).lineTo(-3.2,-3.4).lineTo(3.1,-3.4).lineTo(3.1,3.4).closePath();
	this.shape_14.setTransform(-3.6,-7.475);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.6,2.5).curveTo(-3.7,1.5,-3.7,0).curveTo(-3.7,-1.5,-2.6,-2.5).curveTo(-1.6,-3.6,0,-3.6).curveTo(1.6,-3.6,2.6,-2.5).curveTo(3.7,-1.5,3.7,-0).lineTo(3.7,0).curveTo(3.7,1.5,2.6,2.5).curveTo(1.6,3.6,-0,3.6).curveTo(-1.6,3.6,-2.6,2.5).closePath().moveTo(-1.5,-1.6).curveTo(-2.1,-0.9,-2.1,-0).lineTo(-2.1,0).curveTo(-2.1,0.9,-1.5,1.6).curveTo(-0.9,2.2,0,2.2).curveTo(0.9,2.2,1.5,1.6).curveTo(2.1,0.9,2.1,0).curveTo(2.1,-0.9,1.5,-1.6).curveTo(0.9,-2.2,-0,-2.2).curveTo(-0.9,-2.2,-1.5,-1.6).closePath();
	this.shape_15.setTransform(-12.525,-7.475);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(2.2,4.5).lineTo(2.2,-3.1).lineTo(-2.1,-3.1).lineTo(-2.1,4.5).lineTo(-3.8,4.5).lineTo(-3.8,-4.5).lineTo(3.7,-4.5).lineTo(3.7,4.5).closePath();
	this.shape_16.setTransform(-22.25,-8.6);

	this.instance = new lib.Symbol4();
	this.instance.setTransform(7.5,-1.75,0.9234,0.9234,0,0,0,0,-1.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("rgba(0,0,0,0.086)").beginStroke().moveTo(-46.7,20.9).curveTo(-55.4,20.9,-61.5,14.7).curveTo(-67.6,8.7,-67.6,0.1).lineTo(-67.6,-0).curveTo(-67.6,-8.7,-61.5,-14.8).curveTo(-55.4,-20.9,-46.7,-20.9).lineTo(46.7,-20.9).curveTo(55.4,-20.9,61.5,-14.8).curveTo(67.6,-8.7,67.6,-0).lineTo(67.6,0.1).curveTo(67.6,8.7,61.5,14.7).curveTo(55.4,20.9,46.7,20.9).closePath();
	this.shape_17.setTransform(10.475,3.45);
...
}).prototype = getMCSymbolPrototype(lib.Symbol13, new cjs.Rectangle(-59.8,-22.7,137.89999999999998,47.099999999999994), null);


(lib.Symbol76_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.Symbol76_1("synched",0);
	this.instance.setTransform(30.9,-65.4,1,1,0,0,0,30.9,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({_off:true},81).wait(172));

	// Layer_3
	this.instance_1 = new lib.Symbol76_1("synched",0);
	this.instance_1.setTransform(30.9,-65.4,1,1,0,0,0,30.9,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(149).to({startPosition:149},0).to({_off:true},1).wait(143));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-118.7,61.7,106.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-283.8,61.3,1,1,0,0,0,157.1,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(60).to({_off:false},0).to({y:11.3},13).to({y:14.3},4).wait(84).to({_off:true},1).wait(78));

	// Layer_6
	this.instance_1 = new lib.Symbol102();
	this.instance_1.setTransform(-295.65,-15.35,0.4286,0.4286,0,0,0,54.2,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(49).to({_off:false},0).to({scaleX:1,scaleY:1,x:-295.7},10).wait(102).to({_off:true},1).wait(78));

	// Layer_5
	this.instance_2 = new lib.Symbol77("synched",0);
	this.instance_2.setTransform(-177.95,18.35,1,1,0,0,0,44,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90).to({_off:false},0).wait(71).to({startPosition:71},0).to({_off:true},1).wait(78));

	// Layer_3
	this.instance_3 = new lib.Symbol96();
	this.instance_3.setTransform(-759.85,22,1,1,13.482,0,0,24.1,-10);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:0,x:-618.9,y:-9},24,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(78));

	// Layer_2
	this.instance_4 = new lib.logowhite();
	this.instance_4.setTransform(39,-12);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(161).to({_off:true},1).wait(78));

	// Layer_1
	this.instance_5 = new lib.fon1();
	this.instance_5.setTransform(0,-45);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(161).to({_off:true},1).wait(78));

	// Layer_4
	this.instance_6 = new lib.Symbol97();
	this.instance_6.setTransform(20.1,44,1,1,-38.9856,0,0,212,3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(34).to({_off:false},0).to({rotation:7.9631,y:12},17).to({rotation:0,x:20},5,cjs.Ease.quadOut).wait(105).to({_off:true},1).wait(78));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-797.5,-100.4,961.5,318.20000000000005);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(461));

	// Layer_9
	this.instance = new lib.Symbol104();
	this.instance.setTransform(363.95,46.55,1,1,0,0,0,367.9,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(445).to({_off:false},0).to({alpha:1},15).wait(1));

	// Layer_5
	this.instance_1 = new lib.Symbol13();
	this.instance_1.setTransform(632.15,46.95,0.5244,0.5244,0,0,0,8.5,0.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(342).to({_off:false},0).to({regX:8.6,regY:0.9,scaleX:1.2172,scaleY:1.2172,x:632.25,y:47.1},12).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:632.15,y:46.9},5).wait(37).to({regX:8.6,regY:0.9,scaleX:0.907,scaleY:0.907,x:632.25,y:47},4).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:632.15,y:46.9},10).wait(51));

	// Layer_7 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_285 = new cjs.Graphics().moveTo(-538,56.5).lineTo(-456,-56.5).lineTo(535.9,-56.5).lineTo(453.9,56.5).closePath();
	var mask_graphics_286 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_287 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_288 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_289 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_290 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_291 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_292 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_293 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_294 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_295 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_296 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_297 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_298 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_299 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();
	var mask_graphics_300 = new cjs.Graphics().moveTo(-537,56.5).lineTo(-455,-56.5).lineTo(537,-56.5).lineTo(455,56.5).closePath();

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(285).to({graphics:mask_graphics_285,x:-538,y:48.55}).wait(1).to({graphics:mask_graphics_286,x:-484.5617,y:48.55}).wait(1).to({graphics:mask_graphics_287,x:-430.0983,y:48.55}).wait(1).to({graphics:mask_graphics_288,x:-375.635,y:48.55}).wait(1).to({graphics:mask_graphics_289,x:-321.1717,y:48.55}).wait(1).to({graphics:mask_graphics_290,x:-266.7083,y:48.55}).wait(1).to({graphics:mask_graphics_291,x:-212.245,y:48.55}).wait(1).to({graphics:mask_graphics_292,x:-157.7817,y:48.55}).wait(1).to({graphics:mask_graphics_293,x:-103.3183,y:48.55}).wait(1).to({graphics:mask_graphics_294,x:-48.855,y:48.55}).wait(1).to({graphics:mask_graphics_295,x:5.6083,y:48.55}).wait(1).to({graphics:mask_graphics_296,x:60.0717,y:48.55}).wait(1).to({graphics:mask_graphics_297,x:114.535,y:48.55}).wait(1).to({graphics:mask_graphics_298,x:168.9983,y:48.55}).wait(1).to({graphics:mask_graphics_299,x:223.4617,y:48.55}).wait(1).to({graphics:mask_graphics_300,x:277.925,y:48.55}).wait(161));

	// Layer_6
	this.instance_2 = new lib.Symbol89("synched",0);
	this.instance_2.setTransform(364,45,1,1,0,0,0,364,0);
	this.instance_2._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(285).to({_off:false},0).wait(176));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(162).to({_off:false},0).to({_off:true},138).wait(161));

	// Layer_8
	this.instance_4 = new lib.Symbol21();
	this.instance_4.setTransform(363,46.5,1,1,0,0,0,366.5,0);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({alpha:1},11).to({_off:true},1).wait(298));

	// Layer_3
	this.instance_5 = new lib.Symbol95("synched",0);
	this.instance_5.setTransform(646,44,1,1,0,0,0,82,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},162).wait(299));

	// Layer_4
	this.instance_6 = new lib.Symbol76();
	this.instance_6.setTransform(365.25,44.55,1,1,0,0,0,366.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},162).wait(299));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(130.5,-11.4,601.5,273.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728_90_atlas_1.png?1667763220841", id:"728_90_atlas_1"}
	],
	preloads: []
};
