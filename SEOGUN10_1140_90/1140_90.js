...
lib.ssMetadata = [
		{name:"1140_90_atlas_1", frames: [[0,216,129,35],[232,87,164,90],[0,112,230,102],[0,0,214,110],[400,0,50,50],[398,87,51,51],[232,179,203,56],[216,0,182,85]]}
];
...
(lib._11_logo = function() {
	this.initialize(ss["1140_90_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Symbol107, new cjs.Rectangle(0,-45,164,90), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(424.575,1.525);
	...
	this.shape_1.setTransform(409,1.4);
	...
	this.shape_2.setTransform(387.75,1.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.5).lineTo(3.5,2.4).lineTo(-4.5,2.4).lineTo(-6.1,10.5).lineTo(-12.1,10.5).lineTo(-7.9,-10.5).lineTo(-2,-10.5).lineTo(-3.5,-2.7).lineTo(4.6,-2.7).lineTo(6.1,-10.5).lineTo(12.1,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_3.setTransform(364.025,1.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.5).lineTo(3.5,2.4).lineTo(-4.5,2.4).lineTo(-6.1,10.5).lineTo(-12.1,10.5).lineTo(-7.9,-10.5).lineTo(-2,-10.5).lineTo(-3.5,-2.7).lineTo(4.6,-2.7).lineTo(6.1,-10.5).lineTo(12.1,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_4.setTransform(338.525,1.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.1,10.5).lineTo(4.6,-1.8).lineTo(-6.5,10.5).lineTo(-12.1,10.5).lineTo(-8,-10.5).lineTo(-2.1,-10.5).lineTo(-4.7,1.8).lineTo(6.4,-10.5).lineTo(12.2,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_5.setTransform(313,1.4);
	...
	this.shape_6.setTransform(286.7,1.575);
	...
	this.shape_7.setTransform(259.95,3.525);
	...
	this.shape_8.setTransform(225.45,1.575);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.9,9.8).curveTo(-9.2,8.6,-10.5,6.5).curveTo(-11.8,4.4,-11.8,1.7).curveTo(-11.8,-1.9,-10.1,-4.8).curveTo(-8.5,-7.7,-5.5,-9.3).curveTo(-2.5,-10.9,1.3,-10.9).curveTo(4.5,-10.9,6.8,-9.8).curveTo(9.2,-8.6,10.5,-6.5).curveTo(11.8,-4.4,11.8,-1.7).curveTo(11.8,1.9,10.1,4.8).curveTo(8.4,7.7,5.4,9.3).curveTo(2.5,10.9,-1.4,10.9).curveTo(-4.5,10.9,-6.9,9.8).closePath().moveTo(-2.7,-5).curveTo(-4.2,-4,-5,-2.4).curveTo(-5.8,-0.7,-5.8,1.3).curveTo(-5.8,3.5,-4.5,4.7).curveTo(-3.2,6,-0.8,6).curveTo(1.1,6,2.6,5).curveTo(4.1,4,4.9,2.4).curveTo(5.8,0.7,5.8,-1.3).curveTo(5.8,-3.4,4.4,-4.7).curveTo(3.1,-6,0.8,-6).curveTo(-1.2,-6,-2.7,-5).closePath();
	this.shape_9.setTransform(200.675,1.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-11,10.5).lineTo(-6.9,-10.5).lineTo(3.7,-10.5).curveTo(7.3,-10.5,9.1,-9.2).curveTo(11.1,-7.9,11,-5.6).curveTo(11.1,-3.7,10,-2.4).curveTo(9,-1.1,7.3,-0.3).curveTo(8.7,0.3,9.3,1.4).curveTo(10.1,2.4,10.1,3.8).curveTo(10.1,7.1,7.4,8.8).curveTo(4.7,10.5,0.5,10.5).closePath().moveTo(-4.4,6.2).lineTo(0.8,6.2).curveTo(2.4,6.2,3.3,5.6).curveTo(4.2,4.9,4.2,3.7).curveTo(4.2,2.8,3.6,2.4).curveTo(2.9,2,1.8,1.9).lineTo(-3.5,1.9).closePath().moveTo(-2.7,-2.1).lineTo(1.6,-2.1).curveTo(3.2,-2.2,4,-2.8).curveTo(4.9,-3.4,4.8,-4.6).curveTo(4.8,-6.2,2.4,-6.2).lineTo(-1.8,-6.2).closePath();
	this.shape_10.setTransform(175,1.4);
	...
	this.shape_11.setTransform(154.775,1.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,9.8).curveTo(-8.3,8.6,-9.6,6.5).curveTo(-10.8,4.4,-10.8,1.7).curveTo(-10.8,-1.9,-9.2,-4.8).curveTo(-7.5,-7.7,-4.5,-9.3).curveTo(-1.5,-10.9,2.3,-10.9).curveTo(5.2,-10.9,7.5,-9.9).curveTo(9.7,-8.9,10.8,-7).lineTo(6.6,-3.6).curveTo(5,-6,1.9,-6).curveTo(-0.1,-6,-1.6,-5.1).curveTo(-3.1,-4.1,-4,-2.5).curveTo(-4.8,-0.8,-4.8,1.3).curveTo(-4.8,3.4,-3.5,4.7).curveTo(-2.1,6,0.3,6).curveTo(3.3,6,5.4,3.5).lineTo(8.9,7).curveTo(7.2,9.1,4.9,10).curveTo(2.7,10.9,-0.3,10.9).curveTo(-3.5,10.9,-5.9,9.8).closePath();
	this.shape_12.setTransform(131.675,1.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,9.8).curveTo(-8.3,8.6,-9.6,6.5).curveTo(-10.8,4.4,-10.8,1.7).curveTo(-10.8,-1.9,-9.2,-4.8).curveTo(-7.5,-7.7,-4.5,-9.3).curveTo(-1.5,-10.9,2.3,-10.9).curveTo(5.2,-10.9,7.5,-9.9).curveTo(9.7,-8.9,10.8,-7).lineTo(6.6,-3.6).curveTo(5,-6,1.9,-6).curveTo(-0.1,-6,-1.6,-5.1).curveTo(-3.1,-4.1,-4,-2.5).curveTo(-4.8,-0.8,-4.8,1.3).curveTo(-4.8,3.4,-3.5,4.7).curveTo(-2.1,6,0.3,6).curveTo(3.3,6,5.4,3.5).lineTo(8.9,7).curveTo(7.2,9.1,4.9,10).curveTo(2.7,10.9,-0.3,10.9).curveTo(-3.5,10.9,-5.9,9.8).closePath();
	this.shape_13.setTransform(98.525,1.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(6.3,10.5).lineTo(5.4,6.4).lineTo(-3.5,6.4).lineTo(-5.9,10.5).lineTo(-12.2,10.5).lineTo(1.3,-10.5).lineTo(7.1,-10.5).lineTo(12.2,10.5).closePath().moveTo(-0.9,2).lineTo(4.5,2).lineTo(3.1,-4.7).closePath();
	this.shape_14.setTransform(71.325,1.4);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.9,10.5).lineTo(3.5,2.4).lineTo(-4.5,2.4).lineTo(-6.1,10.5).lineTo(-12.1,10.5).lineTo(-7.9,-10.5).lineTo(-2,-10.5).lineTo(-3.5,-2.7).lineTo(4.6,-2.7).lineTo(6.1,-10.5).lineTo(12.1,-10.5).lineTo(7.9,10.5).closePath();
	this.shape_15.setTransform(47.825,1.4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-12.1,9.9).lineTo(-10.2,5.7).curveTo(-9.3,5.9,-8.4,5.9).curveTo(-6.5,6,-5,4.1).lineTo(-4.8,4).lineTo(-9.9,-10.7).lineTo(-3.8,-10.7).lineTo(-0.9,-0.7).lineTo(6.2,-10.7).lineTo(12.1,-10.7).lineTo(0.2,5.6).curveTo(-1.7,8.2,-3.9,9.5).curveTo(-6,10.8,-8.3,10.8).curveTo(-10.3,10.8,-12.1,9.9).closePath();
	this.shape_16.setTransform(14.675,1.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol106, new cjs.Rectangle(0,-23.3,431.6,45.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._11_logo();
	this.instance.setTransform(0,-17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol105, new cjs.Rectangle(0,-17.5,129,35), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-574.5,48.5).lineTo(-574.5,-48.5).lineTo(574.5,-48.5).lineTo(574.5,48.5).closePath();
	this.shape.setTransform(574.5,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol104, new cjs.Rectangle(0,-48.5,1149,97), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.9,7).lineTo(-2,-0).lineTo(-2,7).lineTo(-5.6,7).lineTo(-5.6,-7).lineTo(-2.8,-7).lineTo(2,0).lineTo(2,-7).lineTo(5.6,-7).lineTo(5.6,7).closePath();
	this.shape.setTransform(300.9,1.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,5.8).curveTo(-5.6,4.5,-5.6,2.2).lineTo(-5.6,-7.1).lineTo(-2,-7.1).lineTo(-2,1.9).curveTo(-1.9,3.7,-0,3.7).curveTo(1.9,3.7,2,1.9).lineTo(2,-7.1).lineTo(5.6,-7.1).lineTo(5.6,2.2).curveTo(5.6,4.5,4,5.8).curveTo(2.5,7.2,-0,7.2).curveTo(-2.5,7.2,-4,5.8).closePath();
	this.shape_1.setTransform(286.65,1.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,5.2).curveTo(-7.2,3.1,-7.2,-0).curveTo(-7.2,-3.1,-5.1,-5.2).curveTo(-3,-7.3,0.1,-7.3).curveTo(2,-7.3,3.7,-6.4).curveTo(5.3,-5.5,6.2,-4.1).lineTo(3.2,-2.4).curveTo(2.8,-3,1.9,-3.4).curveTo(1.1,-3.8,0.1,-3.8).curveTo(-1.5,-3.8,-2.6,-2.7).curveTo(-3.7,-1.6,-3.7,0).curveTo(-3.7,1.7,-2.6,2.8).curveTo(-1.6,3.9,0.3,3.9).curveTo(2.8,3.9,3.6,2).lineTo(0.2,2).lineTo(0.2,-1).lineTo(7.2,-1).lineTo(7.2,0.4).curveTo(7.2,3.5,5.3,5.4).curveTo(3.3,7.3,0.3,7.3).curveTo(-3,7.3,-5.1,5.2).closePath();
	this.shape_2.setTransform(271.375,1.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,5.2).curveTo(-7.3,3.1,-7.4,-0).curveTo(-7.3,-3.1,-5.2,-5.2).curveTo(-3.1,-7.3,-0,-7.3).curveTo(3.1,-7.3,5.2,-5.2).curveTo(7.3,-3.1,7.4,-0).curveTo(7.3,3.1,5.2,5.2).curveTo(3,7.3,-0,7.3).curveTo(-3.1,7.3,-5.2,5.2).closePath().moveTo(-2.7,-2.7).curveTo(-3.8,-1.7,-3.8,-0).curveTo(-3.8,1.7,-2.7,2.7).curveTo(-1.6,3.8,-0,3.8).curveTo(1.6,3.8,2.7,2.7).curveTo(3.8,1.7,3.8,-0).curveTo(3.8,-1.7,2.7,-2.7).curveTo(1.6,-3.8,-0,-3.8).curveTo(-1.6,-3.8,-2.7,-2.7).closePath();
	this.shape_3.setTransform(254.7,1.75);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.5,7).lineTo(-4.5,-7).lineTo(4.4,-7).lineTo(4.4,-3.6).lineTo(-0.9,-3.6).lineTo(-0.9,-1.7).lineTo(3.9,-1.7).lineTo(3.9,1.6).lineTo(-0.9,1.6).lineTo(-0.9,3.7).lineTo(4.5,3.7).lineTo(4.5,7).closePath();
	this.shape_4.setTransform(240.7,1.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.4,6.4).curveTo(-4.9,5.4,-5.5,3.8).lineTo(-2.5,2).curveTo(-1.7,3.9,0.3,3.9).curveTo(1.9,3.9,1.9,2.9).curveTo(1.9,2.3,1,1.9).lineTo(-0.8,1.4).curveTo(-2.8,0.9,-3.9,-0.2).curveTo(-4.9,-1.3,-4.9,-2.9).curveTo(-4.9,-4.9,-3.5,-6.1).curveTo(-2.1,-7.3,-0.1,-7.3).curveTo(1.7,-7.3,3.1,-6.4).curveTo(4.4,-5.7,5.1,-4.1).lineTo(2.1,-2.4).curveTo(1.5,-3.9,-0,-3.9).curveTo(-0.7,-3.9,-1,-3.6).curveTo(-1.3,-3.4,-1.3,-3).curveTo(-1.3,-2.5,-0.8,-2.2).curveTo(-0.4,-1.9,1.1,-1.5).lineTo(2.7,-0.9).lineTo(4.1,-0.1).curveTo(5.5,0.8,5.5,2.9).curveTo(5.5,5,4.1,6.2).curveTo(2.6,7.3,0.2,7.3).curveTo(-2,7.3,-3.4,6.4).closePath();
	this.shape_5.setTransform(228.325,1.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.6,5.2).curveTo(-6.7,3.2,-6.7,-0).curveTo(-6.7,-3.2,-4.6,-5.2).curveTo(-2.5,-7.3,0.6,-7.3).curveTo(2.5,-7.3,4.2,-6.4).curveTo(5.8,-5.5,6.7,-4).lineTo(3.6,-2.2).curveTo(3.2,-2.9,2.4,-3.4).curveTo(1.6,-3.8,0.6,-3.8).curveTo(-1,-3.8,-2.1,-2.7).curveTo(-3.1,-1.7,-3.1,-0).curveTo(-3.1,1.7,-2.1,2.7).curveTo(-1,3.8,0.6,3.8).curveTo(1.6,3.8,2.4,3.4).curveTo(3.2,2.9,3.6,2.2).lineTo(6.7,4).curveTo(5.8,5.5,4.2,6.4).curveTo(2.6,7.3,0.6,7.3).curveTo(-2.5,7.3,-4.6,5.2).closePath();
	this.shape_6.setTransform(208.725,1.75);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.3,7).lineTo(-5.3,-7).lineTo(0.2,-7).curveTo(2.3,-7,3.6,-6).curveTo(4.8,-4.8,4.8,-3).curveTo(4.9,-1.3,3.6,-0.2).curveTo(5.3,0.8,5.3,2.9).curveTo(5.3,4.8,4,5.9).curveTo(2.7,7,0.6,7).closePath().moveTo(-1.7,3.8).lineTo(0.5,3.8).curveTo(1,3.8,1.4,3.5).curveTo(1.7,3.2,1.7,2.6).curveTo(1.7,2.1,1.4,1.8).curveTo(1,1.5,0.5,1.5).lineTo(-1.7,1.5).closePath().moveTo(-1.7,-1.6).lineTo(0.1,-1.6).curveTo(0.6,-1.6,1,-1.9).curveTo(1.2,-2.2,1.2,-2.7).curveTo(1.2,-3.2,1,-3.5).curveTo(0.6,-3.8,0.1,-3.8).lineTo(-1.7,-3.8).closePath();
	this.shape_7.setTransform(189.3,1.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,5.2).curveTo(-7.3,3.1,-7.3,-0).curveTo(-7.3,-3.1,-5.2,-5.2).curveTo(-3.1,-7.3,-0,-7.3).curveTo(3.1,-7.3,5.2,-5.2).curveTo(7.4,-3.1,7.3,-0).curveTo(7.4,3.1,5.2,5.2).curveTo(3.1,7.3,-0,7.3).curveTo(-3.1,7.3,-5.2,5.2).closePath().moveTo(-2.7,-2.7).curveTo(-3.8,-1.7,-3.8,-0).curveTo(-3.8,1.7,-2.7,2.7).curveTo(-1.6,3.8,-0,3.8).curveTo(1.6,3.8,2.7,2.7).curveTo(3.8,1.7,3.8,-0).curveTo(3.8,-1.7,2.7,-2.7).curveTo(1.6,-3.8,-0,-3.8).curveTo(-1.6,-3.8,-2.7,-2.7).closePath();
	this.shape_8.setTransform(174,1.75);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.8,7).lineTo(-1.8,-3.6).lineTo(-5.2,-3.6).lineTo(-5.2,-7).lineTo(5.2,-7).lineTo(5.2,-3.6).lineTo(1.8,-3.6).lineTo(1.8,7).closePath();
	this.shape_9.setTransform(159.65,1.75);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.1,8.9).lineTo(2.1,1.9).lineTo(-2.8,8.9).lineTo(-5.7,8.9).lineTo(-5.7,-5).lineTo(-2.1,-5).lineTo(-2.1,2).lineTo(2.9,-5).lineTo(5.6,-5).lineTo(5.6,8.9).closePath().moveTo(-3.3,-6.2).lineTo(-3.3,-9).lineTo(3.2,-9).lineTo(3.2,-6.2).closePath();
	this.shape_10.setTransform(146.45,-0.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.9,7).lineTo(2.4,5).lineTo(-2.3,5).lineTo(-2.9,7).lineTo(-6.8,7).lineTo(-2.2,-7).lineTo(2.2,-7).lineTo(6.8,7).closePath().moveTo(-1.4,1.9).lineTo(1.4,1.9).lineTo(0,-2.8).closePath();
	this.shape_11.setTransform(132,1.75);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.6,5.2).curveTo(-6.7,3.2,-6.7,-0).curveTo(-6.7,-3.2,-4.6,-5.2).curveTo(-2.5,-7.3,0.6,-7.3).curveTo(2.5,-7.3,4.2,-6.4).curveTo(5.8,-5.5,6.7,-4).lineTo(3.6,-2.2).curveTo(3.2,-2.9,2.4,-3.4).curveTo(1.6,-3.8,0.6,-3.8).curveTo(-1,-3.8,-2.1,-2.7).curveTo(-3.1,-1.7,-3.1,-0).curveTo(-3.1,1.7,-2.1,2.7).curveTo(-1,3.8,0.6,3.8).curveTo(1.6,3.8,2.4,3.4).curveTo(3.2,2.9,3.6,2.2).lineTo(6.7,4).curveTo(5.8,5.5,4.2,6.4).curveTo(2.6,7.3,0.6,7.3).curveTo(-2.5,7.3,-4.6,5.2).closePath();
	this.shape_12.setTransform(117.125,1.75);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2,7).lineTo(2,-0).lineTo(-2.8,7).lineTo(-5.6,7).lineTo(-5.6,-7).lineTo(-2,-7).lineTo(-2,0).lineTo(2.8,-7).lineTo(5.6,-7).lineTo(5.6,7).closePath();
	this.shape_13.setTransform(96.6,1.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.1,7).lineTo(2.1,-0).lineTo(-2.8,7).lineTo(-5.7,7).lineTo(-5.7,-7).lineTo(-2.1,-7).lineTo(-2.1,0).lineTo(2.9,-7).lineTo(5.7,-7).lineTo(5.7,7).closePath();
	this.shape_14.setTransform(82.1,1.75);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.7,8.3).lineTo(2.7,5.6).lineTo(-6.3,5.6).lineTo(-6.3,-8.3).lineTo(-2.6,-8.3).lineTo(-2.6,2.2).lineTo(1,2.2).lineTo(1,-8.3).lineTo(4.7,-8.3).lineTo(4.7,2.2).lineTo(6.3,2.2).lineTo(6.3,8.3).closePath();
	this.shape_15.setTransform(67.7,3.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.1,7).lineTo(2.1,-0).lineTo(-2.9,7).lineTo(-5.7,7).lineTo(-5.7,-7).lineTo(-2.1,-7).lineTo(-2.1,0).lineTo(2.9,-7).lineTo(5.7,-7).lineTo(5.7,7).closePath();
	this.shape_16.setTransform(52.55,1.75);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.3,4).lineTo(-2.3,2.2).curveTo(-1.7,3.9,0.1,3.9).curveTo(1.8,3.9,1.8,2.7).curveTo(1.8,1.6,0.4,1.5).lineTo(-1.7,1.5).lineTo(-1.7,-1.7).lineTo(-0.3,-1.7).curveTo(1.3,-1.7,1.3,-2.8).curveTo(1.3,-4,-0.1,-3.9).curveTo(-1.6,-3.9,-2.1,-2.6).lineTo(-5.1,-4.3).curveTo(-4.5,-5.7,-3.2,-6.5).curveTo(-1.9,-7.3,-0.1,-7.3).curveTo(2.1,-7.3,3.5,-6.2).curveTo(4.9,-5,4.9,-3.1).curveTo(4.9,-1.3,3.5,-0.2).curveTo(5.3,0.8,5.3,3).curveTo(5.3,5,3.9,6.2).curveTo(2.5,7.3,0.1,7.3).curveTo(-4,7.3,-5.3,4).closePath();
	this.shape_17.setTransform(39.125,1.75);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,5.2).curveTo(-7.4,3.1,-7.3,-0).curveTo(-7.4,-3.1,-5.2,-5.2).curveTo(-3.1,-7.3,-0,-7.3).curveTo(3.1,-7.3,5.2,-5.2).curveTo(7.4,-3.1,7.3,-0).curveTo(7.4,3.1,5.2,5.2).curveTo(3.1,7.3,-0,7.3).curveTo(-3.1,7.3,-5.2,5.2).closePath().moveTo(-2.7,-2.7).curveTo(-3.8,-1.7,-3.8,-0).curveTo(-3.8,1.7,-2.7,2.7).curveTo(-1.6,3.8,-0,3.8).curveTo(1.6,3.8,2.7,2.7).curveTo(3.8,1.7,3.8,-0).curveTo(3.8,-1.7,2.7,-2.7).curveTo(1.6,-3.8,-0,-3.8).curveTo(-1.6,-3.8,-2.7,-2.7).closePath();
	this.shape_18.setTransform(24.7,1.75);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.8,7).lineTo(1.8,-3.6).lineTo(-1.8,-3.6).lineTo(-1.8,7).lineTo(-5.4,7).lineTo(-5.4,-7).lineTo(5.4,-7).lineTo(5.4,7).closePath();
	this.shape_19.setTransform(9.3,1.75);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2,8.9).lineTo(2,1.9).lineTo(-2.8,8.9).lineTo(-5.6,8.9).lineTo(-5.6,-5).lineTo(-2,-5).lineTo(-2,2).lineTo(2.8,-5).lineTo(5.6,-5).lineTo(5.6,8.9).closePath().moveTo(-3.3,-6.2).lineTo(-3.3,-9).lineTo(3.2,-9).lineTo(3.2,-6.2).closePath();
	this.shape_20.setTransform(-10.5,-0.2);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2,7).lineTo(2,2.5).lineTo(1.2,2.5).lineTo(-1.6,7).lineTo(-5.6,7).lineTo(-2.4,2).curveTo(-3.6,1.4,-4.3,0.3).curveTo(-5.1,-0.8,-5.1,-2.1).curveTo(-5.1,-4.3,-3.6,-5.6).curveTo(-2.2,-7,-0,-7).lineTo(5.6,-7).lineTo(5.6,7).closePath().moveTo(-1.1,-3.3).curveTo(-1.5,-2.8,-1.5,-2.1).curveTo(-1.5,-1.4,-1.1,-1).curveTo(-0.6,-0.5,-0,-0.6).lineTo(2,-0.6).lineTo(2,-3.7).lineTo(-0,-3.7).curveTo(-0.6,-3.7,-1.1,-3.3).closePath();
	this.shape_21.setTransform(-24.925,1.75);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,7).lineTo(-5.2,-7).lineTo(0.2,-7).curveTo(2.3,-7,3.8,-5.6).curveTo(5.2,-4.2,5.2,-2.1).curveTo(5.2,0.1,3.8,1.4).curveTo(2.3,2.8,0.2,2.8).lineTo(-1.6,2.8).lineTo(-1.6,7).closePath().moveTo(-1.6,-0.6).lineTo(0.2,-0.6).curveTo(0.8,-0.6,1.2,-1).curveTo(1.6,-1.4,1.6,-2.1).curveTo(1.6,-2.7,1.2,-3.2).curveTo(0.8,-3.6,0.2,-3.6).lineTo(-1.6,-3.6).closePath();
	this.shape_22.setTransform(-37.325,1.75);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.5,7).lineTo(-4.5,-7).lineTo(4.4,-7).lineTo(4.4,-3.6).lineTo(-0.9,-3.6).lineTo(-0.9,-1.7).lineTo(3.9,-1.7).lineTo(3.9,1.6).lineTo(-0.9,1.6).lineTo(-0.9,3.7).lineTo(4.5,3.7).lineTo(4.5,7).closePath();
	this.shape_23.setTransform(-49.75,1.75);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.3,7).lineTo(-5.3,-7).lineTo(0.2,-7).curveTo(2.4,-7,3.6,-6).curveTo(4.8,-4.8,4.8,-3).curveTo(4.9,-1.3,3.6,-0.2).curveTo(5.3,0.8,5.3,2.9).curveTo(5.3,4.8,4,5.9).curveTo(2.7,7,0.6,7).closePath().moveTo(-1.7,3.8).lineTo(0.5,3.8).curveTo(1,3.8,1.4,3.5).curveTo(1.7,3.2,1.7,2.6).curveTo(1.7,2.1,1.4,1.8).curveTo(1,1.5,0.5,1.5).lineTo(-1.7,1.5).closePath().moveTo(-1.7,-1.6).lineTo(0.1,-1.6).curveTo(0.6,-1.6,1,-1.9).curveTo(1.2,-2.2,1.2,-2.7).curveTo(1.2,-3.2,1,-3.5).curveTo(0.6,-3.8,0.1,-3.8).lineTo(-1.7,-3.8).closePath();
	this.shape_24.setTransform(-62,1.75);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,5.2).curveTo(-7.3,3.1,-7.4,-0).curveTo(-7.3,-3.1,-5.2,-5.2).curveTo(-3.1,-7.3,-0,-7.3).curveTo(3.1,-7.3,5.2,-5.2).curveTo(7.3,-3.1,7.4,-0).curveTo(7.3,3.1,5.2,5.2).curveTo(3,7.3,-0,7.3).curveTo(-3.1,7.3,-5.2,5.2).closePath().moveTo(-2.7,-2.7).curveTo(-3.8,-1.7,-3.8,-0).curveTo(-3.8,1.7,-2.7,2.7).curveTo(-1.6,3.8,-0,3.8).curveTo(1.6,3.8,2.7,2.7).curveTo(3.8,1.7,3.8,-0).curveTo(3.8,-1.7,2.7,-2.7).curveTo(1.6,-3.8,-0,-3.8).curveTo(-1.6,-3.8,-2.7,-2.7).closePath();
	this.shape_25.setTransform(-77.3,1.75);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.2,7).lineTo(-5.2,-7).lineTo(0.2,-7).curveTo(2.3,-7,3.8,-5.6).curveTo(5.2,-4.2,5.2,-2.1).curveTo(5.2,0.1,3.8,1.4).curveTo(2.3,2.8,0.2,2.8).lineTo(-1.6,2.8).lineTo(-1.6,7).closePath().moveTo(-1.6,-0.6).lineTo(0.2,-0.6).curveTo(0.8,-0.6,1.2,-1).curveTo(1.6,-1.4,1.6,-2.1).curveTo(1.6,-2.7,1.2,-3.2).curveTo(0.8,-3.6,0.2,-3.6).lineTo(-1.6,-3.6).closePath();
	this.shape_26.setTransform(-91.675,1.75);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.beginFill("#FFFFFF").beginStroke().moveTo(1.8,7).lineTo(1.8,-3.6).lineTo(-1.8,-3.6).lineTo(-1.8,7).lineTo(-5.4,7).lineTo(-5.4,-7).lineTo(5.4,-7).lineTo(5.4,7).closePath();
	this.shape_27.setTransform(-105.5,1.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol23, new cjs.Rectangle(-114,-13.3,424.9,29.200000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#B4060D").beginStroke().moveTo(-572.5,46.5).lineTo(-572.5,-46.5).lineTo(572.4,-46.5).lineTo(572.4,46.5).closePath();
	this.shape.setTransform(366.55,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol21, new cjs.Rectangle(-205.9,-46.5,1144.9,93), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(634.6,30.5,1,1,0,0,0,62.6,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(22).to({_off:false},0).to({y:0.5,alpha:1},12,cjs.Ease.quadOut).wait(126).to({_off:true},1).wait(359));

	// Layer_8
	this.instance_1 = new lib.Symbol100();
	this.instance_1.setTransform(491,-29.5,1,1,0,0,0,76,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({y:0.5,alpha:1},10,cjs.Ease.quadOut).wait(135).to({_off:true},1).wait(359));

	// Layer_4
	this.instance_2 = new lib.Symbol101();
	this.instance_2.setTransform(361.8,29.4,1,1,0,0,0,50.8,-0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off:false},0).to({y:0.4,alpha:1},11,cjs.Ease.quadOut).wait(140).to({_off:true},1).wait(359));

	// Layer_7
	this.instance_3 = new lib.Symbol98();
	this.instance_3.setTransform(917,2.5,1,1,0,0,0,91,0);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(8).to({_off:false},0).to({x:797,alpha:1},20,cjs.Ease.quadOut).to({x:827},126).wait(6).to({_off:true},1).wait(359));

	// Layer_2
	this.instance_4 = new lib.Symbol105();
	this.instance_4.setTransform(134.45,1.5,1,1,0,0,0,64.5,0);

	this.instance_5 = new lib.Symbol107();
	this.instance_5.setTransform(190,0,1,1,0,0,180,82,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#000000").beginStroke().moveTo(-62,45).lineTo(-62,-45).lineTo(62,-45).lineTo(62,45).closePath();
	this.shape.setTransform(62.05,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_5},{t:this.instance_4}]}).to({state:[{t:this.shape},{t:this.instance_5},{t:this.instance_4}]},160).to({state:[]},1).wait(359));

	// Layer_3
	this.instance_6 = new lib.Symbol76();
	this.instance_6.setTransform(569.95,0,1.5543,1,0,0,0,366.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({_off:true},1).wait(359));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-46.6,1140,94.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(676.55,2.5,0.3333,0.3333,0,0,0,25.5,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:0.1,scaleX:1.1961,scaleY:1.1961,y:2.6,alpha:0.6992},8).to({regY:0,scaleX:1,scaleY:1,x:676.5,y:2.5},3).wait(79).to({_off:true},1).wait(362));

	// Layer_5
	this.instance_1 = new lib.Symbol25();
	this.instance_1.setTransform(62,3,0.24,0.24,0,0,0,25,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(20).to({_off:false},0).to({regX:25.1,scaleX:1.24,scaleY:1.24,x:62.1,alpha:0.6992},8).to({regX:25,scaleX:1,scaleY:1,x:62},3).wait(79).to({_off:true},1).wait(362));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off:false},0).to({y:19.85},11).to({y:23.85},4).wait(86).to({_off:true},1).wait(362));

	// Layer_2
	this.instance_3 = new lib.Symbol1();
	this.instance_3.setTransform(368.2,0.5,1.1208,1.1208,0,0,0,101.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.5591,scaleY:0.5591,x:368.1,y:-15.45},17).to({regX:101.5,regY:0.1,scaleX:0.6577,scaleY:0.6577,x:368,y:-14.45},4).wait(89).to({_off:true},1).wait(362));

	// Layer_1
	this.instance_4 = new lib.Symbol21();
	this.instance_4.setTransform(366.5,0,1,1,0,0,0,366.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(110).to({_off:true},1).wait(362));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-205.9,-46.5,1144.9,122.2);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(42.525,6.875);
	...
	this.shape_1.setTransform(33.6,6.875);
	...
	this.shape_2.setTransform(25.325,6.875);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.4,3).curveTo(-3.1,2.4,-3.1,1.5).lineTo(-3.1,1.4).curveTo(-3.1,0.3,-2.3,-0.2).curveTo(-1.6,-0.8,-0.3,-0.8).curveTo(0.7,-0.8,1.6,-0.5).lineTo(1.6,-0.7).curveTo(1.6,-2.2,-0.1,-2.2).curveTo(-1,-2.2,-2.1,-1.8).lineTo(-2.5,-3).curveTo(-1.2,-3.5,0.1,-3.6).curveTo(1.6,-3.6,2.4,-2.8).curveTo(3.1,-2.1,3.1,-0.7).lineTo(3.1,3.4).lineTo(1.6,3.4).lineTo(1.6,2.5).curveTo(0.7,3.6,-0.7,3.5).curveTo(-1.7,3.5,-2.4,3).closePath().moveTo(-1.1,0.5).curveTo(-1.6,0.8,-1.6,1.4).curveTo(-1.6,1.9,-1.2,2.1).curveTo(-0.8,2.4,-0.2,2.4).curveTo(0.6,2.4,1.1,2).curveTo(1.6,1.6,1.6,0.9).lineTo(1.6,0.5).curveTo(0.9,0.2,0.1,0.2).curveTo(-0.7,0.2,-1.1,0.5).closePath();
	this.shape_3.setTransform(17.125,6.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(2,3.4).lineTo(0,-1.5).lineTo(-2,3.4).lineTo(-3.7,3.4).lineTo(-0.7,-3.4).lineTo(0.8,-3.4).lineTo(3.7,3.4).closePath();
	this.shape_4.setTransform(8.925,6.85);
	...
	this.shape_5.setTransform(0.25,6.875);
	...
	this.shape_6.setTransform(-8.025,6.875);
	...
	this.shape_7.setTransform(-16.225,6.875);
	...
	this.shape_8.setTransform(-24.875,5.575);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.6,4.8).lineTo(1.6,0.3).lineTo(-1.7,4.8).lineTo(-3.2,4.8).lineTo(-3.2,-2.1).lineTo(-1.6,-2.1).lineTo(-1.6,2.3).lineTo(1.7,-2.1).lineTo(3.1,-2.1).lineTo(3.1,4.8).closePath().moveTo(-1.6,-3.4).curveTo(-2.2,-3.9,-2.3,-4.8).lineTo(-1.2,-4.8).curveTo(-0.9,-4,-0,-4).curveTo(0.9,-4,1.1,-4.8).lineTo(2.2,-4.8).curveTo(2.2,-3.9,1.5,-3.4).curveTo(1,-2.9,-0,-2.9).curveTo(-0.9,-2.9,-1.6,-3.4).closePath();
	this.shape_9.setTransform(40.7,-8.1);
	...
	this.shape_10.setTransform(32.175,-5.675);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.5,3.9).curveTo(-3.6,2.8,-3.6,0.7).curveTo(-3.6,-1.7,-2.7,-2.9).curveTo(-1.8,-4.2,0.1,-4.5).lineTo(2.6,-4.9).lineTo(2.8,-3.5).lineTo(0.4,-3.1).curveTo(-0.8,-2.9,-1.4,-2.3).curveTo(-1.9,-1.8,-2.1,-0.7).curveTo(-1.2,-1.7,0.4,-1.7).curveTo(1.9,-1.7,2.7,-0.9).curveTo(3.6,0,3.6,1.4).curveTo(3.6,2.9,2.6,3.9).curveTo(1.6,4.9,-0,4.9).curveTo(-1.5,4.9,-2.5,3.9).closePath().moveTo(-1.4,0).curveTo(-2,0.6,-2,1.5).lineTo(-2,1.5).curveTo(-2,2.4,-1.4,3).curveTo(-0.9,3.5,0,3.5).curveTo(0.9,3.5,1.5,2.9).curveTo(2,2.3,2,1.4).curveTo(2,0.6,1.5,0).curveTo(1,-0.5,0.1,-0.5).curveTo(-0.9,-0.5,-1.4,0).closePath();
	this.shape_11.setTransform(23.575,-8.025);
	...
	this.shape_12.setTransform(14.525,-6.725);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-3.5,4.6).lineTo(-3.5,-4.4).lineTo(-2,-4.4).lineTo(-2,-3.3).curveTo(-1.1,-4.5,0.3,-4.5).curveTo(1.6,-4.6,2.6,-3.6).curveTo(3.6,-2.6,3.6,-1).lineTo(3.6,-0.9).curveTo(3.6,0.7,2.6,1.6).curveTo(1.6,2.6,0.3,2.6).curveTo(-1.1,2.6,-2,1.4).lineTo(-2,4.6).closePath().moveTo(-1.5,-2.6).curveTo(-2,-1.9,-2.1,-1).lineTo(-2.1,-0.9).curveTo(-2,-0,-1.5,0.6).curveTo(-0.8,1.2,-0,1.2).curveTo(0.8,1.2,1.3,0.6).curveTo(2,-0,2,-0.9).lineTo(2,-1).curveTo(2,-1.9,1.3,-2.6).curveTo(0.8,-3.2,-0,-3.2).curveTo(-0.8,-3.2,-1.5,-2.6).closePath();
	this.shape_13.setTransform(5.6,-5.75);
	...
	this.shape_14.setTransform(-3.6,-6.725);
	...
	this.shape_15.setTransform(-12.525,-6.725);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(2.2,4.5).lineTo(2.2,-3.1).lineTo(-2.1,-3.1).lineTo(-2.1,4.5).lineTo(-3.8,4.5).lineTo(-3.8,-4.6).lineTo(3.7,-4.6).lineTo(3.7,4.5).closePath();
	this.shape_16.setTransform(-22.25,-7.85);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({_off:true},81).wait(31).to({_off:false},0).wait(13).to({startPosition:13},0).to({_off:true},1).wait(127));

	// Layer_3
	this.instance_1 = new lib.Symbol76_1("synched",0);
	this.instance_1.setTransform(30.9,-65.4,1,1,0,0,0,30.9,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(165).to({startPosition:165},0).to({_off:true},1).wait(127));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-146.35,1,0.2856,0.2856,0,0,0,222.6,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({regX:222.5,regY:0.1,scaleX:1.1213,scaleY:1.1213,y:1.1},10).to({regY:0,scaleX:1,scaleY:1,x:-146.4,y:1},5).wait(97).to({_off:true},1).wait(78));

	// Layer_5
	this.instance_1 = new lib.Symbol77("synched",0);
	this.instance_1.setTransform(110.05,18.35,1,1,0,0,0,44,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(74).to({_off:false},0).wait(87).to({startPosition:87},0).to({_off:true},1).wait(78));

	// Layer_3
	this.instance_2 = new lib.Symbol96();
	this.instance_2.setTransform(-729.85,22,1,1,13.482,0,0,24.1,-10);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:0,x:-588.9,y:-9},24,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(78));

	// Layer_2
	this.instance_3 = new lib.Symbol105();
	this.instance_3.setTransform(446.5,1.5,1,1,0,0,0,64.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(161).to({_off:true},1).wait(78));

	// Layer_1
	this.instance_4 = new lib.fon1();
	this.instance_4.setTransform(290,-45);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#000000").beginStroke().moveTo(-62,45).lineTo(-62,-45).lineTo(62,-45).lineTo(62,45).closePath();
	this.shape.setTransform(514.1,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(161).to({_off:true},1).wait(78));

	// Layer_4
	this.instance_5 = new lib.Symbol97();
	this.instance_5.setTransform(310.1,44,1,1,-38.9856,0,0,212,3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(34).to({_off:false},0).to({rotation:7.9631,y:12},17).to({rotation:0,x:306},5,cjs.Ease.quadOut).wait(105).to({_off:true},1).wait(78));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-767.5,-100.4,1343.6,318.20000000000005);


// stage content:
(lib._1140_90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(-570,-45).lineTo(570,-45).lineTo(570,45).lineTo(-570,45).closePath();
	this.shape.setTransform(570,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(403).to({_off:false},0).to({alpha:1},15).wait(1));

	// Layer_5
	this.instance_1 = new lib.Symbol13();
	this.instance_1.setTransform(995.15,46.95,0.4036,0.4036,0,0,0,8.6,0.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(295).to({_off:false},0).to({regX:8.5,regY:1,scaleX:1.2832,scaleY:1.2832,y:47.2},12).to({regY:0.8,scaleX:1.1514,scaleY:1.1514,y:46.9},5).wait(37).to({regX:8.6,regY:1,scaleX:0.9645,scaleY:0.9645,x:995.25,y:47.05},4).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:995.15,y:46.9},10).wait(56));

	// Layer_7 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_258 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_259 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_260 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_261 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_262 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_263 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_264 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_265 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_266 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_267 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_268 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_269 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_270 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_271 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_272 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();
	var mask_graphics_273 = new cjs.Graphics().moveTo(-742,56.5).lineTo(-660,-56.5).lineTo(742,-56.5).lineTo(660,56.5).closePath();

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(258).to({graphics:mask_graphics_258,x:-724.025,y:48.55}).wait(1).to({graphics:mask_graphics_259,x:-643.5617,y:48.55}).wait(1).to({graphics:mask_graphics_260,x:-563.0983,y:48.55}).wait(1).to({graphics:mask_graphics_261,x:-482.635,y:48.55}).wait(1).to({graphics:mask_graphics_262,x:-402.1717,y:48.55}).wait(1).to({graphics:mask_graphics_263,x:-321.7083,y:48.55}).wait(1).to({graphics:mask_graphics_264,x:-241.245,y:48.55}).wait(1).to({graphics:mask_graphics_265,x:-160.7817,y:48.55}).wait(1).to({graphics:mask_graphics_266,x:-80.3183,y:48.55}).wait(1).to({graphics:mask_graphics_267,x:0.145,y:48.55}).wait(1).to({graphics:mask_graphics_268,x:80.6083,y:48.55}).wait(1).to({graphics:mask_graphics_269,x:161.0717,y:48.55}).wait(1).to({graphics:mask_graphics_270,x:241.535,y:48.55}).wait(1).to({graphics:mask_graphics_271,x:321.9983,y:48.55}).wait(1).to({graphics:mask_graphics_272,x:402.4617,y:48.55}).wait(1).to({graphics:mask_graphics_273,x:482.925,y:48.55}).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(258).to({_off:false},0).wait(161));

	// Isolation_Mode
	this.instance_3 = new lib.Symbol22("synched",0);
	this.instance_3.setTransform(571.5,45.55,1,1,0,0,0,366.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(162).to({_off:false},0).to({_off:true},111).wait(146));

	// Layer_8
	this.instance_4 = new lib.Symbol21();
	this.instance_4.setTransform(570,46.5,1,1,0,0,0,366.5,0);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({alpha:1},11).to({_off:true},1).wait(256));

	// Layer_3
	this.instance_5 = new lib.Symbol95("synched",0);
	this.instance_5.setTransform(646,44,1,1,0,0,0,82,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},162).wait(257));

	// Layer_4
	this.instance_6 = new lib.Symbol76();
	this.instance_6.setTransform(569.95,44.55,1.5543,1,0,0,0,366.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},162).wait(257));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(366.5,-11.4,778.5999999999999,273.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/1140_90_atlas_1.png?1667980583214", id:"1140_90_atlas_1"}
	],
	preloads: []
};
