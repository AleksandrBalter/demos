...
lib.ssMetadata = [
		{name:"160_600_atlas_1", frames: [[157,0,230,102],[0,177,214,110],[157,104,50,50],[216,257,203,56],[216,104,146,151],[0,0,155,175]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.man160();
	this.instance.setTransform(0,-75.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol111, new cjs.Rectangle(0,-75.5,146,151), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2,7.8).curveTo(-2.7,7.1,-2.7,6).curveTo(-2.7,4.9,-2,4.2).curveTo(-1.2,3.5,-0,3.5).curveTo(1.2,3.5,2,4.2).curveTo(2.7,4.9,2.7,6).curveTo(2.7,7.1,1.9,7.8).curveTo(1.2,8.5,-0,8.5).curveTo(-1.2,8.5,-2,7.8).closePath().moveTo(-1.8,2.2).lineTo(-2.7,-8.5).lineTo(2.7,-8.5).lineTo(1.8,2.2).closePath();
	this.shape.setTransform(171.525,8.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,8.4).lineTo(-6.7,-8.4).lineTo(6.4,-8.4).lineTo(6.4,-4.7).lineTo(-2,-4.7).lineTo(-2,-1.9).lineTo(5.4,-1.9).lineTo(5.4,1.7).lineTo(-2,1.7).lineTo(-2,4.7).lineTo(6.8,4.7).lineTo(6.8,8.4).closePath();
	this.shape_1.setTransform(160.25,8.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,8.4).lineTo(-6.7,-8.4).lineTo(6.4,-8.4).lineTo(6.4,-4.7).lineTo(-2,-4.7).lineTo(-2,-1.9).lineTo(5.4,-1.9).lineTo(5.4,1.7).lineTo(-2,1.7).lineTo(-2,4.7).lineTo(6.8,4.7).lineTo(6.8,8.4).closePath();
	this.shape_2.setTransform(144.05,8.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.3,8.4).lineTo(3.3,1.9).lineTo(-3.2,1.9).lineTo(-3.2,8.4).lineTo(-8,8.4).lineTo(-8,-8.4).lineTo(-3.2,-8.4).lineTo(-3.2,-2.1).lineTo(3.3,-2.1).lineTo(3.3,-8.4).lineTo(8,-8.4).lineTo(8,8.4).closePath();
	this.shape_3.setTransform(125.7,8.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.2,8.4).lineTo(3.2,1.9).lineTo(-3.2,1.9).lineTo(-3.2,8.4).lineTo(-8,8.4).lineTo(-8,-8.4).lineTo(-3.2,-8.4).lineTo(-3.2,-2.1).lineTo(3.2,-2.1).lineTo(3.2,-8.4).lineTo(8,-8.4).lineTo(8,8.4).closePath();
	this.shape_4.setTransform(106.1,8.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.4,8.4).lineTo(3.4,-1.5).lineTo(-3.6,8.4).lineTo(-8.1,8.4).lineTo(-8.1,-8.4).lineTo(-3.4,-8.4).lineTo(-3.4,1.4).lineTo(3.5,-8.4).lineTo(8,-8.4).lineTo(8,8.4).closePath();
	this.shape_5.setTransform(86.45,8.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-8.6,8.3).lineTo(-8.3,4.3).lineTo(-7.7,4.4).curveTo(-6.7,4.5,-6.2,3.7).curveTo(-5.7,3,-5.5,1.6).curveTo(-5.3,0.3,-5.2,-1.9).lineTo(-5,-8.6).lineTo(8.5,-8.6).lineTo(8.5,8.3).lineTo(3.9,8.3).lineTo(3.9,-4.8).lineTo(-0.9,-4.8).lineTo(-1,-2.1).curveTo(-1.1,1.6,-1.6,3.8).curveTo(-2.1,6.1,-3.2,7.3).curveTo(-4.3,8.6,-6.4,8.6).curveTo(-7.4,8.5,-8.6,8.3).closePath();
	this.shape_6.setTransform(66.25,8.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5.4,10.1).lineTo(5.4,6.7).lineTo(-5.4,6.7).lineTo(-5.4,10.1).lineTo(-9.7,10.1).lineTo(-9.7,3).lineTo(-9.1,3).curveTo(-7.7,2.9,-7,0.9).curveTo(-6.4,-1.1,-6.3,-4.9).lineTo(-6.1,-10.1).lineTo(7.4,-10.1).lineTo(7.4,3).lineTo(9.7,3).lineTo(9.7,10.1).closePath().moveTo(-2.1,-4.5).curveTo(-2.2,-1.8,-2.6,0.1).curveTo(-2.9,1.9,-3.6,3).lineTo(2.8,3).lineTo(2.8,-6.3).lineTo(-2.1,-6.3).closePath();
	this.shape_7.setTransform(47.125,10.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-8.5,8.2).lineTo(-8.3,4.4).lineTo(-7.6,4.4).curveTo(-6.7,4.4,-6.2,3.7).curveTo(-5.7,2.9,-5.5,1.6).curveTo(-5.3,0.3,-5.2,-1.9).lineTo(-4.9,-8.5).lineTo(8.6,-8.5).lineTo(8.6,8.2).lineTo(3.9,8.2).lineTo(3.9,-4.8).lineTo(-0.9,-4.8).lineTo(-1,-2).curveTo(-1.2,1.5,-1.6,3.8).curveTo(-2.1,6,-3.2,7.3).curveTo(-4.3,8.6,-6.4,8.6).curveTo(-7.4,8.5,-8.5,8.2).closePath();
	this.shape_8.setTransform(164.75,-21.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.8,7.6).curveTo(-6.9,6.5,-8.1,4.5).curveTo(-9.3,2.5,-9.3,0).curveTo(-9.3,-2.5,-8.1,-4.5).curveTo(-6.9,-6.5,-4.8,-7.6).curveTo(-2.7,-8.7,-0,-8.7).curveTo(2.6,-8.7,4.8,-7.6).curveTo(6.9,-6.5,8.1,-4.5).curveTo(9.3,-2.5,9.3,0).curveTo(9.3,2.5,8.1,4.5).curveTo(6.9,6.5,4.8,7.6).curveTo(2.6,8.7,-0,8.7).curveTo(-2.7,8.7,-4.8,7.6).closePath().moveTo(-2.3,-4.2).curveTo(-3.4,-3.6,-3.9,-2.5).curveTo(-4.6,-1.4,-4.5,0).curveTo(-4.6,1.4,-3.9,2.5).curveTo(-3.4,3.6,-2.3,4.2).curveTo(-1.2,4.8,-0,4.8).curveTo(1.3,4.8,2.3,4.2).curveTo(3.4,3.6,3.9,2.5).curveTo(4.6,1.4,4.6,0).curveTo(4.6,-1.4,3.9,-2.5).curveTo(3.4,-3.6,2.3,-4.2).curveTo(1.3,-4.8,-0,-4.8).curveTo(-1.2,-4.8,-2.3,-4.2).closePath();
	this.shape_9.setTransform(145.75,-21.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.7,8.4).lineTo(-7.7,-8.4).lineTo(0.5,-8.4).curveTo(3.5,-8.4,5.2,-7.3).curveTo(6.8,-6.1,6.9,-4).curveTo(6.9,-2.8,6.3,-1.9).curveTo(5.7,-1,4.6,-0.4).curveTo(6.1,0.1,6.9,1.1).curveTo(7.6,2.1,7.6,3.6).curveTo(7.6,5.9,5.9,7.1).curveTo(4.1,8.4,1,8.4).closePath().moveTo(-2.9,5).lineTo(0.8,5).curveTo(2.8,5,2.8,3.2).curveTo(2.8,1.6,0.8,1.5).lineTo(-2.9,1.5).closePath().moveTo(-2.9,-1.7).lineTo(0,-1.7).curveTo(2,-1.7,2,-3.3).curveTo(2,-5,0,-5).lineTo(-2.9,-5).closePath();
	this.shape_10.setTransform(127.3,-21.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.4,8.4).lineTo(-2.4,-4.7).lineTo(-7.5,-4.7).lineTo(-7.5,-8.4).lineTo(7.5,-8.4).lineTo(7.5,-4.7).lineTo(2.3,-4.7).lineTo(2.3,8.4).closePath();
	this.shape_11.setTransform(110,-21.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,7.6).curveTo(-5.8,6.5,-7,4.5).curveTo(-8.2,2.5,-8.2,0).curveTo(-8.2,-2.5,-7,-4.5).curveTo(-5.8,-6.5,-3.7,-7.6).curveTo(-1.6,-8.7,1,-8.7).curveTo(3.3,-8.8,5.2,-7.9).curveTo(7,-7.1,8.2,-5.6).lineTo(5.2,-2.9).curveTo(3.6,-4.8,1.2,-4.8).curveTo(-0.1,-4.8,-1.2,-4.2).curveTo(-2.3,-3.6,-2.8,-2.5).curveTo(-3.4,-1.4,-3.4,0).curveTo(-3.4,1.4,-2.8,2.5).curveTo(-2.3,3.6,-1.2,4.2).curveTo(-0.1,4.8,1.2,4.8).curveTo(3.6,4.8,5.2,2.9).lineTo(8.2,5.6).curveTo(7,7.1,5.2,7.9).curveTo(3.3,8.7,1,8.7).curveTo(-1.6,8.7,-3.7,7.6).closePath();
	this.shape_12.setTransform(93.575,-21.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,7.6).curveTo(-5.8,6.5,-7,4.5).curveTo(-8.2,2.5,-8.2,-0).curveTo(-8.2,-2.5,-7,-4.5).curveTo(-5.8,-6.5,-3.7,-7.6).curveTo(-1.6,-8.8,1,-8.8).curveTo(3.3,-8.8,5.2,-7.9).curveTo(7,-7.1,8.2,-5.5).lineTo(5.2,-2.8).curveTo(3.6,-4.8,1.2,-4.8).curveTo(-0.1,-4.8,-1.2,-4.2).curveTo(-2.3,-3.6,-2.8,-2.5).curveTo(-3.4,-1.4,-3.4,-0).curveTo(-3.4,1.4,-2.8,2.5).curveTo(-2.3,3.6,-1.2,4.2).curveTo(-0.1,4.8,1.2,4.8).curveTo(3.6,4.8,5.2,2.8).lineTo(8.2,5.5).curveTo(7,7.1,5.2,7.9).curveTo(3.3,8.8,1,8.8).curveTo(-1.6,8.8,-3.7,7.6).closePath();
	this.shape_13.setTransform(166.525,-51.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.8,8.4).lineTo(3.5,5.2).lineTo(-3.6,5.2).lineTo(-4.9,8.4).lineTo(-9.8,8.4).lineTo(-2.3,-8.4).lineTo(2.3,-8.4).lineTo(9.8,8.4).closePath().moveTo(-2.2,1.7).lineTo(2.1,1.7).lineTo(-0,-3.7).closePath();
	this.shape_14.setTransform(147.625,-51.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.3,8.4).lineTo(3.3,1.8).lineTo(-3.2,1.8).lineTo(-3.2,8.4).lineTo(-8,8.4).lineTo(-8,-8.4).lineTo(-3.2,-8.4).lineTo(-3.2,-2.1).lineTo(3.3,-2.1).lineTo(3.3,-8.4).lineTo(8,-8.4).lineTo(8,8.4).closePath();
	this.shape_15.setTransform(127.95,-51.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.3,8).lineTo(-6.2,4.5).curveTo(-5.2,4.8,-4.5,4.8).curveTo(-3.8,4.8,-3.3,4.5).curveTo(-2.8,4.1,-2.3,3.5).lineTo(-8.8,-8.6).lineTo(-3.8,-8.6).lineTo(0.1,-0.5).lineTo(4.2,-8.6).lineTo(8.8,-8.6).lineTo(1.9,4.4).curveTo(0.8,6.5,-0.8,7.5).curveTo(-2.5,8.6,-4.3,8.6).curveTo(-5.7,8.6,-7.3,8).closePath();
	this.shape_16.setTransform(102.25,-51.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol110, new cjs.Rectangle(34.8,-72,142.3,97.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.smash();
	this.instance.setTransform(0,-87.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol109, new cjs.Rectangle(0,-87.5,155,175), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(118.7,157);
	...
	this.shape_1.setTransform(108.375,156.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.4,7.7).lineTo(-10.4,-7.7).lineTo(-6.2,-7.7).lineTo(-6.2,4.3).lineTo(-2.1,4.3).lineTo(-2.1,-7.7).lineTo(2.2,-7.7).lineTo(2.2,4.3).lineTo(6.1,4.3).lineTo(6.1,-7.7).lineTo(10.5,-7.7).lineTo(10.5,7.7).closePath();
	this.shape_2.setTransform(88.45,156.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.9,7.7).lineTo(-6.9,-7.7).lineTo(-2.6,-7.7).lineTo(-2.6,-2.8).lineTo(1,-2.8).curveTo(3.8,-2.8,5.4,-1.6).curveTo(6.9,-0.3,6.9,2.2).curveTo(6.9,4.9,5.1,6.3).curveTo(3.5,7.7,0.4,7.7).closePath().moveTo(-2.6,4.6).lineTo(0.1,4.6).curveTo(1.2,4.5,1.9,4).curveTo(2.5,3.4,2.5,2.3).curveTo(2.5,0.3,0.1,0.3).lineTo(-2.6,0.3).closePath();
	this.shape_3.setTransform(68.95,156.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.9,7.6).lineTo(-7.6,4).lineTo(-7,4.1).curveTo(-6.2,4.1,-5.7,3.4).curveTo(-5.2,2.7,-5,1.5).lineTo(-4.7,-1.7).lineTo(-4.6,-7.8).lineTo(7.9,-7.8).lineTo(7.9,7.6).lineTo(3.6,7.6).lineTo(3.6,-4.4).lineTo(-0.9,-4.4).lineTo(-0.9,-1.9).curveTo(-1,1.4,-1.5,3.5).curveTo(-1.9,5.6,-2.9,6.7).curveTo(-4,7.8,-5.8,7.8).curveTo(-6.8,7.8,-7.9,7.6).closePath();
	this.shape_4.setTransform(50.9,157.025);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,7).curveTo(-6.3,5.9,-7.5,4.1).curveTo(-8.6,2.3,-8.6,-0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-7).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-7).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,-0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,5.9,4.4,7).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,7).closePath().moveTo(-2.1,-3.8).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,-0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.8).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.8).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,-0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.8).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.8).closePath();
	this.shape_5.setTransform(33.525,156.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(5.8,-7.7).lineTo(5.8,-4.3).lineTo(-2.7,-4.3).lineTo(-2.7,-1.8).lineTo(1.3,-1.8).curveTo(4,-1.9,5.5,-0.7).curveTo(7,0.5,7,2.8).curveTo(7,5.1,5.4,6.4).curveTo(3.7,7.7,0.7,7.7).closePath().moveTo(-2.7,4.6).lineTo(0.4,4.6).curveTo(1.5,4.6,2.1,4.1).curveTo(2.6,3.7,2.6,2.9).curveTo(2.6,1.2,0.4,1.2).lineTo(-2.7,1.2).closePath();
	this.shape_6.setTransform(16.675,156.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.8,7.6).lineTo(-7.6,4).lineTo(-7,4.1).curveTo(-6.2,4.1,-5.7,3.4).curveTo(-5.3,2.7,-5,1.5).lineTo(-4.8,-1.7).lineTo(-4.6,-7.8).lineTo(7.8,-7.8).lineTo(7.8,7.6).lineTo(3.6,7.6).lineTo(3.6,-4.4).lineTo(-0.8,-4.4).lineTo(-1,-1.9).curveTo(-1.1,1.4,-1.4,3.5).curveTo(-1.9,5.6,-3,6.7).curveTo(-4,7.8,-5.9,7.8).curveTo(-6.8,7.8,-7.8,7.6).closePath();
	this.shape_7.setTransform(81.45,127.675);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.9).curveTo(-6.3,6,-7.5,4.1).curveTo(-8.6,2.3,-8.6,-0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-7).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-7).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,-0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,6,4.4,6.9).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,6.9).closePath().moveTo(-2.1,-3.9).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,-0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.8).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.8).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,-0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.9).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.9).closePath();
	this.shape_8.setTransform(64.075,127.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(0.5,-7.7).curveTo(3.2,-7.7,4.8,-6.7).curveTo(6.3,-5.6,6.3,-3.7).curveTo(6.3,-2.5,5.8,-1.7).curveTo(5.2,-0.8,4.2,-0.4).curveTo(5.6,0.1,6.3,1).curveTo(7,2,7,3.3).curveTo(7,5.4,5.4,6.5).curveTo(3.8,7.7,0.9,7.7).closePath().moveTo(-2.7,4.6).lineTo(0.7,4.6).curveTo(2.6,4.5,2.6,3).curveTo(2.6,1.4,0.7,1.4).lineTo(-2.7,1.4).closePath().moveTo(-2.7,-1.5).lineTo(0,-1.5).curveTo(1.9,-1.6,1.9,-3.1).curveTo(1.9,-4.6,0,-4.6).lineTo(-2.7,-4.6).closePath();
	this.shape_9.setTransform(47.15,127.55);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.1,7.7).lineTo(-2.1,-4.3).lineTo(-6.8,-4.3).lineTo(-6.8,-7.7).lineTo(6.9,-7.7).lineTo(6.9,-4.3).lineTo(2.2,-4.3).lineTo(2.2,7.7).closePath();
	this.shape_10.setTransform(31.3,127.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.4,7).curveTo(-5.3,6,-6.4,4.1).curveTo(-7.5,2.3,-7.5,-0).curveTo(-7.5,-2.3,-6.4,-4.2).curveTo(-5.3,-5.9,-3.4,-7).curveTo(-1.5,-8,0.9,-8).curveTo(3,-8,4.7,-7.2).curveTo(6.4,-6.5,7.5,-5.1).lineTo(4.8,-2.6).curveTo(3.3,-4.4,1.1,-4.4).curveTo(-0.1,-4.4,-1.1,-3.9).curveTo(-2.1,-3.3,-2.6,-2.3).curveTo(-3.1,-1.3,-3.1,-0).curveTo(-3.1,1.3,-2.6,2.3).curveTo(-2.1,3.3,-1.1,3.8).curveTo(-0.1,4.4,1.1,4.4).curveTo(3.3,4.4,4.8,2.6).lineTo(7.5,5.1).curveTo(6.4,6.5,4.7,7.3).curveTo(3,8,0.9,8).curveTo(-1.5,8,-3.4,7).closePath();
	this.shape_11.setTransform(16.225,127.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,10).lineTo(3.1,1).lineTo(-3.3,10).lineTo(-7.4,10).lineTo(-7.4,-5.4).lineTo(-3.1,-5.4).lineTo(-3.1,3.6).lineTo(3.3,-5.4).lineTo(7.4,-5.4).lineTo(7.4,10).closePath().moveTo(-3.4,-7.3).curveTo(-4.5,-8.2,-4.5,-9.9).lineTo(-1.6,-9.9).curveTo(-1.6,-9.2,-1.2,-8.8).curveTo(-0.8,-8.4,-0,-8.5).curveTo(0.8,-8.4,1.2,-8.8).curveTo(1.6,-9.2,1.6,-9.9).lineTo(4.5,-9.9).curveTo(4.5,-8.2,3.4,-7.3).curveTo(2.3,-6.4,-0,-6.4).curveTo(-2.4,-6.4,-3.4,-7.3).closePath();
	this.shape_12.setTransform(48.525,95.95);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(5.9,-7.7).lineTo(5.9,-4.3).lineTo(-1.9,-4.3).lineTo(-1.9,-1.7).lineTo(5,-1.7).lineTo(5,1.5).lineTo(-1.9,1.5).lineTo(-1.9,4.3).lineTo(6.2,4.3).lineTo(6.2,7.7).closePath();
	this.shape_13.setTransform(32.475,98.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.8,7.7).lineTo(2.8,2.4).curveTo(1,3.1,-0.4,3).curveTo(-3.7,3,-5.4,1.5).curveTo(-7.1,-0.1,-7.1,-3).lineTo(-7.1,-7.7).lineTo(-2.8,-7.7).lineTo(-2.8,-3.4).curveTo(-2.8,-0.5,0.1,-0.5).curveTo(1.6,-0.5,2.8,-1).lineTo(2.8,-7.7).lineTo(7.1,-7.7).lineTo(7.1,7.7).closePath();
	this.shape_14.setTransform(15.9,98.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.2,4.1).lineTo(-1.2,0.5).curveTo(-1.8,0.3,-2.2,-0.4).curveTo(-2.5,-0.9,-2.5,-1.7).curveTo(-2.5,-2.8,-1.8,-3.4).curveTo(-1.1,-4.1,0,-4.1).curveTo(1.1,-4.1,1.8,-3.4).curveTo(2.5,-2.8,2.5,-1.7).lineTo(2.4,-0.7).lineTo(1.8,0.9).lineTo(0.4,4.1).closePath();
	this.shape_15.setTransform(96.2,75.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,10).lineTo(3.1,1).lineTo(-3.3,10).lineTo(-7.4,10).lineTo(-7.4,-5.5).lineTo(-3.1,-5.5).lineTo(-3.1,3.6).lineTo(3.3,-5.5).lineTo(7.4,-5.5).lineTo(7.4,10).closePath().moveTo(-3.4,-7.3).curveTo(-4.5,-8.2,-4.5,-10).lineTo(-1.6,-10).curveTo(-1.6,-9.2,-1.2,-8.8).curveTo(-0.8,-8.5,-0,-8.5).curveTo(0.8,-8.5,1.2,-8.8).curveTo(1.6,-9.2,1.6,-10).lineTo(4.5,-10).curveTo(4.5,-8.2,3.4,-7.3).curveTo(2.3,-6.4,-0,-6.4).curveTo(-2.4,-6.4,-3.4,-7.3).closePath();
	this.shape_16.setTransform(84.075,66.6);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.4,7.7).lineTo(3.3,4.7).lineTo(-3.3,4.7).lineTo(-4.5,7.7).lineTo(-9,7.7).lineTo(-2.1,-7.7).lineTo(2.2,-7.7).lineTo(8.9,7.7).closePath().moveTo(-2,1.5).lineTo(1.9,1.5).lineTo(-0.1,-3.4).closePath();
	this.shape_17.setTransform(65.95,68.85);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3,7.7).lineTo(3,1.7).lineTo(-3,1.7).lineTo(-3,7.7).lineTo(-7.3,7.7).lineTo(-7.3,-7.7).lineTo(-3,-7.7).lineTo(-3,-1.9).lineTo(3,-1.9).lineTo(3,-7.7).lineTo(7.3,-7.7).lineTo(7.3,7.7).closePath();
	this.shape_18.setTransform(47.925,68.85);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,7.7).curveTo(-5.3,7.3,-6.8,6.6).lineTo(-5.5,3.5).curveTo(-4.4,4,-3.2,4.3).curveTo(-2,4.6,-1,4.6).curveTo(0.5,4.6,1.4,4.1).curveTo(2.4,3.6,2.3,2.8).curveTo(2.3,2.1,1.8,1.7).curveTo(1.2,1.4,0.3,1.4).lineTo(-3.7,1.4).lineTo(-3.7,-1.7).lineTo(-0.1,-1.7).curveTo(0.8,-1.7,1.3,-2.1).curveTo(1.7,-2.5,1.7,-3.1).curveTo(1.8,-3.8,1,-4.2).curveTo(0.3,-4.6,-1,-4.6).curveTo(-1.9,-4.6,-3,-4.3).curveTo(-4,-4.1,-5,-3.5).lineTo(-6.3,-6.8).curveTo(-3.8,-8,-0.9,-8).curveTo(1,-8.1,2.6,-7.5).curveTo(4.2,-7,5.2,-5.9).curveTo(6.1,-4.9,6.1,-3.5).curveTo(6.2,-2.5,5.6,-1.6).curveTo(5,-0.8,4,-0.3).curveTo(5.3,0.2,6,1.2).curveTo(6.8,2.1,6.8,3.3).curveTo(6.8,4.8,5.8,5.8).curveTo(4.8,6.9,3.1,7.5).curveTo(1.5,8,-0.5,8).curveTo(-2,8,-3.7,7.7).closePath();
	this.shape_19.setTransform(31.5,68.85);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,7.4).lineTo(-5.7,4.1).curveTo(-4.8,4.4,-4.2,4.4).curveTo(-3.5,4.4,-3,4.1).curveTo(-2.5,3.8,-2.1,3.2).lineTo(-8.1,-7.9).lineTo(-3.5,-7.9).lineTo(0.1,-0.5).lineTo(3.8,-7.9).lineTo(8.1,-7.9).lineTo(1.7,4).curveTo(0.7,5.9,-0.8,6.9).curveTo(-2.3,7.9,-4,7.9).curveTo(-5.3,7.9,-6.7,7.4).closePath();
	this.shape_20.setTransform(16.225,69.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol108, new cjs.Rectangle(6,50.2,118.2,122.39999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#B4060D").beginStroke().moveTo(-83.5,306).lineTo(-83.5,-306).lineTo(83.5,-306).lineTo(83.5,306).closePath();
	this.shape.setTransform(83.5,174.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol106, new cjs.Rectangle(0,-131.5,167,612), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.2,7.7).lineTo(-2.2,-0).lineTo(-2.2,7.7).lineTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(-3.1,-7.7).lineTo(2.3,0.1).lineTo(2.3,-7.7).lineTo(6.2,-7.7).lineTo(6.2,7.7).closePath();
	this.shape.setTransform(157.65,58.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.4).curveTo(-6.1,4.9,-6.1,2.5).lineTo(-6.1,-7.9).lineTo(-2.2,-7.9).lineTo(-2.2,2.1).curveTo(-2.2,4,0,4).curveTo(2.1,4,2.2,2.1).lineTo(2.2,-7.9).lineTo(6.1,-7.9).lineTo(6.1,2.5).curveTo(6.1,4.9,4.4,6.4).curveTo(2.7,7.9,0,7.9).curveTo(-2.7,7.9,-4.4,6.4).closePath();
	this.shape_1.setTransform(142.1,58.325);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.6,5.7).curveTo(-8,3.4,-8,-0).curveTo(-8,-3.3,-5.6,-5.7).curveTo(-3.3,-8,0.1,-8).curveTo(2.3,-8,4,-7).curveTo(5.8,-6.1,6.8,-4.5).lineTo(3.5,-2.5).curveTo(3.1,-3.3,2.1,-3.8).curveTo(1.3,-4.2,0.2,-4.2).curveTo(-1.7,-4.2,-2.8,-3).curveTo(-4,-1.8,-4,0.1).curveTo(-4,1.8,-2.9,3.1).curveTo(-1.7,4.3,0.4,4.3).curveTo(3.1,4.3,3.9,2.2).lineTo(0.2,2.2).lineTo(0.2,-1.1).lineTo(8,-1.1).lineTo(8,0.4).curveTo(7.9,3.9,5.8,5.9).curveTo(3.7,8.1,0.3,8.1).curveTo(-3.3,8.1,-5.6,5.7).closePath();
	this.shape_2.setTransform(125.4,58.15);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8,0,-8).curveTo(3.4,-8,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8.1,0,8.1).curveTo(-3.4,8.1,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_3.setTransform(107.125,58.15);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.9,7.7).lineTo(-4.9,-7.7).lineTo(4.8,-7.7).lineTo(4.8,-4.1).lineTo(-1,-4.1).lineTo(-1,-1.9).lineTo(4.3,-1.9).lineTo(4.3,1.8).lineTo(-1,1.8).lineTo(-1,4).lineTo(5,4).lineTo(5,7.7).closePath();
	this.shape_4.setTransform(91.85,58.15);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.8,7).curveTo(-5.4,6,-6.1,4.2).lineTo(-2.7,2.2).curveTo(-1.9,4.3,0.3,4.3).curveTo(2.1,4.3,2.1,3.2).curveTo(2.1,2.6,1.1,2.1).lineTo(-0.8,1.5).curveTo(-3.1,0.9,-4.3,-0.2).curveTo(-5.4,-1.4,-5.4,-3.3).curveTo(-5.4,-5.4,-3.9,-6.7).curveTo(-2.3,-8,-0.1,-8).curveTo(1.9,-8,3.4,-7.1).curveTo(4.9,-6.2,5.6,-4.5).lineTo(2.3,-2.5).curveTo(1.6,-4.3,-0.1,-4.3).curveTo(-0.7,-4.3,-1.1,-4).curveTo(-1.5,-3.7,-1.5,-3.3).curveTo(-1.5,-2.7,-0.9,-2.4).curveTo(-0.4,-2,1.2,-1.6).lineTo(3,-1).curveTo(3.7,-0.7,4.5,-0.2).curveTo(6.1,0.9,6.1,3.2).curveTo(6.1,5.5,4.5,6.7).curveTo(2.8,8.1,0.2,8.1).curveTo(-2.2,8.1,-3.8,7).closePath();
	this.shape_5.setTransform(78.325,58.15);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,5.8).curveTo(-7.3,3.5,-7.3,-0).curveTo(-7.3,-3.5,-5.1,-5.7).curveTo(-2.8,-8,0.7,-8).curveTo(2.8,-8,4.6,-7).curveTo(6.3,-6,7.3,-4.3).lineTo(3.9,-2.4).curveTo(3.5,-3.3,2.7,-3.7).curveTo(1.7,-4.2,0.7,-4.2).curveTo(-1.1,-4.2,-2.3,-3).curveTo(-3.4,-1.8,-3.4,-0).curveTo(-3.4,1.9,-2.3,3.1).curveTo(-1.1,4.2,0.7,4.2).curveTo(1.7,4.2,2.7,3.7).curveTo(3.5,3.2,3.9,2.4).lineTo(7.3,4.4).curveTo(6.4,6.1,4.6,7).curveTo(2.8,8.1,0.7,8.1).curveTo(-2.8,8.1,-5.1,5.8).closePath();
	this.shape_6.setTransform(57,58.15);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.8,7.7).lineTo(-5.8,-7.7).lineTo(0.3,-7.7).curveTo(2.6,-7.7,4,-6.5).curveTo(5.3,-5.4,5.3,-3.3).curveTo(5.3,-1.4,3.9,-0.3).curveTo(5.8,0.9,5.8,3.2).curveTo(5.8,5.2,4.4,6.5).curveTo(3,7.7,0.7,7.7).closePath().moveTo(-1.9,4.2).lineTo(0.6,4.2).curveTo(1.2,4.2,1.5,3.8).curveTo(1.9,3.5,1.9,2.9).curveTo(1.9,2.3,1.5,2).curveTo(1.2,1.6,0.6,1.6).lineTo(-1.9,1.6).closePath().moveTo(-1.9,-1.7).lineTo(0.2,-1.7).curveTo(0.7,-1.8,1.1,-2.1).curveTo(1.4,-2.4,1.4,-3).curveTo(1.4,-3.5,1.1,-3.9).curveTo(0.7,-4.2,0.2,-4.2).lineTo(-1.9,-4.2).closePath();
	this.shape_7.setTransform(147.375,30.35);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8.1,0,-8).curveTo(3.4,-8.1,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8,0,8.1).curveTo(-3.4,8,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_8.setTransform(130.625,30.35);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.9,7.7).lineTo(-1.9,-3.9).lineTo(-5.8,-3.9).lineTo(-5.8,-7.7).lineTo(5.8,-7.7).lineTo(5.8,-3.9).lineTo(2,-3.9).lineTo(2,7.7).closePath();
	this.shape_9.setTransform(114.925,30.35);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.3,9.8).lineTo(2.3,2.1).lineTo(-3.1,9.8).lineTo(-6.2,9.8).lineTo(-6.2,-5.6).lineTo(-2.2,-5.6).lineTo(-2.2,2.2).lineTo(3.2,-5.6).lineTo(6.2,-5.6).lineTo(6.2,9.8).closePath().moveTo(-3.6,-6.8).lineTo(-3.6,-9.8).lineTo(3.5,-9.8).lineTo(3.5,-6.8).closePath();
	this.shape_10.setTransform(100.5,28.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.2,7.7).lineTo(2.6,5.5).lineTo(-2.6,5.5).lineTo(-3.2,7.7).lineTo(-7.5,7.7).lineTo(-2.4,-7.7).lineTo(2.4,-7.7).lineTo(7.5,7.7).closePath().moveTo(-1.5,2.1).lineTo(1.6,2.1).lineTo(-0,-3.2).closePath();
	this.shape_11.setTransform(84.725,30.35);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5,5.7).curveTo(-7.4,3.4,-7.4,-0).curveTo(-7.4,-3.4,-5,-5.7).curveTo(-2.8,-8.1,0.7,-8).curveTo(2.8,-8.1,4.6,-7).curveTo(6.3,-6,7.4,-4.3).lineTo(3.9,-2.4).curveTo(3.5,-3.3,2.7,-3.7).curveTo(1.8,-4.2,0.7,-4.2).curveTo(-1.2,-4.2,-2.3,-3).curveTo(-3.4,-1.8,-3.4,-0).curveTo(-3.4,1.9,-2.3,3).curveTo(-1.2,4.2,0.7,4.2).curveTo(1.8,4.2,2.7,3.7).curveTo(3.5,3.3,3.9,2.4).lineTo(7.4,4.4).curveTo(6.4,6,4.6,7.1).curveTo(2.8,8,0.7,8.1).curveTo(-2.8,8.1,-5,5.7).closePath();
	this.shape_12.setTransform(68.5,30.35);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.3,7.7).lineTo(2.3,-0).lineTo(-3.2,7.7).lineTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(-2.3,-7.7).lineTo(-2.3,0.1).lineTo(3.2,-7.7).lineTo(6.2,-7.7).lineTo(6.2,7.7).closePath();
	this.shape_13.setTransform(154.65,2.55);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.3,7.7).lineTo(2.3,-0).lineTo(-3.2,7.7).lineTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(-2.3,-7.7).lineTo(-2.3,0.1).lineTo(3.2,-7.7).lineTo(6.2,-7.7).lineTo(6.2,7.7).closePath();
	this.shape_14.setTransform(138.8,2.55);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3,9.2).lineTo(3,6.2).lineTo(-6.9,6.2).lineTo(-6.9,-9.2).lineTo(-2.9,-9.2).lineTo(-2.9,2.4).lineTo(1.1,2.4).lineTo(1.1,-9.2).lineTo(5.2,-9.2).lineTo(5.2,2.4).lineTo(6.9,2.4).lineTo(6.9,9.2).closePath();
	this.shape_15.setTransform(123.075,4.025);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.3,7.7).lineTo(2.3,-0).lineTo(-3.2,7.7).lineTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(-2.3,-7.7).lineTo(-2.3,0.1).lineTo(3.2,-7.7).lineTo(6.2,-7.7).lineTo(6.2,7.7).closePath();
	this.shape_16.setTransform(106.5,2.55);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,4.4).lineTo(-2.5,2.5).curveTo(-1.8,4.3,0.1,4.3).curveTo(1.9,4.3,1.9,2.9).curveTo(1.9,1.7,0.5,1.7).lineTo(-1.9,1.6).lineTo(-1.9,-1.8).lineTo(-0.4,-1.8).curveTo(1.4,-1.8,1.4,-3.1).curveTo(1.4,-4.4,-0.2,-4.4).curveTo(-1.7,-4.4,-2.4,-2.8).lineTo(-5.7,-4.7).curveTo(-4.9,-6.3,-3.5,-7.1).curveTo(-2,-8.1,-0.1,-8).curveTo(2.3,-8.1,3.9,-6.8).curveTo(5.4,-5.5,5.4,-3.4).curveTo(5.4,-1.4,3.8,-0.2).curveTo(5.9,0.9,5.9,3.4).curveTo(5.9,5.4,4.3,6.7).curveTo(2.7,8,0.1,8.1).curveTo(-4.4,8.1,-5.9,4.4).closePath();
	this.shape_17.setTransform(91.875,2.55);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8.1,0,-8).curveTo(3.4,-8.1,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8,0,8.1).curveTo(-3.4,8,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_18.setTransform(76.075,2.55);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2,7.7).lineTo(2,-3.9).lineTo(-2,-3.9).lineTo(-2,7.7).lineTo(-6,7.7).lineTo(-6,-7.7).lineTo(5.9,-7.7).lineTo(5.9,7.7).closePath();
	this.shape_19.setTransform(59.25,2.55);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.3,9.8).lineTo(2.3,2.1).lineTo(-3.2,9.8).lineTo(-6.2,9.8).lineTo(-6.2,-5.6).lineTo(-2.3,-5.6).lineTo(-2.3,2.2).lineTo(3.2,-5.6).lineTo(6.2,-5.6).lineTo(6.2,9.8).closePath().moveTo(-3.5,-6.8).lineTo(-3.5,-9.8).lineTo(3.5,-9.8).lineTo(3.5,-6.8).closePath();
	this.shape_20.setTransform(158.85,-27.375);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.2,7.7).lineTo(2.2,2.7).lineTo(1.3,2.7).lineTo(-1.8,7.7).lineTo(-6.1,7.7).lineTo(-2.6,2.2).curveTo(-4,1.5,-4.8,0.3).curveTo(-5.6,-0.9,-5.6,-2.4).curveTo(-5.6,-4.7,-4,-6.2).curveTo(-2.4,-7.7,-0.1,-7.7).lineTo(6.1,-7.7).lineTo(6.1,7.7).closePath().moveTo(-1.2,-3.6).curveTo(-1.7,-3.1,-1.7,-2.4).curveTo(-1.7,-1.5,-1.2,-1.1).curveTo(-0.7,-0.6,-0,-0.6).lineTo(2.2,-0.6).lineTo(2.2,-4.1).lineTo(-0,-4.1).curveTo(-0.7,-4.1,-1.2,-3.6).closePath();
	this.shape_21.setTransform(143.125,-25.25);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,7.7).lineTo(-5.7,-7.7).lineTo(0.2,-7.7).curveTo(2.6,-7.7,4.2,-6.2).curveTo(5.7,-4.7,5.7,-2.3).curveTo(5.7,0.1,4.2,1.6).curveTo(2.6,3.1,0.2,3.1).lineTo(-1.8,3.1).lineTo(-1.8,7.7).closePath().moveTo(-1.8,-0.7).lineTo(0.2,-0.7).curveTo(0.9,-0.6,1.3,-1.1).curveTo(1.8,-1.6,1.8,-2.3).curveTo(1.8,-3.1,1.3,-3.5).curveTo(0.9,-4,0.2,-3.9).lineTo(-1.8,-3.9).closePath();
	this.shape_22.setTransform(129.55,-25.25);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.9,7.7).lineTo(-4.9,-7.7).lineTo(4.9,-7.7).lineTo(4.9,-4.1).lineTo(-1,-4.1).lineTo(-1,-1.9).lineTo(4.3,-1.9).lineTo(4.3,1.8).lineTo(-1,1.8).lineTo(-1,4).lineTo(5,4).lineTo(5,7.7).closePath();
	this.shape_23.setTransform(116,-25.25);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.8,7.7).lineTo(-5.8,-7.7).lineTo(0.3,-7.7).curveTo(2.6,-7.7,4,-6.5).curveTo(5.3,-5.4,5.3,-3.3).curveTo(5.3,-1.4,3.9,-0.2).curveTo(5.8,0.9,5.8,3.2).curveTo(5.8,5.3,4.4,6.4).curveTo(3,7.7,0.7,7.7).closePath().moveTo(-1.9,4.2).lineTo(0.6,4.2).curveTo(1.2,4.2,1.5,3.8).curveTo(1.9,3.4,1.9,2.9).curveTo(1.9,2.3,1.5,1.9).curveTo(1.2,1.6,0.6,1.6).lineTo(-1.9,1.6).closePath().moveTo(-1.9,-1.8).lineTo(0.2,-1.8).curveTo(0.7,-1.8,1.1,-2.1).curveTo(1.4,-2.4,1.4,-2.9).curveTo(1.4,-3.5,1.1,-3.8).curveTo(0.7,-4.2,0.2,-4.2).lineTo(-1.9,-4.2).closePath();
	this.shape_24.setTransform(102.625,-25.25);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8.1,0,-8.1).curveTo(3.4,-8.1,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8.1,0,8.1).curveTo(-3.4,8.1,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_25.setTransform(85.875,-25.25);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,7.7).lineTo(-5.7,-7.7).lineTo(0.2,-7.7).curveTo(2.6,-7.7,4.2,-6.2).curveTo(5.7,-4.7,5.7,-2.3).curveTo(5.7,0.1,4.2,1.6).curveTo(2.6,3.1,0.2,3.1).lineTo(-1.8,3.1).lineTo(-1.8,7.7).closePath().moveTo(-1.8,-0.7).lineTo(0.2,-0.7).curveTo(0.9,-0.6,1.3,-1.1).curveTo(1.8,-1.6,1.8,-2.3).curveTo(1.8,-3.1,1.3,-3.5).curveTo(0.9,-4,0.2,-3.9).lineTo(-1.8,-3.9).closePath();
	this.shape_26.setTransform(70.15,-25.25);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2,7.7).lineTo(2,-3.9).lineTo(-2,-3.9).lineTo(-2,7.7).lineTo(-5.9,7.7).lineTo(-5.9,-7.7).lineTo(6,-7.7).lineTo(6,7.7).closePath();
	this.shape_27.setTransform(55.05,-25.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol105, new cjs.Rectangle(45.8,-41.7,123.60000000000001,115.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-85,306).lineTo(-85,-306).lineTo(85,-306).lineTo(85,306).closePath();
	this.shape.setTransform(85,253.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol104, new cjs.Rectangle(0,-52.5,170,612), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9F060C").beginStroke().moveTo(-83,306).lineTo(-83,-306).lineTo(83,-306).lineTo(83,306).closePath();
	this.shape.setTransform(83,254.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol76, new cjs.Rectangle(0,-51.5,166,612), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(292.65,44.7,1,1,0,0,0,128.3,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({x:143.65,alpha:1},19,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(345));

	// Layer_7
	this.instance_1 = new lib.Symbol111();
	this.instance_1.setTransform(87,420.7,1,1,0,0,0,73,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({x:88.35,y:312.75,alpha:1},20,cjs.Ease.quadOut).to({y:334.75},125).wait(20).to({_off:true},1).wait(345));

	// Layer_5
	this.instance_2 = new lib.Symbol1();
	this.instance_2.setTransform(80.1,3.95,0.5393,0.5393,0,0,0,101.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(174).to({_off:true},1).wait(345));

	// Layer_6
	this.instance_3 = new lib.Symbol109();
	this.instance_3.setTransform(82.5,342.9,1,1,0,0,0,77.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(28).to({_off:false},0).wait(146).to({_off:true},1).wait(345));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-83.5,305.5).lineTo(-83.5,-305.5).lineTo(83.5,-305.5).lineTo(83.5,305.5).closePath();
	this.shape.setTransform(81.85,253.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(174).to({_off:true},1).wait(345));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.6,-51.5,290.20000000000005,611);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(88.05,327.9,0.16,0.16,0,0,0,25,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({_off:false},0).to({scaleX:1.2,scaleY:1.2,x:88.1},8).to({scaleX:1,scaleY:1,x:88.05},3).wait(83).to({_off:true},1).wait(358));

	// Layer_3
	this.instance_1 = new lib.Symbol105();
	this.instance_1.setTransform(81,277.2,1,1,0,0,0,104.8,16);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(11).to({_off:false},0).to({y:227.2,alpha:1},11,cjs.Ease.quadOut).wait(90).to({_off:true},1).wait(358));

	// Layer_2
	this.instance_2 = new lib.Symbol1();
	this.instance_2.setTransform(82.7,28.3,1.5608,1.5608,0,0,0,101.5,0.2);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:101.7,regY:0.1,scaleX:0.4705,scaleY:0.4705,x:82.85,y:28.15,alpha:1},15).to({regX:101.5,scaleX:0.6577,scaleY:0.6577,x:82.75},4).wait(93).to({_off:true},1).wait(358));

	// Layer_1
	this.instance_3 = new lib.Symbol21();
	this.instance_3.setTransform(82.6,263.65,0.2278,6.6025,0,0,0,362.6,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(112).to({regX:362.7},0).to({_off:true},1).wait(358));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-75.7,-48.6,316.9,614);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-0.7,3.8).lineTo(-0.7,2.3).lineTo(0.7,2.3).lineTo(0.7,3.8).closePath().moveTo(-0.4,1.4).lineTo(-0.8,-3.5).lineTo(-0.8,-3.8).lineTo(0.8,-3.8).lineTo(0.8,-3.5).lineTo(0.4,1.4).closePath();
	this.shape.setTransform(41.575,4.35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.2,2.2).curveTo(-3.1,1.3,-3.1,0).lineTo(-3.1,0).curveTo(-3.1,-1.2,-2.2,-2.2).curveTo(-1.3,-3.1,-0,-3).curveTo(1.4,-3.1,2.2,-2.2).curveTo(3.1,-1.3,3.1,0).curveTo(3.1,1.2,2.2,2.2).curveTo(1.3,3,-0,3.1).curveTo(-1.3,3,-2.2,2.2).closePath().moveTo(-1.3,-1.3).curveTo(-1.7,-0.8,-1.7,0).curveTo(-1.7,0.8,-1.3,1.3).curveTo(-0.7,1.9,-0,1.8).curveTo(0.8,1.8,1.3,1.4).curveTo(1.8,0.8,1.8,0).lineTo(1.8,0).curveTo(1.8,-0.8,1.2,-1.3).curveTo(0.8,-1.9,-0,-1.9).curveTo(-0.8,-1.8,-1.3,-1.3).closePath();
	this.shape_1.setTransform(35.75,5.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.3,2.9).lineTo(1.3,0.6).lineTo(-1.4,0.6).lineTo(-1.4,2.9).lineTo(-2.7,2.9).lineTo(-2.7,-2.9).lineTo(-1.4,-2.9).lineTo(-1.4,-0.6).lineTo(1.3,-0.6).lineTo(1.3,-2.9).lineTo(2.7,-2.9).lineTo(2.7,2.9).closePath();
	this.shape_2.setTransform(28.175,5.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-0.6,2.9).lineTo(-0.6,-1.7).lineTo(-2.8,-1.7).lineTo(-2.8,-2.9).lineTo(2.7,-2.9).lineTo(2.7,-1.7).lineTo(0.6,-1.7).lineTo(0.6,2.9).closePath();
	this.shape_3.setTransform(21.05,5.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2,2.5).curveTo(-2.6,2,-2.6,1.3).lineTo(-2.6,1.2).curveTo(-2.6,0.3,-2,-0.2).curveTo(-1.3,-0.7,-0.2,-0.6).curveTo(0.6,-0.6,1.3,-0.4).lineTo(1.3,-0.5).curveTo(1.3,-1.9,-0.1,-1.9).curveTo(-0.9,-1.9,-1.8,-1.4).lineTo(-2.1,-2.5).curveTo(-1,-3,0.1,-3).curveTo(1.4,-3,2,-2.3).curveTo(2.6,-1.7,2.6,-0.5).lineTo(2.6,2.9).lineTo(1.3,2.9).lineTo(1.3,2.2).curveTo(0.6,3,-0.6,3).curveTo(-1.4,3,-2,2.5).closePath().moveTo(-1,0.5).curveTo(-1.3,0.7,-1.3,1.2).curveTo(-1.3,1.6,-1,1.8).curveTo(-0.7,2.1,-0.2,2.1).curveTo(0.5,2.1,0.9,1.7).curveTo(1.4,1.4,1.4,0.8).lineTo(1.4,0.4).curveTo(0.8,0.2,0,0.2).curveTo(-0.6,0.2,-1,0.5).closePath();
	this.shape_4.setTransform(14.075,5.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.7,2.9).lineTo(-0,-1.3).lineTo(-1.7,2.9).lineTo(-3.2,2.9).lineTo(-0.6,-2.9).lineTo(0.7,-2.9).lineTo(3.1,2.9).closePath();
	this.shape_5.setTransform(7.05,5.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.3,2.9).lineTo(1.3,-1.7).lineTo(-1.4,-1.7).lineTo(-1.4,2.9).lineTo(-2.6,2.9).lineTo(-2.6,-2.9).lineTo(2.7,-2.9).lineTo(2.7,2.9).closePath();
	this.shape_6.setTransform(-0.35,5.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-1.8,2.2).curveTo(-2.7,1.3,-2.7,0).lineTo(-2.7,0).curveTo(-2.7,-1.2,-1.8,-2.2).curveTo(-0.9,-3.1,0.3,-3).curveTo(1.7,-3.1,2.7,-2.1).lineTo(1.9,-1.2).curveTo(1.1,-1.8,0.3,-1.9).curveTo(-0.4,-1.9,-0.8,-1.3).curveTo(-1.4,-0.8,-1.4,0).curveTo(-1.4,0.8,-0.8,1.4).curveTo(-0.4,1.8,0.4,1.8).curveTo(1.2,1.8,1.9,1.2).lineTo(2.7,2).curveTo(2.2,2.4,1.7,2.7).curveTo(1.1,3.1,0.3,3.1).curveTo(-0.9,3,-1.8,2.2).closePath();
	this.shape_7.setTransform(-7.45,5.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2,2.2).curveTo(-2.8,1.4,-2.8,0).curveTo(-2.8,-1.3,-2,-2.2).curveTo(-1.2,-3.1,0,-3).curveTo(1.3,-3.1,2.1,-2.2).curveTo(2.8,-1.2,2.8,0.1).lineTo(2.8,0.5).lineTo(-1.5,0.5).curveTo(-1.4,1.1,-0.9,1.5).curveTo(-0.5,1.9,0.2,2).curveTo(1,1.9,1.8,1.3).lineTo(2.6,2).curveTo(1.6,3,0.2,3.1).curveTo(-1.1,3.1,-2,2.2).closePath().moveTo(-1,-1.5).curveTo(-1.4,-1.1,-1.5,-0.4).lineTo(1.5,-0.4).curveTo(1.4,-1.1,1,-1.5).curveTo(0.7,-1.9,0,-2).curveTo(-0.6,-1.9,-1,-1.5).closePath();
	this.shape_8.setTransform(-14.475,5.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.1,3.4).curveTo(-3,2.4,-3,0.6).curveTo(-3,-1.4,-2.3,-2.5).curveTo(-1.5,-3.5,0.1,-3.8).lineTo(2.2,-4.1).lineTo(2.4,-2.9).lineTo(0.3,-2.6).curveTo(-0.7,-2.4,-1.2,-2).curveTo(-1.7,-1.5,-1.8,-0.6).curveTo(-1,-1.5,0.3,-1.4).curveTo(1.6,-1.5,2.3,-0.7).curveTo(3,-0,3,1.2).curveTo(3,2.5,2.2,3.3).curveTo(1.3,4.2,-0,4.2).curveTo(-1.3,4.1,-2.1,3.4).closePath().moveTo(-1.2,0).curveTo(-1.7,0.5,-1.7,1.3).curveTo(-1.7,2,-1.2,2.5).curveTo(-0.8,3,-0,3).curveTo(0.8,3,1.2,2.5).curveTo(1.7,2,1.7,1.2).curveTo(1.7,0.4,1.3,0).curveTo(0.8,-0.5,0.1,-0.4).curveTo(-0.7,-0.4,-1.2,0).closePath();
	this.shape_9.setTransform(-21.875,4.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.3,4.1).lineTo(1.3,0.2).lineTo(-1.5,4.1).lineTo(-2.7,4.1).lineTo(-2.7,-1.8).lineTo(-1.4,-1.8).lineTo(-1.4,1.9).lineTo(1.4,-1.8).lineTo(2.7,-1.8).lineTo(2.7,4.1).closePath().moveTo(-1.3,-2.9).curveTo(-1.9,-3.3,-1.9,-4).lineTo(-1,-4).curveTo(-0.8,-3.4,-0,-3.4).curveTo(0.7,-3.4,0.9,-4).lineTo(1.9,-4).curveTo(1.8,-3.3,1.3,-2.9).curveTo(0.8,-2.4,-0,-2.5).curveTo(-0.8,-2.4,-1.3,-2.9).closePath();
	this.shape_10.setTransform(36.075,-7.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.6,3.5).lineTo(-2.2,2.5).curveTo(-1.8,2.7,-1.4,2.7).curveTo(-1.3,2.7,-1.2,2.6).curveTo(-1.2,2.6,-1.1,2.6).curveTo(-1.1,2.6,-1,2.6).curveTo(-1,2.5,-0.9,2.5).curveTo(-0.7,2.4,-0.6,2).lineTo(-3,-3.8).lineTo(-1.6,-3.8).lineTo(0.1,0.5).lineTo(1.6,-3.8).lineTo(3,-3.8).lineTo(0.7,2.1).curveTo(0.3,3.1,-0.1,3.4).curveTo(-0.5,3.8,-1.3,3.8).curveTo(-2,3.8,-2.6,3.5).closePath();
	this.shape_11.setTransform(28.775,-5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.1,3.3).curveTo(-3,2.4,-3,0.6).curveTo(-3,-1.4,-2.3,-2.5).curveTo(-1.5,-3.5,0.1,-3.8).lineTo(2.2,-4.2).lineTo(2.4,-2.9).lineTo(0.3,-2.6).curveTo(-0.7,-2.4,-1.2,-1.9).curveTo(-1.7,-1.5,-1.8,-0.6).curveTo(-1,-1.5,0.3,-1.5).curveTo(1.6,-1.4,2.3,-0.7).curveTo(3,0,3,1.2).curveTo(3,2.4,2.2,3.3).curveTo(1.3,4.2,-0,4.1).curveTo(-1.3,4.1,-2.1,3.3).closePath().moveTo(-1.2,0.1).curveTo(-1.7,0.5,-1.7,1.2).curveTo(-1.7,2.1,-1.2,2.5).curveTo(-0.8,3,-0,3).curveTo(0.8,3,1.2,2.5).curveTo(1.7,2,1.7,1.2).curveTo(1.7,0.5,1.3,-0).curveTo(0.8,-0.4,0.1,-0.5).curveTo(-0.7,-0.5,-1.2,0.1).closePath();
	this.shape_12.setTransform(21.425,-7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.2,2.1).curveTo(-3.1,1.3,-3.1,0).lineTo(-3.1,-0).curveTo(-3.1,-1.2,-2.2,-2.1).curveTo(-1.3,-3,0,-3).curveTo(1.4,-3,2.3,-2.1).curveTo(3.1,-1.3,3.1,-0).curveTo(3.1,1.3,2.2,2.1).curveTo(1.3,3,0,3).curveTo(-1.3,3,-2.2,2.1).closePath().moveTo(-1.2,-1.4).curveTo(-1.8,-0.8,-1.8,-0).curveTo(-1.8,0.8,-1.2,1.3).curveTo(-0.8,1.8,0,1.8).curveTo(0.8,1.9,1.3,1.3).curveTo(1.8,0.8,1.8,0).lineTo(1.8,-0).curveTo(1.8,-0.8,1.3,-1.3).curveTo(0.7,-1.8,0,-1.8).curveTo(-0.8,-1.8,-1.2,-1.4).closePath();
	this.shape_13.setTransform(13.65,-5.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-3,3.8).lineTo(-3,-3.7).lineTo(-1.7,-3.7).lineTo(-1.7,-2.7).curveTo(-0.9,-3.8,0.3,-3.8).curveTo(1.4,-3.9,2.2,-3).curveTo(3,-2.2,3,-0.8).curveTo(3,0.6,2.2,1.4).curveTo(1.4,2.2,0.3,2.2).curveTo(-0.9,2.2,-1.7,1.2).lineTo(-1.7,3.8).closePath().moveTo(-1.2,-2.2).curveTo(-1.7,-1.6,-1.7,-0.8).curveTo(-1.7,0,-1.2,0.5).curveTo(-0.7,1.1,0,1).curveTo(0.7,1.1,1.1,0.5).curveTo(1.7,0.1,1.7,-0.8).curveTo(1.7,-1.6,1.1,-2.2).curveTo(0.6,-2.6,0,-2.6).curveTo(-0.7,-2.6,-1.2,-2.2).closePath();
	this.shape_14.setTransform(6,-5.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.3,2.9).lineTo(1.3,-1.7).lineTo(-1.4,-1.7).lineTo(-1.4,2.9).lineTo(-2.7,2.9).lineTo(-2.7,-2.9).lineTo(2.7,-2.9).lineTo(2.7,2.9).closePath();
	this.shape_15.setTransform(-1.85,-5.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(-2.2,2.1).curveTo(-3.1,1.3,-3.1,0).lineTo(-3.1,-0).curveTo(-3.1,-1.2,-2.2,-2.1).curveTo(-1.3,-3,-0,-3).curveTo(1.4,-3,2.2,-2.1).curveTo(3.1,-1.3,3.1,-0).curveTo(3.1,1.3,2.2,2.1).curveTo(1.3,3,-0,3).curveTo(-1.3,3,-2.2,2.1).closePath().moveTo(-1.2,-1.4).curveTo(-1.8,-0.8,-1.8,-0).curveTo(-1.8,0.8,-1.2,1.3).curveTo(-0.7,1.8,-0,1.8).curveTo(0.8,1.9,1.3,1.3).curveTo(1.8,0.8,1.8,0).lineTo(1.8,-0).curveTo(1.8,-0.8,1.2,-1.3).curveTo(0.8,-1.8,-0,-1.8).curveTo(-0.8,-1.8,-1.2,-1.4).closePath();
	this.shape_16.setTransform(-9.5,-5.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("rgba(0,0,0,0.898)").beginStroke().moveTo(1.8,3.9).lineTo(1.8,-2.6).lineTo(-1.8,-2.6).lineTo(-1.8,3.9).lineTo(-3.2,3.9).lineTo(-3.2,-3.9).lineTo(3.2,-3.9).lineTo(3.2,3.9).closePath();
	this.shape_17.setTransform(-17.725,-6.85);

	this.instance = new lib.Symbol4();
	this.instance.setTransform(8,-1.05,0.7126,0.7126,0,0,0,0.1,-1.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("rgba(0,0,0,0.086)").beginStroke().moveTo(-46.7,20.9).curveTo(-55.4,20.9,-61.5,14.7).curveTo(-67.6,8.7,-67.6,0.1).lineTo(-67.6,-0).curveTo(-67.6,-8.7,-61.5,-14.8).curveTo(-55.4,-20.9,-46.7,-20.9).lineTo(46.7,-20.9).curveTo(55.4,-20.9,61.5,-14.8).curveTo(67.6,-8.7,67.6,-0).lineTo(67.6,0.1).curveTo(67.6,8.7,61.5,14.7).curveTo(55.4,20.9,46.7,20.9).closePath();
	this.shape_18.setTransform(10.2874,2.9624,0.7717,0.7717);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.instance},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol13, new cjs.Rectangle(-44,-17.2,106.5,36.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-499.55,445.6,1,1,0,0,0,89.5,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({y:391.6,alpha:1},10).to({y:405.6},5).wait(97).to({_off:true},1).wait(78));

	// Layer_5
	this.instance_1 = new lib.Symbol77("synched",0);
	this.instance_1.setTransform(-545.05,207.4,1,1,27.2352,0,0,44,0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90).to({_off:false},0).wait(71).to({startPosition:71},0).to({_off:true},1).wait(78));

	// Layer_3
	this.instance_2 = new lib.Symbol96();
	this.instance_2.setTransform(-733.6,328.05,0.8607,0.8607,-21.1933,0,0,23.6,-10.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:23.7,rotation:-51.914,x:-601.6,y:357},24,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(78));

	// Layer_2
	this.instance_3 = new lib.Symbol1();
	this.instance_3.setTransform(-483.9,4.95,0.5393,0.5393,0,0,0,101.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(161).to({_off:true},1).wait(78));

	// Layer_4
	this.instance_4 = new lib.Symbol97();
	this.instance_4.setTransform(-280.8,64.1,0.8566,0.8566,-64.4406,0,0,211.8,3);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(34).to({_off:false},0).to({regY:3.1,scaleX:0.8565,scaleY:0.8565,rotation:-34.4816,x:-383.75,y:90.1},17).to({regX:211.9,scaleX:0.8566,scaleY:0.8566,rotation:-39.9538,x:-383.65,y:90.05},5,cjs.Ease.quadOut).wait(105).to({_off:true},1).wait(78));

	// Layer_1
	this.instance_5 = new lib.Symbol109();
	this.instance_5.setTransform(-439.5,144.5,1,1,0,0,0,77.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(51).to({_off:false},0).wait(110).to({_off:true},1).wait(78));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-765.2,-10.1,525.5,481);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(-80,-300).lineTo(80,-300).lineTo(80,300).lineTo(-80,300).closePath();
	this.shape.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(436));

	// Layer_5
	this.instance = new lib.Symbol13();
	this.instance.setTransform(80.15,555.05,0.4097,0.4097,0,0,0,8.6,1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(99).to({_off:false},0).to({regY:0.9,scaleX:1.337,scaleY:1.337,x:80.25,y:554.95},12).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:80.15,y:554.85},5).wait(255).to({regX:8.6,regY:0.9,scaleX:0.8921,scaleY:0.8921,x:80.2,y:555},4).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:80.15,y:554.85},10).wait(51));

	// Layer_9
	this.instance_1 = new lib.Symbol104();
	this.instance_1.setTransform(363.95,46.55,1,1,0,0,0,367.9,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(248).to({_off:false},0).to({alpha:1},12).to({alpha:0},7).to({_off:true},1).wait(152).to({_off:false},0).to({alpha:1},15).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(261).to({_off:false},0).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(162).to({_off:false},0).to({_off:true},113).wait(161));

	// Layer_8
	this.instance_4 = new lib.Symbol106();
	this.instance_4.setTransform(151.05,127,1,1,0,0,0,152.5,0);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({alpha:1},11).to({_off:true},1).wait(273));

	// Layer_3
	this.instance_5 = new lib.Symbol95("synched",0);
	this.instance_5.setTransform(646,44,1,1,0,0,0,82,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},162).wait(274));

	// Layer_4
	this.instance_6 = new lib.Symbol76();
	this.instance_6.setTransform(365.25,44.55,1,1,0,0,0,366.7,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},162).wait(274));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-121.2,293.1,445.5,317.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/160_600_atlas_1.png?1668007384277", id:"160_600_atlas_1"}
	],
	preloads: []
};
