...
lib.ssMetadata = [
		{name:"300_250_atlas_1", frames: [[157,0,230,102],[0,177,214,110],[157,104,50,50],[216,222,203,56],[216,104,172,116],[0,0,155,175]]}
];
...
(lib.gun1 = function() {
	this.initialize(ss["300_250_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.4,9.4).curveTo(-3.3,8.5,-3.3,7.2).curveTo(-3.3,5.9,-2.4,5.1).curveTo(-1.4,4.2,0,4.2).curveTo(1.5,4.2,2.4,5.1).curveTo(3.3,5.9,3.3,7.2).curveTo(3.3,8.5,2.4,9.4).curveTo(1.4,10.3,0,10.3).curveTo(-1.4,10.3,-2.4,9.4).closePath().moveTo(-2.2,2.6).lineTo(-3.3,-10.3).lineTo(3.3,-10.3).lineTo(2.2,2.6).closePath();
	this.shape.setTransform(171.725,32.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-8.2,10.1).lineTo(-8.2,-10.1).lineTo(7.8,-10.1).lineTo(7.8,-5.7).lineTo(-2.5,-5.7).lineTo(-2.5,-2.3).lineTo(6.5,-2.3).lineTo(6.5,2).lineTo(-2.5,2).lineTo(-2.5,5.7).lineTo(8.1,5.7).lineTo(8.1,10.1).closePath();
	this.shape_1.setTransform(157.1,32);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-8.2,10.1).lineTo(-8.2,-10.1).lineTo(7.8,-10.1).lineTo(7.8,-5.7).lineTo(-2.5,-5.7).lineTo(-2.5,-2.3).lineTo(6.5,-2.3).lineTo(6.5,2).lineTo(-2.5,2).lineTo(-2.5,5.7).lineTo(8.1,5.7).lineTo(8.1,10.1).closePath();
	this.shape_2.setTransform(136.5,32);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.9,10.1).lineTo(3.9,2.3).lineTo(-3.9,2.3).lineTo(-3.9,10.1).lineTo(-9.7,10.1).lineTo(-9.7,-10.1).lineTo(-3.9,-10.1).lineTo(-3.9,-2.5).lineTo(3.9,-2.5).lineTo(3.9,-10.1).lineTo(9.7,-10.1).lineTo(9.7,10.1).closePath();
	this.shape_3.setTransform(113.35,32);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.9,10.1).lineTo(3.9,2.3).lineTo(-3.9,2.3).lineTo(-3.9,10.1).lineTo(-9.7,10.1).lineTo(-9.7,-10.1).lineTo(-3.9,-10.1).lineTo(-3.9,-2.5).lineTo(3.9,-2.5).lineTo(3.9,-10.1).lineTo(9.7,-10.1).lineTo(9.7,10.1).closePath();
	this.shape_4.setTransform(88.7,32);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.1,10.1).lineTo(4.1,-1.8).lineTo(-4.3,10.1).lineTo(-9.7,10.1).lineTo(-9.7,-10.1).lineTo(-4,-10.1).lineTo(-4,1.8).lineTo(4.3,-10.1).lineTo(9.7,-10.1).lineTo(9.7,10.1).closePath();
	this.shape_5.setTransform(63.95,32);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.3,10).lineTo(-10.1,5.3).lineTo(-9.2,5.4).curveTo(-8.1,5.4,-7.5,4.5).curveTo(-6.9,3.6,-6.6,2).curveTo(-6.3,0.3,-6.3,-2.2).lineTo(-6,-10.3).lineTo(10.4,-10.3).lineTo(10.4,10).lineTo(4.7,10).lineTo(4.7,-5.8).lineTo(-1.1,-5.8).lineTo(-1.2,-2.5).curveTo(-1.4,1.9,-2,4.6).curveTo(-2.5,7.3,-3.9,8.8).curveTo(-5.2,10.3,-7.7,10.3).curveTo(-8.9,10.3,-10.3,10).closePath();
	this.shape_6.setTransform(38.5,32.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(6.5,12.2).lineTo(6.5,8.1).lineTo(-6.5,8.1).lineTo(-6.5,12.2).lineTo(-11.8,12.2).lineTo(-11.8,3.6).lineTo(-11,3.6).curveTo(-9.2,3.5,-8.5,1.1).curveTo(-7.8,-1.3,-7.6,-6).lineTo(-7.4,-12.2).lineTo(9,-12.2).lineTo(9,3.6).lineTo(11.8,3.6).lineTo(11.8,12.2).closePath().moveTo(-2.6,-5.4).curveTo(-2.7,-2.2,-3.1,0.1).curveTo(-3.5,2.3,-4.3,3.6).lineTo(3.4,3.6).lineTo(3.4,-7.7).lineTo(-2.5,-7.7).closePath();
	this.shape_7.setTransform(14.425,34.05);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.4,10).lineTo(-10,5.3).lineTo(-9.3,5.4).curveTo(-8.1,5.4,-7.5,4.5).curveTo(-6.9,3.6,-6.7,2).curveTo(-6.3,0.3,-6.3,-2.2).lineTo(-6,-10.3).lineTo(10.3,-10.3).lineTo(10.3,10).lineTo(4.7,10).lineTo(4.7,-5.8).lineTo(-1.1,-5.8).lineTo(-1.3,-2.5).curveTo(-1.4,1.9,-1.9,4.6).curveTo(-2.5,7.3,-3.9,8.8).curveTo(-5.2,10.3,-7.8,10.3).curveTo(-8.9,10.3,-10.4,10).closePath();
	this.shape_8.setTransform(163.55,2.175);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.8,9.2).curveTo(-8.4,7.8,-9.8,5.4).curveTo(-11.3,3,-11.3,-0).curveTo(-11.3,-3,-9.8,-5.4).curveTo(-8.4,-7.9,-5.8,-9.2).curveTo(-3.2,-10.6,-0,-10.6).curveTo(3.2,-10.6,5.8,-9.2).curveTo(8.3,-7.9,9.8,-5.4).curveTo(11.3,-3,11.3,-0).curveTo(11.3,3,9.8,5.4).curveTo(8.3,7.8,5.8,9.2).curveTo(3.2,10.5,-0,10.5).curveTo(-3.2,10.5,-5.8,9.2).closePath().moveTo(-2.8,-5.1).curveTo(-4,-4.3,-4.8,-3.1).curveTo(-5.5,-1.7,-5.5,-0).curveTo(-5.5,1.7,-4.8,3).curveTo(-4,4.3,-2.8,5.1).curveTo(-1.5,5.8,-0,5.8).curveTo(1.5,5.8,2.8,5.1).curveTo(4,4.3,4.8,3).curveTo(5.5,1.7,5.5,-0).curveTo(5.5,-1.7,4.8,-3.1).curveTo(4,-4.3,2.8,-5.1).curveTo(1.5,-5.8,-0,-5.8).curveTo(-1.5,-5.8,-2.8,-5.1).closePath();
	this.shape_9.setTransform(139.6,2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-9.2,10.1).lineTo(-9.2,-10.2).lineTo(0.6,-10.2).curveTo(4.3,-10.2,6.3,-8.8).curveTo(8.3,-7.4,8.3,-4.9).curveTo(8.3,-3.4,7.6,-2.3).curveTo(6.9,-1.1,5.5,-0.5).curveTo(7.3,0.1,8.3,1.3).curveTo(9.2,2.5,9.2,4.4).curveTo(9.2,7.1,7.1,8.6).curveTo(5,10.1,1.2,10.1).closePath().moveTo(-3.6,6).lineTo(0.9,6).curveTo(3.4,6,3.4,3.9).curveTo(3.4,1.8,0.9,1.9).lineTo(-3.6,1.9).closePath().moveTo(-3.6,-2.1).lineTo(0.1,-2.1).curveTo(2.5,-2.1,2.5,-4).curveTo(2.5,-6.1,0.1,-6.1).lineTo(-3.6,-6.1).closePath();
	this.shape_10.setTransform(116.275,2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.8,10.1).lineTo(-2.8,-5.6).lineTo(-9,-5.6).lineTo(-9,-10.2).lineTo(9.1,-10.2).lineTo(9.1,-5.6).lineTo(2.8,-5.6).lineTo(2.8,10.1).closePath();
	this.shape_11.setTransform(94.35,2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.5,9.2).curveTo(-7.1,7.9,-8.5,5.5).curveTo(-10,3,-10,-0).curveTo(-10,-3.1,-8.5,-5.4).curveTo(-7.1,-7.9,-4.5,-9.2).curveTo(-1.9,-10.6,1.2,-10.6).curveTo(4,-10.6,6.2,-9.6).curveTo(8.5,-8.6,9.9,-6.8).lineTo(6.3,-3.4).curveTo(4.3,-5.8,1.5,-5.8).curveTo(-0.1,-5.8,-1.4,-5.1).curveTo(-2.7,-4.3,-3.5,-3.1).curveTo(-4.1,-1.7,-4.1,-0).curveTo(-4.1,1.7,-3.5,3).curveTo(-2.7,4.3,-1.4,5.1).curveTo(-0.1,5.8,1.5,5.8).curveTo(4.3,5.8,6.3,3.4).lineTo(9.9,6.7).curveTo(8.5,8.6,6.2,9.5).curveTo(4,10.5,1.2,10.5).curveTo(-1.9,10.5,-4.5,9.2).closePath();
	this.shape_12.setTransform(73.5,2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.5,9.2).curveTo(-7.1,7.8,-8.5,5.4).curveTo(-10,3.1,-10,0).curveTo(-10,-3,-8.5,-5.5).curveTo(-7.1,-7.8,-4.5,-9.2).curveTo(-1.9,-10.5,1.2,-10.5).curveTo(4,-10.5,6.2,-9.6).curveTo(8.5,-8.6,9.9,-6.7).lineTo(6.3,-3.4).curveTo(4.3,-5.8,1.5,-5.8).curveTo(-0.1,-5.8,-1.4,-5).curveTo(-2.7,-4.4,-3.5,-3.1).curveTo(-4.1,-1.7,-4.1,0).curveTo(-4.1,1.7,-3.5,3.1).curveTo(-2.7,4.4,-1.4,5.1).curveTo(-0.1,5.8,1.5,5.8).curveTo(4.3,5.8,6.3,3.4).lineTo(9.9,6.7).curveTo(8.5,8.6,6.2,9.5).curveTo(4,10.6,1.2,10.5).curveTo(-1.9,10.5,-4.5,9.2).closePath();
	this.shape_13.setTransform(165.75,-28);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5.8,10.2).lineTo(4.2,6.2).lineTo(-4.3,6.2).lineTo(-6,10.2).lineTo(-11.8,10.2).lineTo(-2.8,-10.2).lineTo(2.8,-10.2).lineTo(11.8,10.2).closePath().moveTo(-2.7,2).lineTo(2.6,2).lineTo(-0,-4.5).closePath();
	this.shape_14.setTransform(141.95,-28);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.9,10.2).lineTo(3.9,2.3).lineTo(-4,2.3).lineTo(-4,10.2).lineTo(-9.7,10.2).lineTo(-9.7,-10.2).lineTo(-4,-10.2).lineTo(-4,-2.5).lineTo(3.9,-2.5).lineTo(3.9,-10.2).lineTo(9.6,-10.2).lineTo(9.6,10.2).closePath();
	this.shape_15.setTransform(117.2,-28);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-8.8,9.7).lineTo(-7.5,5.4).curveTo(-6.3,5.8,-5.5,5.8).curveTo(-4.6,5.8,-4,5.4).curveTo(-3.3,5,-2.8,4.2).lineTo(-10.6,-10.4).lineTo(-4.6,-10.4).lineTo(0.2,-0.6).lineTo(5,-10.4).lineTo(10.6,-10.4).lineTo(2.3,5.3).curveTo(0.9,7.8,-1,9.1).curveTo(-3,10.4,-5.2,10.4).curveTo(-6.9,10.4,-8.8,9.7).closePath();
	this.shape_16.setTransform(84.15,-27.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol110, new cjs.Rectangle(0,-52,179.1,104), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.8,7.1).curveTo(-2.5,6.5,-2.5,5.5).curveTo(-2.5,4.5,-1.8,3.9).curveTo(-1.1,3.2,0,3.2).curveTo(1.1,3.2,1.8,3.9).curveTo(2.5,4.5,2.5,5.5).curveTo(2.5,6.5,1.8,7.1).curveTo(1.1,7.8,0,7.8).curveTo(-1.1,7.8,-1.8,7.1).closePath().moveTo(-1.6,2).lineTo(-2.4,-7.8).lineTo(2.5,-7.8).lineTo(1.6,2).closePath();
	this.shape.setTransform(118.7,14.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(5.9,-7.7).lineTo(5.9,-4.4).lineTo(-1.9,-4.4).lineTo(-1.9,-1.8).lineTo(5,-1.8).lineTo(5,1.5).lineTo(-1.9,1.5).lineTo(-1.9,4.3).lineTo(6.2,4.3).lineTo(6.2,7.7).closePath();
	this.shape_1.setTransform(107.375,14.2);
	...
	this.shape_2.setTransform(86.45,14.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.9,7.7).lineTo(-6.9,-7.7).lineTo(-2.6,-7.7).lineTo(-2.6,-2.8).lineTo(0.9,-2.8).curveTo(3.8,-2.8,5.3,-1.5).curveTo(6.9,-0.3,6.9,2.2).curveTo(6.9,4.9,5.1,6.3).curveTo(3.4,7.7,0.4,7.7).closePath().moveTo(-2.6,4.5).lineTo(0.1,4.5).curveTo(1.2,4.6,1.8,4).curveTo(2.5,3.4,2.5,2.3).curveTo(2.5,0.3,0.1,0.3).lineTo(-2.6,0.3).closePath();
	this.shape_3.setTransform(65.95,14.2);
	...
	this.shape_4.setTransform(46.9,14.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.9).curveTo(-6.3,6,-7.5,4.1).curveTo(-8.6,2.3,-8.6,0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-6.9).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-6.9).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,6,4.4,6.9).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,6.9).closePath().moveTo(-2.1,-3.9).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.9).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.9).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.9).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.9).closePath();
	this.shape_5.setTransform(28.525,14.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(5.8,-7.7).lineTo(5.8,-4.4).lineTo(-2.7,-4.4).lineTo(-2.7,-1.9).lineTo(1.3,-1.9).curveTo(4,-1.8,5.5,-0.6).curveTo(7,0.5,7,2.7).curveTo(7,5.1,5.4,6.4).curveTo(3.7,7.7,0.7,7.7).closePath().moveTo(-2.7,4.5).lineTo(0.4,4.5).curveTo(1.5,4.5,2.1,4.2).curveTo(2.6,3.7,2.6,2.9).curveTo(2.6,1.3,0.4,1.3).lineTo(-2.7,1.3).closePath();
	this.shape_6.setTransform(10.675,14.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.9,7.6).lineTo(-7.6,4).lineTo(-7,4.1).curveTo(-6.1,4.1,-5.7,3.4).curveTo(-5.2,2.7,-5,1.5).lineTo(-4.7,-1.7).lineTo(-4.6,-7.8).lineTo(7.9,-7.8).lineTo(7.9,7.6).lineTo(3.6,7.6).lineTo(3.6,-4.4).lineTo(-0.9,-4.4).lineTo(-1,-1.9).curveTo(-1.1,1.4,-1.4,3.5).curveTo(-1.9,5.6,-2.9,6.7).curveTo(-4,7.8,-5.8,7.8).curveTo(-6.8,7.8,-7.9,7.6).closePath();
	this.shape_7.setTransform(244.05,-11.025);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.9).curveTo(-6.3,6,-7.5,4.1).curveTo(-8.6,2.3,-8.6,-0).curveTo(-8.6,-2.3,-7.5,-4.1).curveTo(-6.3,-6,-4.4,-6.9).curveTo(-2.4,-8,-0,-8).curveTo(2.4,-8,4.4,-6.9).curveTo(6.3,-6,7.4,-4.1).curveTo(8.6,-2.3,8.6,-0).curveTo(8.6,2.3,7.4,4.1).curveTo(6.3,6,4.4,6.9).curveTo(2.4,8,-0,8).curveTo(-2.4,8,-4.4,6.9).closePath().moveTo(-2.1,-3.9).curveTo(-3.1,-3.3,-3.6,-2.3).curveTo(-4.2,-1.3,-4.2,-0).curveTo(-4.2,1.3,-3.6,2.3).curveTo(-3.1,3.3,-2.1,3.9).curveTo(-1.2,4.4,-0,4.4).curveTo(1.2,4.4,2.1,3.9).curveTo(3.1,3.3,3.6,2.3).curveTo(4.1,1.3,4.1,-0).curveTo(4.1,-1.3,3.6,-2.3).curveTo(3.1,-3.3,2.1,-3.9).curveTo(1.2,-4.4,-0,-4.4).curveTo(-1.2,-4.4,-2.1,-3.9).closePath();
	this.shape_8.setTransform(225.675,-11.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7,7.7).lineTo(-7,-7.7).lineTo(0.5,-7.7).curveTo(3.3,-7.7,4.8,-6.7).curveTo(6.3,-5.6,6.3,-3.7).curveTo(6.3,-2.5,5.7,-1.7).curveTo(5.3,-0.8,4.2,-0.4).curveTo(5.6,0.1,6.3,1).curveTo(7,2,7,3.3).curveTo(7,5.3,5.4,6.5).curveTo(3.8,7.7,0.9,7.7).closePath().moveTo(-2.7,4.6).lineTo(0.7,4.6).curveTo(2.6,4.6,2.6,3).curveTo(2.6,1.4,0.7,1.4).lineTo(-2.7,1.4).closePath().moveTo(-2.7,-1.5).lineTo(0.1,-1.5).curveTo(1.9,-1.6,1.9,-3.1).curveTo(1.9,-4.6,0.1,-4.6).lineTo(-2.7,-4.6).closePath();
	this.shape_9.setTransform(207.75,-11.15);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.2,7.7).lineTo(-2.2,-4.2).lineTo(-6.8,-4.2).lineTo(-6.8,-7.7).lineTo(6.8,-7.7).lineTo(6.8,-4.2).lineTo(2.2,-4.2).lineTo(2.2,7.7).closePath();
	this.shape_10.setTransform(190.9,-11.15);
	...
	this.shape_11.setTransform(174.825,-11.15);
	...
	this.shape_12.setTransform(149.225,-13.4);
	...
	this.shape_13.setTransform(132.175,-11.15);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.8,7.7).lineTo(2.8,2.4).curveTo(1,3.1,-0.5,3).curveTo(-3.7,3,-5.4,1.5).curveTo(-7.1,-0.1,-7.1,-3).lineTo(-7.1,-7.7).lineTo(-2.8,-7.7).lineTo(-2.8,-3.4).curveTo(-2.8,-0.5,0.1,-0.5).curveTo(1.7,-0.5,2.8,-1).lineTo(2.8,-7.7).lineTo(7.1,-7.7).lineTo(7.1,7.7).closePath();
	this.shape_14.setTransform(114.6,-11.15);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.2,4.1).lineTo(-1.2,0.5).curveTo(-1.8,0.3,-2.1,-0.3).curveTo(-2.5,-0.9,-2.5,-1.7).curveTo(-2.5,-2.8,-1.8,-3.4).curveTo(-1.1,-4.1,0,-4.1).curveTo(1.1,-4.1,1.8,-3.4).curveTo(2.5,-2.8,2.5,-1.7).lineTo(2.4,-0.7).lineTo(1.8,0.9).lineTo(0.4,4.1).closePath();
	this.shape_15.setTransform(95.2,-4.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,10).lineTo(3.1,1).lineTo(-3.3,10).lineTo(-7.4,10).lineTo(-7.4,-5.4).lineTo(-3.1,-5.4).lineTo(-3.1,3.6).lineTo(3.3,-5.4).lineTo(7.4,-5.4).lineTo(7.4,10).closePath().moveTo(-3.4,-7.3).curveTo(-4.5,-8.2,-4.5,-9.9).lineTo(-1.6,-9.9).curveTo(-1.6,-9.2,-1.2,-8.8).curveTo(-0.8,-8.4,-0,-8.5).curveTo(0.8,-8.4,1.2,-8.8).curveTo(1.6,-9.2,1.6,-9.9).lineTo(4.5,-9.9).curveTo(4.5,-8.2,3.4,-7.3).curveTo(2.3,-6.4,-0,-6.4).curveTo(-2.4,-6.4,-3.4,-7.3).closePath();
	this.shape_16.setTransform(82.075,-13.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.5,7.7).lineTo(3.3,4.7).lineTo(-3.3,4.7).lineTo(-4.5,7.7).lineTo(-9,7.7).lineTo(-2.1,-7.7).lineTo(2.1,-7.7).lineTo(9,7.7).closePath().moveTo(-2,1.5).lineTo(1.9,1.5).lineTo(-0,-3.4).closePath();
	this.shape_17.setTransform(62.95,-11.15);
	...
	this.shape_18.setTransform(43.925,-11.15);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.6,7.6).curveTo(-5.2,7.3,-6.8,6.6).lineTo(-5.4,3.5).curveTo(-4.4,4,-3.2,4.3).curveTo(-2,4.6,-0.9,4.6).curveTo(0.5,4.6,1.5,4.1).curveTo(2.3,3.6,2.4,2.8).curveTo(2.4,2.1,1.8,1.8).curveTo(1.2,1.4,0.2,1.4).lineTo(-3.7,1.4).lineTo(-3.7,-1.7).lineTo(-0.1,-1.7).curveTo(0.8,-1.7,1.2,-2.1).curveTo(1.8,-2.4,1.8,-3.1).curveTo(1.7,-3.8,1,-4.2).curveTo(0.3,-4.6,-0.9,-4.6).curveTo(-1.9,-4.6,-3,-4.3).curveTo(-4.1,-4.1,-5.1,-3.5).lineTo(-6.3,-6.9).curveTo(-3.9,-8,-0.9,-8).curveTo(1,-8.1,2.6,-7.5).curveTo(4.3,-7,5.2,-6).curveTo(6.2,-4.9,6.2,-3.5).curveTo(6.1,-2.5,5.6,-1.6).curveTo(5,-0.8,4,-0.3).curveTo(5.3,0.2,6.1,1.2).curveTo(6.7,2.1,6.7,3.3).curveTo(6.8,4.8,5.8,5.8).curveTo(4.8,6.9,3.1,7.5).curveTo(1.5,8,-0.5,8.1).curveTo(-2.1,8,-3.6,7.6).closePath();
	this.shape_19.setTransform(26.5,-11.15);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,7.3).lineTo(-5.7,4.1).curveTo(-4.8,4.4,-4.2,4.4).curveTo(-3.5,4.4,-3,4.1).curveTo(-2.5,3.8,-2.1,3.2).lineTo(-8.1,-7.9).lineTo(-3.5,-7.9).lineTo(0.1,-0.5).lineTo(3.8,-7.9).lineTo(8.1,-7.9).lineTo(1.7,4).curveTo(0.7,5.9,-0.8,6.9).curveTo(-2.3,7.9,-4,7.9).curveTo(-5.3,7.9,-6.7,7.3).closePath();
	this.shape_20.setTransform(10.225,-10.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol108, new cjs.Rectangle(0,-29.8,256.8,59.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol107, new cjs.Rectangle(0,-58,172,116), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#B4060D").beginStroke().moveTo(-152.5,127).lineTo(-152.5,-127).lineTo(152.5,-127).lineTo(152.5,127).closePath();
	this.shape.setTransform(152.5,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol106, new cjs.Rectangle(0,-127,305,254), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.2,7.7).lineTo(-2.2,-0.1).lineTo(-2.2,7.7).lineTo(-6.2,7.7).lineTo(-6.2,-7.7).lineTo(-3.1,-7.7).lineTo(2.3,0).lineTo(2.3,-7.7).lineTo(6.2,-7.7).lineTo(6.2,7.7).closePath();
	this.shape.setTransform(157.65,26.35);
	...
	this.shape_1.setTransform(142.1,26.525);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.6,5.7).curveTo(-8,3.4,-8,0).curveTo(-8,-3.4,-5.6,-5.7).curveTo(-3.3,-8,0.1,-8.1).curveTo(2.3,-8,4,-7.1).curveTo(5.8,-6.1,6.8,-4.5).lineTo(3.5,-2.6).curveTo(3.1,-3.3,2.1,-3.8).curveTo(1.3,-4.2,0.2,-4.2).curveTo(-1.7,-4.2,-2.8,-3).curveTo(-4,-1.8,-4,0).curveTo(-4,1.9,-2.9,3.1).curveTo(-1.7,4.3,0.4,4.3).curveTo(3.1,4.3,3.9,2.3).lineTo(0.2,2.3).lineTo(0.2,-1.1).lineTo(8,-1.1).lineTo(8,0.5).curveTo(7.9,3.8,5.8,6).curveTo(3.7,8,0.3,8).curveTo(-3.3,8.1,-5.6,5.7).closePath();
	this.shape_2.setTransform(125.4,26.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8,0,-8.1).curveTo(3.4,-8,5.7,-5.7).curveTo(8.1,-3.4,8.1,0).curveTo(8.1,3.3,5.7,5.7).curveTo(3.4,8.1,0,8).curveTo(-3.4,8.1,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.9,-4.1,0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,0).curveTo(4.2,-1.9,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_3.setTransform(107.125,26.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.9,7.7).lineTo(-4.9,-7.7).lineTo(4.8,-7.7).lineTo(4.8,-4).lineTo(-1,-4).lineTo(-1,-1.9).lineTo(4.3,-1.9).lineTo(4.3,1.7).lineTo(-1,1.7).lineTo(-1,4).lineTo(5,4).lineTo(5,7.7).closePath();
	this.shape_4.setTransform(91.85,26.35);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.8,7).curveTo(-5.4,6,-6.1,4.2).lineTo(-2.7,2.3).curveTo(-1.9,4.3,0.3,4.3).curveTo(2.1,4.3,2.1,3.3).curveTo(2.1,2.6,1.1,2.2).lineTo(-0.8,1.5).curveTo(-3.1,0.9,-4.3,-0.2).curveTo(-5.4,-1.4,-5.4,-3.2).curveTo(-5.4,-5.4,-3.9,-6.7).curveTo(-2.3,-8.1,-0.1,-8.1).curveTo(1.9,-8.1,3.4,-7.1).curveTo(4.9,-6.2,5.6,-4.5).lineTo(2.3,-2.6).curveTo(1.6,-4.3,-0.1,-4.3).curveTo(-0.7,-4.3,-1.1,-4).curveTo(-1.5,-3.7,-1.5,-3.3).curveTo(-1.5,-2.7,-0.9,-2.4).curveTo(-0.4,-2,1.2,-1.6).lineTo(3,-1).curveTo(3.7,-0.7,4.5,-0.2).curveTo(6.1,0.9,6.1,3.2).curveTo(6.1,5.5,4.5,6.8).curveTo(2.8,8.1,0.2,8).curveTo(-2.2,8,-3.8,7).closePath();
	this.shape_5.setTransform(78.325,26.35);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,5.8).curveTo(-7.3,3.4,-7.3,0).curveTo(-7.3,-3.5,-5.1,-5.7).curveTo(-2.8,-8,0.7,-8.1).curveTo(2.8,-8,4.6,-7.1).curveTo(6.3,-6.1,7.3,-4.4).lineTo(3.9,-2.4).curveTo(3.5,-3.3,2.7,-3.7).curveTo(1.7,-4.2,0.7,-4.2).curveTo(-1.1,-4.2,-2.3,-3).curveTo(-3.4,-1.9,-3.4,0).curveTo(-3.4,1.9,-2.3,3.1).curveTo(-1.1,4.2,0.7,4.2).curveTo(1.7,4.2,2.7,3.7).curveTo(3.5,3.3,3.9,2.4).lineTo(7.3,4.4).curveTo(6.4,6,4.6,7).curveTo(2.8,8.1,0.7,8).curveTo(-2.8,8,-5.1,5.8).closePath();
	this.shape_6.setTransform(57,26.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.8,7.7).lineTo(-5.8,-7.7).lineTo(0.3,-7.7).curveTo(2.6,-7.7,4,-6.5).curveTo(5.3,-5.3,5.3,-3.3).curveTo(5.3,-1.4,3.9,-0.3).curveTo(5.8,0.9,5.8,3.2).curveTo(5.8,5.2,4.4,6.5).curveTo(3,7.7,0.7,7.7).closePath().moveTo(-1.9,4.2).lineTo(0.6,4.2).curveTo(1.2,4.2,1.5,3.8).curveTo(1.9,3.5,1.9,2.9).curveTo(1.9,2.3,1.5,2).curveTo(1.2,1.6,0.6,1.6).lineTo(-1.9,1.6).closePath().moveTo(-1.9,-1.7).lineTo(0.2,-1.7).curveTo(0.7,-1.7,1.1,-2.1).curveTo(1.4,-2.4,1.4,-3).curveTo(1.4,-3.5,1.1,-3.9).curveTo(0.7,-4.2,0.2,-4.2).lineTo(-1.9,-4.2).closePath();
	this.shape_7.setTransform(205.875,0.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8,0,-8).curveTo(3.4,-8,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8.1,0,8.1).curveTo(-3.4,8.1,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_8.setTransform(189.125,0.55);
	...
	this.shape_9.setTransform(173.425,0.55);
	...
	this.shape_10.setTransform(159,-1.575);
	...
	this.shape_11.setTransform(143.225,0.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,5.7).curveTo(-7.4,3.5,-7.4,-0).curveTo(-7.4,-3.5,-5.1,-5.7).curveTo(-2.8,-8,0.7,-8).curveTo(2.8,-8,4.6,-7).curveTo(6.3,-6,7.4,-4.3).lineTo(3.9,-2.4).curveTo(3.5,-3.3,2.7,-3.7).curveTo(1.8,-4.2,0.7,-4.2).curveTo(-1.2,-4.2,-2.3,-3).curveTo(-3.4,-1.8,-3.4,-0).curveTo(-3.4,1.9,-2.3,3).curveTo(-1.2,4.2,0.7,4.2).curveTo(1.8,4.2,2.7,3.7).curveTo(3.5,3.2,3.9,2.4).lineTo(7.4,4.4).curveTo(6.4,6.1,4.6,7).curveTo(2.8,8.1,0.7,8.1).curveTo(-2.8,8.1,-5.1,5.7).closePath();
	this.shape_12.setTransform(127,0.55);
	...
	this.shape_13.setTransform(104.6,0.55);
	...
	this.shape_14.setTransform(88.75,0.55);
	...
	this.shape_15.setTransform(73.025,2.025);
	...
	this.shape_16.setTransform(56.45,0.55);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,4.4).lineTo(-2.5,2.5).curveTo(-1.8,4.3,0.1,4.3).curveTo(1.9,4.3,1.9,3).curveTo(1.9,1.8,0.5,1.6).lineTo(-1.9,1.6).lineTo(-1.9,-1.8).lineTo(-0.4,-1.8).curveTo(1.4,-1.8,1.4,-3.1).curveTo(1.4,-4.3,-0.2,-4.3).curveTo(-1.7,-4.3,-2.4,-2.8).lineTo(-5.7,-4.7).curveTo(-4.9,-6.3,-3.5,-7.1).curveTo(-2,-8,-0.1,-8).curveTo(2.3,-8,3.9,-6.8).curveTo(5.4,-5.5,5.4,-3.4).curveTo(5.4,-1.4,3.8,-0.3).curveTo(5.9,0.9,5.9,3.3).curveTo(5.9,5.5,4.3,6.7).curveTo(2.7,8.1,0.1,8.1).curveTo(-4.4,8.1,-5.9,4.4).closePath();
	this.shape_17.setTransform(41.825,0.55);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,5.7).curveTo(-8.1,3.4,-8.1,-0).curveTo(-8.1,-3.4,-5.7,-5.7).curveTo(-3.4,-8,0,-8).curveTo(3.4,-8,5.7,-5.7).curveTo(8.1,-3.4,8.1,-0).curveTo(8.1,3.4,5.7,5.7).curveTo(3.4,8.1,0,8.1).curveTo(-3.4,8.1,-5.7,5.7).closePath().moveTo(-3,-3).curveTo(-4.1,-1.8,-4.1,-0).curveTo(-4.1,1.8,-3,3).curveTo(-1.7,4.2,0,4.2).curveTo(1.8,4.2,3,3).curveTo(4.2,1.8,4.2,-0).curveTo(4.2,-1.8,3,-3).curveTo(1.8,-4.2,0,-4.2).curveTo(-1.8,-4.2,-3,-3).closePath();
	this.shape_18.setTransform(26.025,0.55);
	...
	this.shape_19.setTransform(9.2,0.55);
...
}).prototype = getMCSymbolPrototype(lib.Symbol105, new cjs.Rectangle(0,-41.7,215.2,83.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-153.5,129).lineTo(-153.5,-129).lineTo(153.5,-129).lineTo(153.5,129).closePath();
	this.shape.setTransform(153.5,78.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol104, new cjs.Rectangle(0,-50.7,307,258), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9F060C").beginStroke().moveTo(-152,127.5).lineTo(-152,-127.5).lineTo(152,-127.5).lineTo(152,127.5).closePath();
	this.shape.setTransform(152,80);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol76, new cjs.Rectangle(0,-47.5,304,255), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({x:142.65,alpha:1},19,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(345));

	// Layer_2
	this.instance_1 = new lib.Symbol107();
	this.instance_1.setTransform(-14,149,1,1,0,0,0,86,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({x:226,y:147.95,alpha:1},20,cjs.Ease.quadOut).to({x:210},125).wait(20).to({_off:true},1).wait(345));

	// Layer_5
	this.instance_2 = new lib.Symbol1();
	this.instance_2.setTransform(71.1,-15.05,0.5393,0.5393,0,0,0,101.5,0);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},9).wait(165).to({_off:true},1).wait(345));

	// Layer_6
	this.instance_3 = new lib.Symbol109();
	this.instance_3.setTransform(225.5,197.95,1,1,0,0,0,77.5,0);
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#9E060B").beginStroke().moveTo(-153,128).lineTo(-153,-128).lineTo(153,-128).lineTo(153,128).closePath();
	this.shape.setTransform(150,79.025);
...
p.nominalBounds = new cjs.Rectangle(-100,-48.9,521.1,334.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(154.05,161.95,0.36,0.36,0,0,0,25,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({_off:false},0).to({regX:25.1,scaleX:1.24,scaleY:1.24,x:154.15,alpha:1},8).to({regX:25,scaleX:1,scaleY:1,x:154.05},3).wait(83).to({_off:true},1).wait(358));

	// Layer_3
	this.instance_1 = new lib.Symbol105();
	this.instance_1.setTransform(152.9,139.2,1,1,0,0,0,107.6,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).to({y:73.2,alpha:1},10).to({y:79.2},4).wait(90).to({_off:true},1).wait(358));

	// Layer_2
	this.instance_2 = new lib.Symbol1();
	this.instance_2.setTransform(153.7,1.15,1.6138,1.6138,0,0,0,101.5,0.1);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:0.4795,scaleY:0.4795,x:153.75,alpha:1},15).to({scaleX:0.6577,scaleY:0.6577},4).wait(93).to({_off:true},1).wait(358));

	// Layer_1
	this.instance_3 = new lib.Symbol21();
	this.instance_3.setTransform(152,80.3,0.4202,2.7597,0,0,0,366.4,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(112).to({_off:true},1).wait(358));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10.1,-48.3,327.6,256.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-374.5,135.65,0.6538,0.6538,0,0,0,89.5,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({scaleX:1.1228,scaleY:1.1228,alpha:1},10).to({scaleX:1,scaleY:1,x:-374.55},5).wait(97).to({_off:true},1).wait(78));

	// Layer_5
	this.instance_1 = new lib.Symbol77("synched",0);
	this.instance_1.setTransform(-462.05,92.4,1,1,27.2352,0,0,44,0.1);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-726.55,234,0.8607,0.8607,-0.6867,0,0,23.7,-10.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-43.9255,x:-610.6,y:210},24,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(78));

	// Layer_2
	this.instance_3 = new lib.Symbol1();
	this.instance_3.setTransform(-488.9,-11.05,0.5393,0.5393,0,0,0,101.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(161).to({_off:true},1).wait(78));

	// Layer_4
	this.instance_4 = new lib.Symbol97();
	this.instance_4.setTransform(-127.75,2.3,0.9999,0.9999,-62.7468,0,0,211.9,3);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(34).to({_off:false},0).to({regX:212,regY:3.1,scaleX:1,scaleY:1,rotation:-21.8141,x:-262.65,y:-14.05},17).to({rotation:-31.7547,x:-262.6,y:-14},5,cjs.Ease.quadOut).wait(105).to({_off:true},1).wait(78));

	// Layer_1
	this.instance_5 = new lib.Symbol109();
	this.instance_5.setTransform(-326.5,9.5,1,1,0,0,0,77.5,0);
...
p.nominalBounds = new cjs.Rectangle(-747.4,-78,666.9,364.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(248).to({_off:false},0).to({alpha:1},12).to({alpha:0},7).to({_off:true},1).wait(152).to({_off:false},0).to({alpha:1},15).wait(1));

	// Layer_5
	this.instance_1 = new lib.Symbol13();
	this.instance_1.setTransform(78.2,216.9,0.4657,0.4657,0,0,0,8.6,0.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(317).to({_off:false},0).to({regX:8.5,regY:0.9,scaleX:1.2817,scaleY:1.2817,x:78.15,y:216.95},12).to({regY:0.8,scaleX:1.1514,scaleY:1.1514,y:216.85},5).wait(37).to({regX:8.6,regY:0.9,scaleX:0.9474,scaleY:0.9474,x:78.25,y:217},4).to({regX:8.5,regY:0.8,scaleX:1.1514,scaleY:1.1514,x:78.15,y:216.85},10).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-33.3,91,516.8,239.89999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300_250_atlas_1.png?1668004698085", id:"300_250_atlas_1"}
	],
	preloads: []
};
